...
if(null != ClipType){
	if("newReport".equals(ClipType)){
		...
		//프린트용 pdf 다운로드 시 파일 명을 변경하여 사용합니다.
		//doPost 메서드 대신 doPostByFileName 메서드를 사용해야 합니다.
		//Content-Disposition 의 inline;filename=test.pdf 변경됩니다.
		//영문만 사용 가능합니다.
		//pdfPrintDownload.doPostByFileName(request, response,  propertyPath, "test");
