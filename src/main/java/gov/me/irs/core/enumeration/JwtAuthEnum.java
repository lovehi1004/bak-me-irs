...
public enum JwtAuthEnum implements CoreResponseEnumType {
	...
	AUTHENTICATION_HOLD_USER(
			JwtConst.AUTH_CODE.AUTHENTICATION_HOLD_USER,
			JwtConst.AUTH_MESSAGE.AUTHENTICATION_HOLD_USER),						//관리자에 의해 이용정지된 사용자입니다.
	AUTHENTICATION_SHUTDOWN_USER(
			JwtConst.AUTH_CODE.AUTHENTICATION_SHUTDOWN_USER,
			JwtConst.AUTH_MESSAGE.AUTHENTICATION_SHUTDOWN_USER),					//관리자에 의해 폐쇄된 계정입니다.
	...
	VIEWER_ERROR(
			JwtConst.AUTH_CODE.VIEWER_ERROR,
			JwtConst.AUTH_MESSAGE.VIEWER_ERROR),
	...
	FILE_NOT_FOUND(
			JwtConst.AUTH_CODE.FILE_NOT_FOUND,
			JwtConst.AUTH_MESSAGE.FILE_NOT_FOUND),
	FILE_UNKNOWN_ERROR(
			JwtConst.AUTH_CODE.FILE_UNKNOWN_ERROR,
			JwtConst.AUTH_MESSAGE.FILE_UNKNOWN_ERROR);
