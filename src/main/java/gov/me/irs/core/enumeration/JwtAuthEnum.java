...
public enum JwtAuthEnum implements CoreResponseEnumType {
	...
	AUTHENTICATION_REISSUE_TOKEN_OK(
			JwtConst.AUTH_CODE.AUTHENTICATION_REISSUE_TOKEN_OK,
			JwtConst.AUTH_MESSAGE.AUTHENTICATION_REISSUE_TOKEN_OK),
	...
	FORBIDDEN(
			JwtConst.AUTH_CODE.FORBIDDEN,
			JwtConst.AUTH_MESSAGE.FORBIDDEN),
