...
SELECT A.BIZ_MGNO																					/* 사업관리번호 */
     ...
     , F.BIZ_DTL_FLD_ENG_NM																		/* 사업세부분야영문명 */
     , F.BIZ_DTL_FLD_KORN_NM																		/* 사업세부분야한글명 */
 ...
 INNER JOIN COM_BIZ_FLD_BSC E
 	ON E.BIZ_FLD_CD_MGNO = B.BIZ_FLD_CD
 INNER JOIN COM_BIZ_FLD_DTL F
 	ON F.BIZ_FLD_DTL_CD_MGNO = B.BIZ_DTL_FLD_CD 
 WHERE A.DEL_YN = 'N'
  AND B.DEL_YN = 'N'
;
...
COMMENT ON COLUMN V_SEARCH_IRB_BSC.BIZ_FLD_ENG_NM IS '사업분야영문명';
COMMENT ON COLUMN V_SEARCH_IRB_BSC.BIZ_FLD_KORN_NM IS '사업분야한글명';
COMMENT ON COLUMN V_SEARCH_IRB_BSC.BIZ_DTL_FLD_ENG_NM IS '사업세부분야영문명';
COMMENT ON COLUMN V_SEARCH_IRB_BSC.BIZ_DTL_FLD_KORN_NM IS '사업세부분야한글명';
