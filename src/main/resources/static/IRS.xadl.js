(function()
{
    return function()  
	{
        ...
        {		
            ...
            obj._setContents("<ColumnInfo><Column id=\"userId\" type=\"STRING\" size=\"256\"/><Column id=\"upInstMgno\" type=\"STRING\" size=\"256\"/><Column id=\"instMgno\" type=\"STRING\" size=\"256\"/><Column id=\"userClCd\" type=\"STRING\" size=\"256\"/><Column id=\"flnm\" type=\"STRING\" size=\"256\"/><Column id=\"deptNm\" type=\"STRING\" size=\"256\"/><Column id=\"jbpsNm\" type=\"STRING\" size=\"256\"/><Column id=\"telDdd\" type=\"STRING\" size=\"256\"/><Column id=\"telTlpno\" type=\"STRING\" size=\"256\"/><Column id=\"telPhino\" type=\"STRING\" size=\"256\"/><Column id=\"acntRprsvYn\" type=\"STRING\" size=\"256\"/><Column id=\"instClsfCd\" type=\"STRING\" size=\"256\"/><Column id=\"instDtlsClsfCd\" type=\"STRING\" size=\"256\"/><Column id=\"govInstYn\" type=\"STRING\" size=\"256\"/><Column id=\"bzentNm\" type=\"STRING\" size=\"256\"/><Column id=\"bzentClCd\" type=\"STRING\" size=\"256\"/><Column id=\"rprsvNm\" type=\"STRING\" size=\"256\"/><Column id=\"roleIdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"roleIdMgnoList\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this._addDataset(obj.name, obj);
        ...
        */
        this.Application_onload = function(obj,e)
        {
        	...
        	if(sSysNaviName.indexOf("NEXACRO") > -1)	// nexacro-studio 실행일때
        	{
        		...
        		{
        			this.gvServiceUrl = "http://127.0.0.1:28080/irs";
        	...
        	else	// 그외의 경우(WEB)
        	{
        		...
        		if(this.gvServiceUrl != null && this.gvServiceUrl != "")
        		{
        			...
        			if(sWasUrl.indexOf("IRS.") > -1)
        			{
        				this.gvSvrType = "REAL";		//운영
        				objApp.Tran.bTraceLog = objApp.Tran.traceLog.REAL;
        			}
        			else if(sWasUrl.indexOf("192.168.0.140") > -1
        				 || sWasUrl.indexOf("IRSDEV.") > -1)
        			{
