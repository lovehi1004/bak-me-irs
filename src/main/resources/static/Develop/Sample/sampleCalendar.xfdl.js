(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnGridExpandDsPrn","1363","45","84","30",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("gfnDsPrn");
            this.addChild(obj.name, obj);

            obj = new Static("staTitle04","884","616","248","30",null,null,null,null,null,null,this);
            obj.set_taborder("28");
            obj.set_text("4) Calendar - 월달력");
            obj.set_font("bold 10pt \"맑은 고딕\"");
            this.addChild(obj.name, obj);

            obj = new Static("staLabel03","902","644","107","30",null,null,null,null,null,null,this);
            obj.set_taborder("29");
            obj.set_text("월달력");
            obj.set_color("darkblue");
            obj.set_font("bold 14px/normal \"Malgun Gothic\",\"Dotum\",\"Arial\"");
            ...
            obj = new Div("divCalMonth","1060","649","104","30",null,null,null,null,null,null,this);
            obj.set_taborder("30");
            obj.set_text("divCalMonth");
            obj.set_url("Frame_Common::comCalMonth.xfdl");
            this.addChild(obj.name, obj);

            obj = new Button("btnGetMonth","900","686","144","30",null,null,null,null,null,null,this);
            obj.set_taborder("31");
            obj.set_text("월달력 값 가져오기");
            this.addChild(obj.name, obj);

            obj = new Edit("edtGetMonth","1060","686","102","30",null,null,null,null,null,null,this);
            obj.set_taborder("32");
            this.addChild(obj.name, obj);

            obj = new Button("btnSetMonth","900","723","144","30",null,null,null,null,null,null,this);
            obj.set_taborder("33");
            obj.set_text("월달력 값 설정하기");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSetMonth","1060","723","102","30",null,null,null,null,null,null,this);
            obj.set_taborder("34");
            obj.set_value("202309");
            obj.set_text("202309");
            this.addChild(obj.name, obj);

            obj = new Button("btnCalMonthEnable","970","766","74","30",null,null,null,null,null,null,this);
            obj.set_taborder("35");
            obj.set_text("Enable");
            this.addChild(obj.name, obj);

            obj = new Button("btnCalMonthReadOnly","1060","766","84","30",null,null,null,null,null,null,this);
            obj.set_taborder("36");
            obj.set_text("readOnly");
            this.addChild(obj.name, obj);

            obj = new Grid("grdMonth","1212","649","235","205",null,null,null,null,null,null,this);
            obj.set_taborder("37");
            ...
            obj = new Button("btnMonthDsPrn","1462","649","84","30",null,null,null,null,null,null,this);
            obj.set_taborder("38");
            obj.set_text("gfnDsPrn");
            this.addChild(obj.name, obj);

            obj = new TextArea("taeDesc01","902","275","525","330",null,null,null,null,null,null,this);
            obj.set_taborder("39");
            obj.set_value("Grid > 달력 빈값일때 \"____-__-__\" 표시 처리\nGrid Contents Edit > Cell 속성\n\nAction\ndisplaytype : date\nedittype : date\n\nCellCalendar\ncalendarbuttonsize : 0px , 0px (Calendar 기본 드롭다운 버튼 숨기기위해)\ncalendardateformat : yyyy-MM-dd\ncalendardisplaynulltext : ____-__-__\ncalendardisplaynulltype : nulltext\n\nCellExpand\nexpandimage : theme://images/grd_WF_Search.png\nexpandshow : show\nexpandsize : 30");
            this.addChild(obj.name, obj);
            // Layout Functions
