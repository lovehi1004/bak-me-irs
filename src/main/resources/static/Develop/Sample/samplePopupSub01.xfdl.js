(function()
{
    return function()
    {
        ...
        {
            this.set_name("samplePopupSub01");
            this.set_titletext("직접폼 모달(Modal) 샘플팝업");
            this.set_cssclass("frm_POP_Bg");
            if (Form == this.constructor)
            {
                this._setFormPosition(740,621);
            }
            ...
            obj = new Div("divTitle","20","19",null,"45","20",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_cssclass("div_POP_TitleBg");
            this.addChild(obj.name, obj);

            obj = new Static("stcPopTitle","18","7","250","30",null,null,null,null,null,null,this.divTitle.form);
            obj.set_taborder("0");
            obj.set_text("직접폼 모달(Modal) 샘플팝업");
            ...
            obj = new Div("divContents","45","89","650","430",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btnOk","295",null,"75","32",null,"45",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("확인");
            obj.set_cssclass("btn_POP_Confirm");
            this.addChild(obj.name, obj);

            obj = new Button("btnCancel","373",null,"75","32",null,"45",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("취소");
            obj.set_cssclass("btn_POP_Cancel");
            this.addChild(obj.name, obj);

            obj = new Static("stcGuide01","20","64","290","25",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            ...
            obj = new Static("stcGuide02","20","89","25","205",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            obj.set_text("25");
            ...
            obj = new Static("stcGuide04","290",null,"290","25",null,"77",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            obj.set_text("25");
            ...
            obj = new Static("stcGuide03",null,"89","25","205","20",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            obj.set_text("25");
            ...
            obj = new Static("stcGuide05","155",null,"290","25",null,"20",null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            obj.set_text("25");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",740,621,this,function(p){});
        ...
        // User Script
        this.registerScript("samplePopupSub01.xfdl", function() {
        /***********************************************************************************
        ...
        */
        ...
        this.loadIncludeScript("samplePopupSub01.xfdl");
