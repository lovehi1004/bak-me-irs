(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"chk\" type=\"STRING\" size=\"256\"/><Column id=\"realFileName\" type=\"STRING\" size=\"256\"/><Column id=\"displayFileName\" type=\"STRING\" size=\"256\"/><Column id=\"fileGroupMgno\" type=\"STRING\" size=\"256\"/><Column id=\"fileMgno\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"displayFileName\">multi 1/1 테스트파일</Col><Col id=\"chk\">0</Col><Col id=\"realFileName\">1.xlsx</Col><Col id=\"fileGroupMgno\">FG00000001</Col><Col id=\"fileMgno\">FD00000001</Col></Row><Row><Col id=\"displayFileName\">multi 1/2 테스트파일</Col><Col id=\"chk\">0</Col><Col id=\"realFileName\">111.xlsx</Col><Col id=\"fileGroupMgno\">FG00000001</Col><Col id=\"fileMgno\">FD00000002</Col></Row><Row><Col id=\"displayFileName\">single 테스트파일</Col><Col id=\"chk\">0</Col><Col id=\"realFileName\">Hydrangeas.jpg</Col><Col id=\"fileGroupMgno\">FG00000002</Col><Col id=\"fileMgno\">FD00000001</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsDownFileList", this);
            obj._setContents("<ColumnInfo><Column id=\"chk\" type=\"STRING\" size=\"256\"/><Column id=\"realFileName\" type=\"STRING\" size=\"256\"/><Column id=\"displayFileName\" type=\"STRING\" size=\"256\"/><Column id=\"fileGroupMgno\" type=\"STRING\" size=\"256\"/><Column id=\"fileMgno\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Grid("Grid00","19","22","501","108",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_binddataset("dsFileList");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"30\"/><Column size=\"259\"/><Column size=\"98\"/><Column size=\"112\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\"/></Rows><Band id=\"head\"><Cell/><Cell col=\"1\" text=\"DownLoad FileName\"/><Cell col=\"2\" text=\"그룹SN\"/><Cell col=\"3\" text=\"SN\"/></Band><Band id=\"body\"><Cell displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:chk\"/><Cell col=\"1\" text=\"bind:displayFileName\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:fileGroupMgno\" displaytype=\"normal\"/><Cell col=\"3\" text=\"bind:fileMgno\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("Button00","530","80","150","50",null,null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("single 파일 다운로드");
            this.addChild(obj.name, obj);

            obj = new Button("Button00_00","530","22","150","50",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("multi 파일 다운로드");
            this.addChild(obj.name, obj);

            obj = new Button("Button_excel","19","215","150","50",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text(" 엑셀 파일 다운로드");
            this.addChild(obj.name, obj);

            obj = new Button("Button_csv","195","215","150","50",null,null,null,null,null,null,this);
            obj.set_taborder("4");
        ...
        this.Button00_onclick = function(obj,e)
        {
        	...
        	for(var i=0;i<nCnt;i++){
        		...
        		if(nChk==1) {
        			...
        			this.dsDownFileList.setColumn(nRow, "fileGroupMgno", objDs.getColumn(i,"fileGroupMgno"));
        			this.dsDownFileList.setColumn(nRow, "fileMgno", objDs.getColumn(i,"fileMgno"));
        		}
        	}
