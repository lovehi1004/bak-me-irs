(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_datacolumn("datacolumn");
            obj.set_buttonsize("20");
            var divCalYMD_form_cboYear_innerdataset = new nexacro.NormalDataset("divCalYMD_form_cboYear_innerdataset", obj);
            divCalYMD_form_cboYear_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"datacolumn\">2023</Col><Col id=\"codecolumn\">0</Col></Row><Row><Col id=\"datacolumn\">2023</Col><Col id=\"codecolumn\">1</Col></Row></Rows>");
            obj.set_innerdataset(divCalYMD_form_cboYear_innerdataset);
            obj.set_text("2023");
            obj.set_value("0");
            obj.set_index("0");
            this.divCalYMD.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("comCalDayPop.xfdl", function() {
        /***********************************************************************************
        ...
        */
        ...
        this.loadIncludeScript("comCalDayPop.xfdl");
