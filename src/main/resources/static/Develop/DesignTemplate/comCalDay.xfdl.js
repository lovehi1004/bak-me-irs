(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cboMonth","135","22","48","25",null,null,null,null,null,null,this.pdvCalYMD.form);
            obj.set_taborder("1");
            ...
            obj = new Combo("cboYear","54","22","63","25",null,null,null,null,null,null,this.pdvCalYMD.form);
            obj.set_taborder("55");
            ...
            obj = new Static("staYYYY","120","24","13","20",null,null,null,null,null,null,this.pdvCalYMD.form);
            obj.set_taborder("56");
        ...
        */
        this.fnTitleSet = function()
        {
        	...
        	{
        		this.pdvCalYMD.form.staDN1.set_text("월");
        		this.pdvCalYMD.form.staDN2.set_text("화");
        		this.pdvCalYMD.form.staDN3.set_text("수");
        		this.pdvCalYMD.form.staDN4.set_text("목");
        		this.pdvCalYMD.form.staDN5.set_text("금");
        		this.pdvCalYMD.form.staDN6.set_text("토");
        		this.pdvCalYMD.form.staDN7.set_text("일");
        	}
        	else
        	{
        		this.pdvCalYMD.form.staDN1.set_text("일");
        		this.pdvCalYMD.form.staDN2.set_text("월");
        		this.pdvCalYMD.form.staDN3.set_text("화");
        		this.pdvCalYMD.form.staDN4.set_text("수");
        		this.pdvCalYMD.form.staDN5.set_text("목");
        		this.pdvCalYMD.form.staDN6.set_text("금");
        		this.pdvCalYMD.form.staDN7.set_text("토");
        	}
        };
        ...
        */
        this.btnYMD_onclick = function(obj,e)
        {
        	...
        	this.pdvCalYMD.trackPopupByComponent(this.calYmd, 0, this.calYmd.height);
        };
