(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("Button03_01","224",null,"75","32",null,"45",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("등록");
            obj.set_cssclass("btn_POP_Confirm");
            this.addChild(obj.name, obj);

            obj = new Button("Button03_01_00","302",null,"75","32",null,"45",null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("취소");
            ...
            //-- Default Layout : this
            obj = new Layout("default","",600,417,this,function(p){});
