(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta12","1096","43","150","44",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("7");
            obj.set_text("사업시행장소");
            obj.set_cssclass("sta_WF_Label_E");
            this.div01.addChild(obj.name, obj);

            obj = new Static("sta15","1096","86","150","44",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("8");
            obj.set_text("직위");
            obj.set_cssclass("sta_WF_LabelSub");
            this.div01.addChild(obj.name, obj);

            obj = new Static("sta17","620","86","150","44",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("9");
            obj.set_text("부서");
            obj.set_cssclass("sta_WF_LabelSub");
            this.div01.addChild(obj.name, obj);

            obj = new Edit("edt02","157","50","932","30",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("10");
            this.div01.addChild(obj.name, obj);
            ...
            obj = new Edit("edt05_00","1253","50",null,"30","7",null,null,null,null,null,this.div01.form);
            obj.set_taborder("13");
            this.div01.addChild(obj.name, obj);
            ...
            obj = new Edit("edt02_01","306","93","307","30",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("16");
            obj.set_value("홍길동");
            obj.set_cssclass("output");
            obj.set_readonly("true");
            ...
            obj = new Edit("edt02_01_00","777","93","311","30",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("17");
            ...
            obj = new Edit("edt05_00_00","1253","93",null,"30","7",null,null,null,null,null,this.div01.form);
            obj.set_taborder("18");
            obj.set_value("매니저");
            obj.set_cssclass("output");
            obj.set_readonly("true");
            ...
            obj = new Static("sta17_00","620","129","150","44",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("20");
            obj.set_text("E-MAIL");
            obj.set_cssclass("sta_WF_LabelSub");
            this.div01.addChild(obj.name, obj);

            obj = new Edit("edt02_01_01","306","136","307","30",null,null,null,null,null,null,this.div01.form);
            obj.set_taborder("22");
            ...
            obj = new Edit("edt02_01_00_00","777","136",null,"30","7",null,null,null,null,null,this.div01.form);
            obj.set_taborder("23");
            ...
            obj = new Div("div01_00","0","293",null,"589","30",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_formscrollbartype("none none");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta06_00_00_00_00_00_00_00","783","344",null,"74","0",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("31");
            obj.set_cssclass("sta_WF_LabelBg");
            this.div01_00.addChild(obj.name, obj);
            ...
            obj = new Static("sta12","783","43","150","44",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("4");
            obj.set_text("파리협정조항");
            obj.set_cssclass("sta_WF_Label_E");
            this.div01_00.addChild(obj.name, obj);

            obj = new Button("btn01","677","50","101","30",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("9");
            ...
            obj = new Combo("cbo00","940","50","227","30",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("8");
            obj.set_text("선택");
            obj.set_value("");
            obj.set_index("-1");
            ...
            obj = new Static("sta12_00","783","86","150","44",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("12");
            obj.set_text("사업유형/규모");
            obj.set_cssclass("sta_WF_Label_E");
            this.div01_00.addChild(obj.name, obj);

            obj = new Combo("cbo00_00","940","93","227","30",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("13");
            obj.set_text("선택");
            obj.set_value("");
            obj.set_index("-1");
            ...
            obj = new Static("sta12_00_00_00_00_00","783","258","150","44",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("24");
            obj.set_text("인증유효기간");
            obj.set_cssclass("sta_WF_Label_E");
            this.div01_00.addChild(obj.name, obj);

            obj = new Combo("cbo00_00_00_00_00_00","940","265","227","30",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("25");
            obj.set_text("선택");
            obj.set_value("");
            obj.set_index("-1");
            ...
            obj = new Static("sta12_00_00_00_00_00_00","783","301","150","44",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("28");
            obj.set_text("환산계수");
            obj.set_cssclass("sta_WF_Label");
            this.div01_00.addChild(obj.name, obj);
            ...
            obj = new Static("sta12_00_00_00_00_00_00_00","783","344","150","74",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("32");
            obj.set_text("환산근거");
            obj.set_cssclass("sta_WF_Label");
            this.div01_00.addChild(obj.name, obj);
            ...
            obj = new Radio("rdo00_00","157","265","538","30",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("36");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Edit("edt02_00_00_00_00_00_00_01","940","308",null,"30","7",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("37");
            this.div01_00.addChild(obj.name, obj);

            obj = new Edit("edt02_00_00_00_00_00_00_00_00","940","351",null,"30","7",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("38");
            this.div01_00.addChild(obj.name, obj);

            obj = new Static("Static00","940","384",null,"30","7",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("39");
            obj.set_text("단위 tCO2-eq가 아닌경우, 환산계수 및 근거를 입력해주세요.");
            obj.set_cssclass("sta_WF_Info");
            this.div01_00.addChild(obj.name, obj);

            obj = new Static("sta06_00_00_00_00_00_00_01","0","417",null,"172","0",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("40");
            obj.set_cssclass("sta_WF_LabelBg");
            this.div01_00.addChild(obj.name, obj);

            obj = new Static("sta05_00_00_00_00_00_00_00","0","417","150","172",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("41");
            obj.set_text("사업분야 및 방법론");
            obj.set_cssclass("sta_WF_Label_E");
            this.div01_00.addChild(obj.name, obj);

            obj = new Button("Button00",null,"428","98","30","7",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("44");
            obj.set_text("방법론 추가");
            obj.set_cssclass("btn_WF_Add");
            this.div01_00.addChild(obj.name, obj);

            obj = new Combo("cbo00_00_00_00_00_00_01_00",null,"428","227","30","Button00:3",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("43");
            obj.set_text("선택");
            obj.set_value("");
            obj.set_index("-1");
            ...
            obj = new Combo("cbo00_00_00_00_00_00_01",null,"428","227","30","cbo00_00_00_00_00_00_01_00:3",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("42");
            obj.set_text("선택");
            obj.set_value("");
            obj.set_index("-1");
            ...
            obj = new Grid("Grid00","157","466",null,"116","7",null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("45");
            ...
            obj = new Static("Static01","1439","458","120","8",null,null,null,null,null,null,this.div01_00.form);
            obj.set_taborder("46");
            obj.set_text("H8");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            ...
            obj = new Static("sta00_00_00","0","902","300","30",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("첨부파일정보");
            obj.set_cssclass("sta_WF_Title");
            this.addChild(obj.name, obj);

            obj = new Static("sta04_01_00","150","882","30","60",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            obj.set_text("H60");
            ...
            obj = new Static("sta00_00_00_00","0","1100","300","30",null,null,null,null,null,null,this);
            obj.set_taborder("12");
            obj.set_text("사업 참가자 정보");
            obj.set_cssclass("sta_WF_Title");
            this.addChild(obj.name, obj);

            obj = new Static("sta04_01_00_00","150","1080","30","60",null,null,null,null,null,null,this);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            obj.set_text("H60");
            ...
            obj = new Div("div01_01","0","1140",null,"214","30",null,null,null,null,null,this);
            obj.set_taborder("14");
            obj.set_formscrollbartype("none none");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("Static01_00","1446","1354","120","20",null,null,null,null,null,null,this);
            obj.set_taborder("16");
            obj.set_text("H20");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            ...
            obj = new Button("Button01",null,"1703","75","32","29",null,null,null,null,null,this);
            obj.set_taborder("17");
            obj.set_text("목록");
            ...
            obj = new Static("sta04_02_00_00","0","932","150","10",null,null,null,null,null,null,this);
            obj.set_taborder("21");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_text("H10");
            obj.set_visible("false");
            ...
            obj = new Static("sta04_02_00_00_00","0","1130","150","10",null,null,null,null,null,null,this);
            obj.set_taborder("22");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_text("H10");
            obj.set_visible("false");
            ...
            obj = new Button("Button01_00",null,"1703","75","32","Button01:3",null,null,null,null,null,this);
            obj.set_taborder("18");
            obj.set_text("신청");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);

            obj = new Button("Button01_00_00",null,"1703","88","32","Button01_00:3",null,null,null,null,null,this);
            obj.set_taborder("19");
            obj.set_text("임시저장");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);

            obj = new Static("sta04_01_00_00_00","140","1354","30","60",null,null,null,null,null,null,this);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_GSize");
            obj.set_visible("false");
            obj.set_text("H60");
            ...
            obj = new Static("sta00_00_00_00_00","0","1374","300","30",null,null,null,null,null,null,this);
            obj.set_taborder("24");
            obj.set_text("양도인");
            obj.set_cssclass("sta_WF_Title");
            this.addChild(obj.name, obj);

            obj = new Grid("Grid01","0","1414",null,"269","838",null,null,null,null,null,this);
            obj.set_taborder("25");
            ...
            obj = new Div("Div00",null,"1414","758","269","30",null,null,null,null,null,this);
            obj.set_taborder("26");
            ...
            obj = new Static("sta00_00_00_00_00_00","Grid01:50","1374","300","30",null,null,null,null,null,null,this);
            obj.set_taborder("27");
            obj.set_text("양도가능량");
            obj.set_cssclass("sta_WF_Title");
            this.addChild(obj.name, obj);
        ...
        this.loadIncludeScript("Temp_01.xfdl");
