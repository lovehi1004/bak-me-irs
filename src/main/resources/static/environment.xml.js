if (nexacro.Environment)
{
    ...
    env.loadTypeDefinition = function ()
    {
        ...
        nexacro._addService("vvvvv", "JSP", "ccccc://", "", null, "", "", "");
        ...
        nexacro._addService("svc", "JSP", "http://localhost:28080/irs/", "none", null, "", "0", "0");
    ...
    env.on_loadVariables = function ()
    {
        ...
        // HTTP Header
        nexacro.setHTTPHeaderVariable("Authorization");
        nexacro.setHTTPHeaderVariable("RefreshToken");
        nexacro.setHTTPHeaderVariable("IssueToken");
        nexacro.setHTTPHeaderVariable("ReissueToken");
    };
