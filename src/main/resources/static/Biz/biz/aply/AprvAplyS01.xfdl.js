(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divBizUnit","0","divH7:0",null,"1128","30",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_formscrollbartype("none none");
            obj.set_formscrolltype("none");
            obj.set_text("사업장명");
            ...
            obj = new Static("staLine13","0","837",null,"289","0",null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("24");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBizUnit.addChild(obj.name, obj);

            obj = new Static("staMhdlg","0","837","150","289",null,null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("25");
            obj.set_text("사업분야\r\n및 방법론");
            obj.set_cssclass("sta_WF_Label_E");
            this.divBizUnit.addChild(obj.name, obj);
            ...
            obj = new Grid("grdUnitMhdlg","157","893",null,"228","7",null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("30");
            obj.set_autofittype("col");
            obj.set_cssclass("grd_WF_NoneS");
            obj.set_selecttype("cell");
            ...
            obj = new Static("staLine14","0","793",null,"45","0",null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("42");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBizUnit.addChild(obj.name, obj);

            obj = new Static("staSopNm","0","793","150","45",null,null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("43");
            obj.set_text("SOP");
            obj.set_cssclass("sta_WF_Label");
            this.divBizUnit.addChild(obj.name, obj);

            obj = new Static("staOmgeNm","783","793","150","45",null,null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("44");
            obj.set_text("OMGE");
            obj.set_cssclass("sta_WF_Label");
            this.divBizUnit.addChild(obj.name, obj);

            obj = new Edit("edtBizFldCdSnm","157","846","543","30",null,null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("45");
            obj.set_cssclass("output");
            obj.set_readonly("true");
            obj.set_text("");
            ...
            obj = new Static("stcSop","161","803","209","30",null,null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("63");
            obj.set_fittocontents("width");
            this.divBizUnit.addChild(obj.name, obj);

            obj = new Edit("edtSopUnitCdNm","stcSop:3","803",null,"30","937",null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("50");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_font("italic 12px/normal \"NotoSansKR\"");
            ...
            obj = new Static("stcOmge","941","803","209","30",null,null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("64");
            obj.set_fittocontents("width");
            this.divBizUnit.addChild(obj.name, obj);

            obj = new Edit("edtOmge","stcOmge:3","803",null,"30","147",null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("51");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_font("italic 12px/normal \"NotoSansKR\"");
            ...
            obj = new CheckBox("chkReddPlusYn","300","846","236","30",null,null,null,null,null,null,this.divBizUnit.form);
            obj.set_taborder("58");
            obj.set_text("REDD+ 여부");
            obj.set_falsevalue("N");
            obj.set_truevalue("Y");
            ...
            obj = new Static("stcBfcnvrRdcqtyNo","274","107","129","30",null,null,null,null,null,null,this.divExcr.form);
            obj.set_taborder("23");
            obj.set_fittocontents("width");
            this.divExcr.addChild(obj.name, obj);

            obj = new Edit("edtBfcnvrRdcqty","stcBfcnvrRdcqtyNo:3","107","155","30",null,null,null,null,null,null,this.divExcr.form);
            obj.set_taborder("17");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_font("italic 12px/normal \"NotoSansKR\"");
            ...
            obj = new Static("stcAtcnvrRdcqtyNo","274","150","129","30",null,null,null,null,null,null,this.divExcr.form);
            obj.set_taborder("24");
            obj.set_fittocontents("width");
            this.divExcr.addChild(obj.name, obj);

            obj = new Edit("edtAtcnvrRdcqty","stcAtcnvrRdcqtyNo:3","150","156","30",null,null,null,null,null,null,this.divExcr.form);
            obj.set_taborder("18");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_font("italic 12px/normal \"NotoSansKR\"");
            ...
            obj = new Static("stcBfr","156","107","115","30",null,null,null,null,null,null,this.divExcr.form);
            obj.set_taborder("21");
            obj.set_text("환산 전 감축량 : ");
            this.divExcr.addChild(obj.name, obj);

            obj = new Static("stcAfr","156","150","115","30",null,null,null,null,null,null,this.divExcr.form);
            obj.set_taborder("22");
            obj.set_text("환산 후 감축량 : ");
            this.divExcr.addChild(obj.name, obj);
            ...
            obj = new BindItem("item141","divBizUnit.form.stcOmge","text","dsUniInfo","omgeRdcqty");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item142","divBizUnit.form.stcSop","text","dsUniInfo","sopRdcqty");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item143","divBizUnit.form.stcBfcnvrRdcqtyNo","text","dsUniInfo","bfcnvrRdcqty");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item144","divBizUnit.form.stcAtcnvrRdcqtyNo","text","dsUniInfo","atcnvrRdcqty");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("AprvAplyS01.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	// 사전심의결과파일(조회용)
        	var objFileParam7 = { objDs:this.dsDicDlbrList						// 바인딩 데이터셋
        	...
        	this.divDicDlbr.form.divDicDlbrRst.form.divRaonKSingleDic02.form.fnInitRaonK(this, objFileParam7);

        	// 이의신청결과파일(조회용)
        	var objFileParam8 = { objDs:this.dsDicDlbrList						// 바인딩 데이터셋
        	...
        	this.divDicDlbr.form.divDicDlbrOpnnRst.form.divRaonKSingleDicOpnn02.form.fnInitRaonK(this, objFileParam8);

        	// 심의결과파일(조회용)
        	var objFileParam9 = { objDs:this.dsDlbrList						// 바인딩 데이터셋
        	...
        	this.divDlbr.form.divDlbrRst.form.divRaonKSingleDlbr02.form.fnInitRaonK(this, objFileParam9);

        	// 심의-이의신청결과파일(조회용)
        	var objFileParam10 = { objDs:this.dsDlbrList						// 바인딩 데이터셋
        					,sBindCol:"objcAplyFlmno"							// 바인딩 컬럼
        					,sCallbackFunc:"fnRaonKFileCallback"				// 콜백함수명 , 필요시 추가
        	...
        	this.divDlbr.form.divDlbrOpnnRst.form.divRaonKSingleDlbrOpnn02.form.fnInitRaonK(this, objFileParam10);

        	// 착수보고파일(조회용)
        	var objFileParam11 = { objDs:this.dsKoffRst								// 바인딩 데이터셋
        	...
        	this.divKoff.form.divKoffRst.form.divRaonKMultiKoff02.form.fnInitRaonK(this, objFileParam11);

        	// 착수지연등록결과 (조회용)
        	var objFileParam12 = { objDs:this.dsDlayList								// 바인딩 데이터셋
        	...
        	this.divDlay.form.divDlayRegVew.form.divRaonKMultiDlay02.form.fnInitRaonK(this, objFileParam12);

        	// 착수지연 검토파일(조회용)
        	var objFileParam13 = { objDs:this.dsDlayList								// 바인딩 데이터셋
        	...
        	this.divDlay.form.divDlayRst.form.divRaonKSingleDlayDic02.form.fnInitRaonK(this, objFileParam13);

        	// 착수지연 심의파일(조회용)
        	var objFileParam14 = { objDs:this.dsDlayList								// 바인딩 데이터셋
        	...
        	this.divDlay.form.divDlayUsrRstDlbr.form.divRaonKSingleDlayDlbr02.form.fnInitRaonK(this, objFileParam14);

        	//-----------------------------------------------------------------------------------------------------------

        	// From-To 달력 초기화 호출 - 단위사업 심의 후 인증유효기간 갱신
        	var objParam1 = { objDs:this.dsPrdDlbr								// 바인딩 데이터셋
        	...
        	this.divBizUnit.form.divCalFromTo.form.fnInitCommonCalendar(this, objParam1);
        ...
        this.fnCallback = function(sSvcId, nErrCode, sErrMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		case "dtlInfo" :
        			...
        			// 변경사유
        			trace("******************************   1");
        			if(this.dsCurInfo.getColumn(0, "dgrRegRsnCd") == "BGC0001" || this.dsCurInfo.getColumn(0, "dgrRegRsnCd") == "BGC0005") {
        ...
        ***********************************************************************************/
        ...
        {
        	this.getOwnerFrame().form.divWork.form.divDetail.form.divReg.form.fnCallDicDlbrSave();
        };
        ...
        {
        	this.getOwnerFrame().form.divWork.form.divDetail.form.divReg.form.fnCallKoffSave();
        };
        ...
        this.divComBtn_btnDlayReg_onclick = function(obj,e)
        {
        	...
        	//착수지연 오픈.
        	this.getOwnerFrame().form.divWork.form.divDetail.form.divDlayReg.form.fnOpenDlay();
        ...
        this.divComBtn_btnKoffReg_onclick = function(obj,e)
        {
        	...
        	//착수보고 오픈.
        	this.getOwnerFrame().form.divWork.form.divDetail.form.divReg.form.fnOpenKoff();
        };

        // 착수지연 신청 저장
        this.divComBtn_btnDlaySave_onclick = function(obj,e)
        {
        	this.getOwnerFrame().form.divWork.form.divDetail.form.divDlayReg.form.fnCallDlayUsrSave();
        };

        //착수지연 결과 저장
        this.divComBtn_btnDlayRstSave_onclick = function(obj,e)
        {
        	this.getOwnerFrame().form.divWork.form.divDetail.form.divDlayReg.form.fnCallDlayDicDlbrSave();
        };
        ...
        this.dsExcrList_onrowposchanged = function(obj,e)
        {
        	...
        	var bfcnvrRdcqty = this.gfnAppendComma(this.dsExcrList.getColumn(this.dsExcrList.rowposition, "bfcnvrRdcqty"), 0);
        	bfcnvrRdcqty = bfcnvrRdcqty + " ";
        	trace("=============================================>>>bfcnvrRdcqty : " + bfcnvrRdcqty);
        	this.divExcr.form.stcBfcnvrRdcqtyNo.set_text(bfcnvrRdcqty);
        	var atcnvrRdcqty = this.gfnAppendComma(this.dsExcrList.getColumn(this.dsExcrList.rowposition, "atcnvrRdcqty"), 0);
        	atcnvrRdcqty = atcnvrRdcqty + " ";
        	trace("=============================================>>>atcnvrRdcqty : " + atcnvrRdcqty);
        	this.divExcr.form.stcAtcnvrRdcqtyNo.set_text(atcnvrRdcqty);
        	this.divExcr.form.resetScroll();
        };
        ...
        this.loadIncludeScript("AprvAplyS01.xfdl");
