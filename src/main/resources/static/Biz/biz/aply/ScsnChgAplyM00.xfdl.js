(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Dataset("dsScsnGbnCd", this);
            obj._setContents("<ColumnInfo><Column id=\"groupCdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"cdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"cdKornNm\" type=\"STRING\" size=\"256\"/><Column id=\"sortSeqo\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Combo("cboAplyClCd","150","30","180","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("3");
            ...
            obj = new Static("staBizFormCd","390","30","110","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("4");
            obj.set_text("사업형태");
            obj.set_cssclass("sta_WFSA_Label");
            this.divList.form.divSearch.addChild(obj.name, obj);
            ...
            obj = new Combo("cboBizFormCd","465","30","180","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("6");
            ...
            obj = new Static("staPrcsTypeCd","35","staAplyClCd:5","110","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("처리상태");
            obj.set_cssclass("sta_WFSA_Label");
            ...
            obj = new Static("staBizFldCd","390","staBizFormCd:5","110","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("8");
            obj.set_text("사업분야");
            obj.set_cssclass("sta_WFSA_Label");
            this.divList.form.divSearch.addChild(obj.name, obj);

            obj = new Static("staInstMngNo","695","30","110","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("관장기관");
            obj.set_cssclass("sta_WFSA_Label");
            this.divList.form.divSearch.addChild(obj.name, obj);

            obj = new Static("staBizDtlsFldCd","695","staInstMngNo:5","110","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("사업세부분야");
            obj.set_cssclass("sta_WFSA_Label");
            this.divList.form.divSearch.addChild(obj.name, obj);

            obj = new Static("staBizScalCd","35","staPrcsTypeCd:5","120","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("10");
            ...
            obj = new Static("staAddDataYn","695","staBizDtlsFldCd:5","110","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("자료요청");
            obj.set_cssclass("sta_WFSA_Label");
            this.divList.form.divSearch.addChild(obj.name, obj);

            obj = new Combo("cboPrcsTypeCd","150","cboAplyClCd:5","180","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("13");
            ...
            obj = new Combo("cboBizFldCd","465","cboBizFormCd:5","180","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("15");
            obj.set_cssclass("WFSA");
            ...
            obj = new Combo("cboInstMngNo","790","30","180","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("16");
            obj.set_cssclass("WFSA");
            ...
            obj = new Combo("cboBizDtlsFldCd","790","cboInstMngNo:5","180","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("17");
            obj.set_cssclass("WFSA");
            ...
            obj = new Combo("cboAddDataYn","790","cboBizDtlsFldCd:5","180","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("19");
            ...
            obj = new Edit("edtMhdlg","1111","edtBizNm:5","180","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("20");
            obj.set_cssclass("WFSA");
            obj.set_text("");
            this.divList.form.divSearch.addChild(obj.name, obj);
            ...
            obj = new Button("btnReg",null,null,"150","32","39","grdList:10",null,null,null,null,this.divList.form);
            obj.set_taborder("3");
            obj.set_text("권리의무승계 신청");
        ...
        // User Script
        this.registerScript("ScsnChgAplyM00.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        this.fnCallLstBtnCtrl = function()
        {
        	...
        	if(this.fvApp.User.roleIdMgno == "RL00000004"
        		...
        		callUrl = "/biz/aply/scsnChgAply/selectScsnChgAplyLstBtnCtrl.irs";
        	}else {
        		callUrl = "/adm/aply/scsnChgAply/selectScsnChgAplyLstBtnCtrl.irs";
        	}
        ...
        this.fnCallSearchList = function()
        {
        	...
        	if(this.fvApp.User.roleIdMgno == "RL00000004"
        		...
        		callUrl = "/biz/aply/scsnChgAply/selectScsnChgAplyList.irs";
        	}else {
        		callUrl = "/adm/aply/scsnChgAply/selectScsnChgAplyList.irs";
        	}
        ...
        this.fnCallComCdoe = function()
        {
        	...
        	arrParam[24] = {outDs:"dsScsnGbnCd", 	groupId:"SCSN_GBN_CD", 	useYn:"Y"};
        ...
        ***********************************************************************************/
        ...
        this.divList_grdList_oncellclick = function(obj,e)
        {
        	...
        	if(this.cellNo == 16 || this.cellNo == 6) {
        		if(!this.isCallDtlPage) {		// 최초 처음 로딩 필요.
        			...
        			this.divReg.set_url("");
        			this.divDetail.set_url("");
        			this.divDetail.set_url("Biz_biz::aply/ScsnChgAplyS01.xfdl");
        		}
        		else {
        ...
        this.divList_btnReg_onclick = function(obj,e)
        {
        	if(!this.isCallRegPage) {		// 최초 처음 로딩 필요.
        		...
        		this.divDetail.set_url("");
        		this.divReg.set_url("");
        		this.divReg.set_url("Biz_biz::aply/ScsnChgAplyS02.xfdl");
        	}
        	else {
        		this.isFuncId = "SCSN1";
        		this.fnCallRegPage();
        ...
        this.fnRegLoadComplete = function()
        {
        	...
        	if(this.isFuncId == "SCSN1") {
        		this.fnCallRegPage();
        	}
        	else if(this.isFuncId == "SCSN2") {
        		this.divDetail.form.fnCallDoc();
        	}
        	else if(this.isFuncId == "SCSN3") {
        		this.divDetail.form.fnCallMod();
        	}
        	else if(this.isFuncId == "SCSN4") {
        ...
        this.divList_btnExcelDown_onclick = function(obj,e)
        {
        	...
        	this.fdtExcel.setPostData("downloadExcelFileNm","권리의무승계목록.xlsx");
        	this.fdtExcel.setPostData("sheetname","권리의수승계내역");
        ...
        this.loadIncludeScript("ScsnChgAplyM00.xfdl");
