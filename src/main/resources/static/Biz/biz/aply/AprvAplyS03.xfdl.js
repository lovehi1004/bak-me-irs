(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edtCalFromTo","157","468",null,"30","10",null,null,null,null,null,this.divRPrgm.form);
            obj.set_taborder("28");
            obj.set_cssclass("output");
            obj.set_readonly("true");
            obj.set_text("");
            ...
            obj = new Edit("edtCertVldYmd","157","636","303","30",null,null,null,null,null,null,this.divRBizUnit.form);
            obj.set_taborder("64");
            obj.set_cssclass("output");
            obj.set_readonly("true");
            obj.set_text("");
            ...
            obj = new BindItem("item73","divRPrgm.form.edtCalFromTo","value","dsPgmInfo","certVldYmd");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item74","divRBizUnit.form.edtAgreeClausCd","value","dsUniInfo","agreeClausCdNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item75","divRBizUnit.form.edtBizFormCd","value","dsUniInfo","bizFormCdNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item76","divRBizUnit.form.edtCertVldYmd","value","dsUniInfo","certVldYmd");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item77","divRPrgm.form.edtBizFldCdSnm","value","dsPgmInfo","bizFldCdSnm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item78","divRBizUnit.form.edtBizFldCdSnm","value","dsUniInfo","bizFldCdSnm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item79","divChgCn.form.chkTrsmYn","value","dsUniInfo","trsmYn");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item80","divChgCn.form.taeChgCn","value","dsUniInfo","chgCn");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item81","divPrgm.form.stcAgreeMgnoNm","text","dsPgmInfo","agreeMgnoNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item82","divPrgm.form.stcAgreeMgnoNm","tooltiptext","dsPgmInfo","agreeMgnoNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item83","divRPrgm.form.stcAgreeMgnoNm","text","dsPgmInfo","agreeMgnoNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item84","divRPrgm.form.stcAgreeMgnoNm","tooltiptext","dsPgmInfo","agreeMgnoNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item85","divRBizUnit.form.stcAgreeMgnoNm","text","dsUniInfo","agreeMgnoNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item86","divRBizUnit.form.stcAgreeMgnoNm","tooltiptext","dsUniInfo","agreeMgnoNm");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("AprvAplyS03.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.form_oninit = function(obj,e)
        {
        	...
        	this.getOwnerFrame().form.divWork.form.fnChgLoadComplete();
        	trace("====================  M00에 로딩 완료여부 전달. ========================");
        };
        ...
        */
        ...
        this.fnCallValidCheckDivRBizUnit = function()
        {
        	...
        	if(this.gfnIsNull(atcnvrRdcqty)) {
        		this.divRBizUnit.form.mseAtcnvrRdcqty.set_cssclass("error");
        		this.divRBizUnit.form.mseAtcnvrRdcqty.setFocus();
        		this.gfnShowMessage(this, "W000025", "연평균 온실가스 배출 감축량", "fnMsgCallback", "msgAlert01");
        		return false;
        ...
        this.loadIncludeScript("AprvAplyS03.xfdl");
