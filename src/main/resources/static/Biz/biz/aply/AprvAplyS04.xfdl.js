(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj.set_cssclass("output");
            obj.set_readonly("true");
            obj.set_value("인증유효기간 갱신");
            obj.set_text("인증유효기간 갱신");
            this.divRCmm.addChild(obj.name, obj);
            ...
            obj = new BindItem("item70","divRPrgm.form.chkReddPlusYn","value","dsUniInfo","reddPlusYn");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item72","divRPrgm.form.edtAgreeClausCd","value","dsPgmInfo","agreeClausCdNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item73","divRBizUnit.form.edtAgreeClausCd","value","dsUniInfo","agreeClausCdNm");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item76","divRBizUnit.form.edtKoffPrnmntYmd","value","dsUniInfo","koffPrnmntYmdNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item77","divRBizUnit.form.taeCnvrBassCn","value","dsUniInfo","cnvrBassCn");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item82","divRBizUnit.form.mseSopUnitCdNm","value","dsUniInfo","sopRdcqty");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item83","divRBizUnit.form.edtSopUnitCdNm","value","dsUniInfo","sopUnitCdNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item84","divRExcr.form.edtDmstClCd","value","dsExcrList","dmstClCdNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item85","divRExcr.form.taeCnvrBassCn","value","dsExcrList","cnvrBassCn");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item86","divRExcr.form.edtAgreYn","value","dsExcrList","lstAgreYnNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item87","divRPrgm.form.edtBizFldCdSnm","value","dsPgmInfo","bizFldCdSnm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item88","divRBizUnit.form.edtBizFldCdSnm","value","dsUniInfo","bizFldCdSnm");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("AprvAplyS04.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.form_oninit = function(obj,e)
        {
        	...
        	this.getOwnerFrame().form.divWork.form.fnPrdLoadComplete();
        	trace("====================  M00에 로딩 완료여부 전달. ========================");
        };
        ...
        */
        ...
        this.loadIncludeScript("AprvAplyS04.xfdl");
