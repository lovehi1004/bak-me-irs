(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divPop","45","89",null,"490","45",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Grid("grdList","5","0",null,"465","5",null,null,null,null,null,this.divPop.form);
            obj.set_taborder("0");
            obj.set_autofittype("none");
            obj.set_cellsizingtype("col");
            obj.set_scrolltype("horizontal");
            obj.set_binddataset("dsUniList");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"208\"/><Column size=\"97\"/><Column size=\"118\"/><Column size=\"118\"/><Column size=\"92\"/><Column size=\"134\"/><Column size=\"69\"/></Columns><Rows><Row size=\"22\" band=\"head\"/><Row size=\"21\" band=\"head\"/><Row size=\"22\"/><Row size=\"21\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"번호\"/><Cell col=\"1\" rowspan=\"2\" text=\"단위사업명\"/><Cell col=\"2\" rowspan=\"2\" text=\"신청일자\"/><Cell col=\"3\" text=\"인증유효\" border=\"1px solid #bfd2e7,1px solid #bfd2e7,0px solid #bfd2e7\"/><Cell col=\"4\" text=\"시작일자\"/><Cell col=\"5\" rowspan=\"2\" text=\"처리상태\"/><Cell col=\"6\" rowspan=\"2\" text=\"사업수행자\"/><Cell col=\"7\" rowspan=\"2\" text=\"조회\"/><Cell row=\"1\" col=\"3\" text=\"기간유형\"/><Cell row=\"1\" col=\"4\" text=\"종료일자\" border=\"0px solid #bfd2e7,1px solid #bfd2e7,1px solid #bfd2e7\"/></Band><Band id=\"body\"><Cell rowspan=\"2\" textAlign=\"center\" text=\"bind:rn\" tooltiptext=\"bind:rn\"/><Cell col=\"1\" rowspan=\"2\" textAlign=\"left\" tooltiptext=\"bind:bizKrnNm\" text=\"expr:dataset.parent.gfnGetRealColSizeText(comp, bizOrgtNm, currow, 1)\"/><Cell col=\"2\" rowspan=\"2\" textAlign=\"center\" text=\"bind:aplyYmd\" tooltiptext=\"bind:aplyYmd\"/><Cell col=\"3\" rowspan=\"2\" textAlign=\"center\" text=\"bind:certVldTypeCdNm\" tooltiptext=\"bind:certVldTypeCdNm\"/><Cell col=\"4\" textAlign=\"center\" border=\"1px solid #dcdee4,1px solid #eeeff3,0\" text=\"bind:certVldBgngYmd\" tooltiptext=\"bind:certVldBgngYmd\"/><Cell col=\"5\" rowspan=\"2\" displaytype=\"normal\" edittype=\"none\" padding=\"10px\" text=\"bind:prcsTypeCdNm\" tooltiptext=\"bind:prcsTypeCdNm\" textAlign=\"center\"/><Cell col=\"6\" rowspan=\"2\" text=\"bind:bzentNm\" tooltiptext=\"bind:bzentNm\" textAlign=\"center\"/><Cell col=\"7\" rowspan=\"2\" text=\"조회\" displaytype=\"buttoncontrol\" edittype=\"button\" padding=\"5px\" textAlign=\"center\"/><Cell row=\"1\" col=\"4\" text=\"bind:certVldEndYmd\" tooltiptext=\"bind:certVldEndYmd\" textAlign=\"center\" border=\"0,1px solid #eeeff3,1px solid #dcdee4\"/></Band></Format></Formats>");
        ...
        // User Script
        this.registerScript("AprvAplyP02.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	var prgrmMngNo 	= this.gfnGetParameter(objFormFrame, "prgrmMngNo");
        	...
        	this.dsSrh.setColumn(0, "prgrmMngNo", prgrmMngNo);
        ...
        ***********************************************************************************/
        this.fnCallSearchList = function()
        {
        	...
        	if(this.fvApp.User.roleIdMgno == "RL00000004"
        		...
        		callUrl = "/biz/aply/aprvAply/selectAprvAplyUnitList.irs";
        	}else {
        		callUrl = "/adm/aply/aprvAply/selectAprvAplyUnitList.irs";
        	}
        	...
        	// 공통Transaction 호출
         	...
         	objArgs.outds     		= "dsUniList=dsUniList";
         	objArgs.args 			= "";
        ...
        ***********************************************************************************/
        ...
        {
        	var strRtn = this.gfnSetPopupReturn({flag:"OPEN"
        										,bizMngNo:this.dsUniList.getColumn(e.row, "bizMngNo")
        										,bizDgr:this.dsUniList.getColumn(e.row, "bizDgr")
        										,bizTypeCd:this.dsUniList.getColumn(e.row, "bizTypeCd")
        										,dgrRegRsnCd:this.dsUniList.getColumn(e.row, "dgrRegRsnCd")});
        	//trace("=====strRtn========"+strRtn);
        	this.gfnPopupClose(this, strRtn);
        };
        ...
        this.loadIncludeScript("AprvAplyP02.xfdl");
