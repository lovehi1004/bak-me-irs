(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"no\" type=\"STRING\" size=\"256\"/><Column id=\"cnsltngrpMgno\" type=\"STRING\" size=\"256\"/><Column id=\"cncldDgr\" type=\"STRING\" size=\"256\"/><Column id=\"cnsltngrpNm\" type=\"STRING\" size=\"256\"/><Column id=\"cnsltngrpCmpsYmd\" type=\"STRING\" size=\"256\"/><Column id=\"ntnNm\" type=\"STRING\" size=\"256\"/><Column id=\"ntnCd\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSrh", this);
            obj._setContents("<ColumnInfo><Column id=\"srhCnsltngrpNm\" type=\"STRING\" size=\"256\"/><Column id=\"cncldClCd\" type=\"STRING\" size=\"256\"/><Column id=\"ntnCd\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staCncldNm","38","31","95","32",null,null,null,null,null,null,this.divPop.form.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("협의체명");
            obj.set_cssclass("sta_WFSA_Label");
            this.divPop.form.divSearch.addChild(obj.name, obj);

            obj = new Edit("edtSrhCnsltngrpNm","133","31","372","32",null,null,null,null,null,null,this.divPop.form.divSearch.form);
            obj.set_taborder("3");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"243\"/><Column size=\"161\"/><Column size=\"140\"/><Column size=\"105\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"27\"/><Row size=\"27\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"번호\"/><Cell col=\"1\" rowspan=\"2\" text=\"국제감축협의체명\"/><Cell col=\"2\" rowspan=\"2\" text=\"협의체구성일자\"/><Cell col=\"3\" rowspan=\"2\" text=\"체결국가\"/><Cell col=\"4\" rowspan=\"2\" text=\"선택\"/></Band><Band id=\"body\"><Cell rowspan=\"2\" textAlign=\"center\" text=\"bind:no\" tooltiptext=\"bind:no\"/><Cell col=\"1\" rowspan=\"2\" textAlign=\"center\" text=\"bind:cnsltngrpNm\" tooltiptext=\"bind:cncldClCdNm\"/><Cell col=\"2\" rowspan=\"2\" textAlign=\"center\" text=\"bind:cnsltngrpCmpsYmd\" tooltiptext=\"bind:cncldDgrNm\"/><Cell col=\"3\" rowspan=\"2\" text=\"bind:ntnNm\" tooltiptext=\"bind:ntnNm\"/><Cell col=\"4\" rowspan=\"2\" displaytype=\"buttoncontrol\" edittype=\"button\" padding=\"10px\" text=\"bind:btnNm\" tooltiptext=\"bind:btnNm\" textAlign=\"center\"/></Band></Format></Formats>");
            this.divPop.addChild(obj.name, obj);
            ...
            obj = new BindItem("item1","divPop.form.divSearch.form.edtSrhCnsltngrpNm","value","dsSrh","srhCncldNm");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("CnsltngrpP01.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	var ntnCd = this.gfnGetParameter(objFormFrame, "ntnCd");
        	...
        	if( ntnCd != '') {
        		this.dsSrh.setColumn(0, "ntnCd", ntnCd);
        	}
        ...
        ***********************************************************************************/
        this.fnCallSearchList = function()
        {
        	...
        	// 공통Transaction 호출
        	var callUrl = "/adm/cnsltngrp/cnsltngrpMng/selectCnsltngrpPopList.irs";
        ...
        */
        ...
        this.divPop_grdList_oncellclick = function(obj,e)
        {
        	...
        	if(e.cell == 4)
        	{
        		var strRtn = this.gfnSetPopupReturn({ cnsltngrpMgno:this.dsList.getColumn(e.row, "cnsltngrpMgno"),  cncldMgno:this.dsList.getColumn(e.row, "cncldMgno"),cnsltngrpNm:this.dsList.getColumn(e.row, "cnsltngrpNm")
        											 ,cnsltngrpCmpsYmd:this.dsList.getColumn(e.row, "cnsltngrpCmpsYmd"), ntnNm:this.dsList.getColumn(e.row, "ntnNm")
        ...
        this.loadIncludeScript("CnsltngrpP01.xfdl");
