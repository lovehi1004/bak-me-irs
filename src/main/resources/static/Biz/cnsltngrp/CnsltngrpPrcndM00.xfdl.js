(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("국제감축협의체현황 목록");
        ...
        // User Script
        this.registerScript("CnsltngrpPrcndM00.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Develop_Sample
        * BUSINESS      : CnsltngrpPrcndM00 Form
        * FILE NAME     : CnsltngrpPrcndM00.xfdl
        * DESCRIPTION   : 국제감축협의체 현황 (목록)
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        {
        	trace("[CnsltngrpPrcndM00]Form onload 후 필요(설정)시 실행되는 callback 함수 ");


        	// 국제감축협의체 상세
        	this.divDetail01.set_url("Biz_cnsltngrp::CnsltngrpPrcndS01.xfdl");
        ...
        ***********************************************************************************/
        this.fnCallSearchList = function()
        {
        	...
        	// 공통Transaction 호출
         	...
         	objArgs.url 			= "/biz/cnsltngrp/cnsltngrpPrcnd/selectCnsltngrpPrcndList.irs";
        ...
        ***********************************************************************************/
        ...
        {
            var url = nexacro.getApplication().Tran.fwUrl + "/biz/cnsltngrp/cnsltngrpPrcnd/selectCnsltngrpPrcndExcel.irs";
        	...
        	this.fdtExcel.setPostData("downloadExcelFileNm","국제감축협의체현황목록.xlsx");
        	this.fdtExcel.setPostData("sheetname","국제감축협의체현황");
        ...
        this.loadIncludeScript("CnsltngrpPrcndM00.xfdl");
