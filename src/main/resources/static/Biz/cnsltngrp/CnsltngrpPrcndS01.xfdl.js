(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("국제감축협의체현황 상세");
            ...
            obj = new Div("divCnsltngrpDetail","0","305",null,"810","30",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Button("btnBackList",null,"738","75","32","0",null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("1");
            obj.set_text("목록");
            obj.set_cssclass("btn_WF_CrudSub");
            this.divCnsltngrpDetail.addChild(obj.name, obj);
            ...
            obj = new Static("staUsrInfoL2_00_00_00","0","221",null,"44","0",null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_LabelBg");
            this.divCnsltngrpDetail.addChild(obj.name, obj);

            obj = new Static("staBzentNm01_01_00_00","0","221","150","44",null,null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("12");
            obj.set_text("협의체명");
            obj.set_cssclass("sta_WF_Label");
            this.divCnsltngrpDetail.addChild(obj.name, obj);

            obj = new Static("sta07_00_00_00","1","579",null,"154","0",null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divCnsltngrpDetail.addChild(obj.name, obj);

            obj = new Grid("Grid00","158","597",null,"77","0",null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("14");
            ...
            obj = new Button("btn01_00","158","681","90","30",null,null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("15");
            obj.set_text("전체다운로드");
            ...
            obj = new Static("sta08_00_00_00_00","1","579","150","154",null,null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("16");
            obj.set_text("관련문서");
            obj.set_cssclass("sta_WF_Label");
            this.divCnsltngrpDetail.addChild(obj.name, obj);

            obj = new Static("sta07_00_00_00_01","0","265",null,"175","0",null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divCnsltngrpDetail.addChild(obj.name, obj);

            obj = new Static("sta08_00_00_00_00_01","0","265","150","175",null,null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("18");
            obj.set_text("구성원");
            obj.set_cssclass("sta_WF_Label");
            this.divCnsltngrpDetail.addChild(obj.name, obj);

            obj = new Grid("grdNtnList","157","275",null,"157","0",null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("19");
            ...
            obj = new Static("staBzentNm01_01_00_00_00_00_00_00_00","805","221","150","44",null,null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("20");
            obj.set_text("협의체구성일자");
            obj.set_cssclass("sta_WF_Label");
            this.divCnsltngrpDetail.addChild(obj.name, obj);

            obj = new Static("sta07_00_00_00_00","0","436",null,"154","0",null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("21");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divCnsltngrpDetail.addChild(obj.name, obj);

            obj = new Static("sta08_00_00_00_00_00","0","436","150","154",null,null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("22");
            obj.set_text("협의내용");
            obj.set_cssclass("sta_WF_Label");
            this.divCnsltngrpDetail.addChild(obj.name, obj);
            ...
            obj = new Edit("edtNm00","156","50","1190","30",null,null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("24");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Edit("edtCnsltngrpNm","156","227","643","30",null,null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("28");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Edit("edtCnsltngrpCmpsYmd","959","229","566","0",null,null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("29");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Static("staUsrInfo00","0","183","360","30",null,null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("30");
            ...
            obj = new Edit("edtCnsltnCn",null,"460","1405","129","0",null,null,null,null,null,this.divCnsltngrpDetail.form);
            obj.set_taborder("31");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Static("staUsrInfo","0","253","360",null,null,"845",null,null,null,null,this);
            obj.set_taborder("2");
        ...
        // User Script
        this.registerScript("CnsltngrpPrcndS01.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        this.fnCallDtlInfo = function()
        {
        	...
        	// 공통Transaction 호출
         	...
         	objArgs.url 			= "/biz/cnsltngrp/cnsltngrpPrcnd/selectCnsltngrpPrcndDetail.irs";
         	objArgs.inds      		= "dsCurInfo=dsCurInfo ";
         	objArgs.outds     		= "dsCnsltngrpInfo=dsCnsltngrpInfo dsMemberList=dsMemberList dsDocList=dsDocList dsAgrInfo=dsAgrInfo";
         	objArgs.args 			= "";
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divCnsltngrpDetail.form.sta08_00_00_00_00_00.addEventHandler("onclick",this.sta08_00_00_00_00_onclick,this);
        ...
        this.loadIncludeScript("CnsltngrpPrcndS01.xfdl");
