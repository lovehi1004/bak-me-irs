(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("FAQBoardS01.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_Common
        * BUSINESS      : FAQ 상세화면
        * FILE NAME     : FAQBoardS01.xfdl
        * DESCRIPTION   : FAQ 상세화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        {
        	trace("[divFAQBoardS01]Form onload 후 필요(설정)시 실행되는 callback 함수 ");
        	...
        	this.getOwnerFrame().form.fnLoadComplete('FAQBoardS01');
        ...
        */
        ...
        {
        	this.getOwnerFrame().form.fnFAQBoardCall()
        };
        ...
        this.loadIncludeScript("FAQBoardS01.xfdl");
