(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divBoardInfo","55","22",null,"638","55",null,"1130",null,null,null,this);
            obj.set_taborder("0");
            obj.set_formscrollbartype("none none");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("staPstatNmArea","0","0",null,"44","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staPstatNm","0","0","150","44",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("0");
            obj.set_text("제목");
            ...
            obj = new Edit("edtPstatNm","157","7",null,"30","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("1");
            ...
            obj = new Static("staPstatCnArea","0","staPstatNmArea:-1",null,"224","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staPstatCn","0","staPstatNm:-1","150","224",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("2");
            obj.set_text("내용");
            obj.set_cssclass("sta_WF_Label");
            this.divBoardInfo.addChild(obj.name, obj);
            ...
            obj = new Button("btnList",null,"579","75","32","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("11");
            obj.set_text("목록");
            ...
            obj = new Button("btnUpdate",null,"579","75","32","btnList:3",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("10");
            obj.set_text("수정");
            ...
            obj = new TextArea("txaPstatCn","157","51",null,"208","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("3");
            obj.set_enable("true");
            ...
            obj = new Static("staPostPstatNmArea","0","staFlmnoArea:-1",null,"44","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("15");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staPostPstatNm","0","staFlmno:-1","150","44",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("6");
            obj.set_text("다음글");
            obj.set_cssclass("sta_WF_Label");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Edit("edtPostPstatNm","157","479",null,"30","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("7");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_accessibilitylabel("다음글");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staPrePstatNmArea","0","staPostPstatNmArea:-1",null,"44","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("16");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Edit("edtPrePstatNm","157","522",null,"30","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("9");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_accessibilitylabel("이전글");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staPrePstatNm","0","staPostPstatNm:-1","150","44",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("8");
            obj.set_text("이전글");
            obj.set_cssclass("sta_WF_Label");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Div("divEtcMultiFile","157","274",null,"190","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("5");
            ...
            obj = new BindItem("item29","divBoardInfo.form.edtPrePstatNm","value","dsBbsInfo","prePstatNm");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("NoticeBoardS01.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_Common
        * BUSINESS      : 공지사항 상세화면
        * FILE NAME     : NoticeBoardS01.xfdl
        * DESCRIPTION   : 공지사항 상세화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        {
        	trace("[divNoticeBoardS01]Form onload 후 필요(설정)시 실행되는 callback 함수 ");
        	...
        	this.getOwnerFrame().form.fnLoadComplete('NoticeBoardS01');
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divBoardInfo.form.edtPrePstatNm.addEventHandler("oneditclick",this.divBoardInfo_edtRrePstatNm_oneditclick,this);
        };
        this.loadIncludeScript("NoticeBoardS01.xfdl");
