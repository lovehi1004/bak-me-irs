(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdList","155","189",null,"453","155",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_autofittype("col");
            obj.set_binddataset("dsList");
            obj.set_cssclass("grd_Bd_List");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"60\"/><Column size=\"60\"/><Column size=\"150\"/><Column size=\"450\"/><Column size=\"300\"/><Column size=\"100\"/><Column size=\"120\"/><Column size=\"60\"/></Columns><Rows><Row size=\"42\" band=\"head\"/><Row size=\"51\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"구분\"/><Cell col=\"2\" text=\"체결국가\"/><Cell col=\"3\" text=\"협정명원문\"/><Cell col=\"4\" text=\"협정명국문\"/><Cell col=\"5\" text=\"조약번호\"/><Cell col=\"6\" text=\"서명일자\"/><Cell col=\"7\" text=\"조회\" cssclass=\"bdNone\"/></Band><Band id=\"body\"><Cell text=\"bind:번호\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:구분\" textAlign=\"center\"/><Cell col=\"2\" text=\"bind:체결국가\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:협정명원문\"/><Cell col=\"4\" text=\"bind:협정명국문\"/><Cell col=\"5\" text=\"bind:조약번호\" textAlign=\"center\"/><Cell col=\"6\" text=\"bind:서명일자\" textAlign=\"center\"/><Cell col=\"7\" text=\"조회\" textAlign=\"center\" cssclass=\"Cell_Grd_Btn, bdNone\" edittype=\"button\" displaytype=\"buttoncontrol\" padding=\"12px 10px\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("sta00","35","31","50","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("구분");
            ...
            obj = new Combo("cbo02_00","85","31","130","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            obj = new Combo("cbo02_00_00","325","31","150","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_cssclass("WFSA");
            ...
            obj = new Static("sta01_00","245","31","80","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("등록유형");
            obj.set_cssclass("sta_WFSA_Label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edt09","585","31","300","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_cssclass("WFSA");
            obj.set_text("");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta01_00_00","505","30","80","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("체결국가");
            obj.set_cssclass("sta_WFSA_Label");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("AgrStiplCmmInfoM00.xfdl","");
