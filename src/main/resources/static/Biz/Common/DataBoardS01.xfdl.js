(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divBoardInfo","55","22",null,"618","55",null,"1130",null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new TextArea("txaPstatCn","157","53",null,"208","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("3");
            obj.set_enable("true");
            ...
            obj = new Div("divEtcMultiFile","157","staFlmnoArea:-199",null,"190","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("5");
            obj.set_url("Frame_Common::comRaonK.xfdl");
            obj.set_text("");
            obj.set_accessibilitylabel("첨부파일");
            this.divBoardInfo.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("DataBoardS01.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_Common
        * BUSINESS      : 자료실 상세화면
        * FILE NAME     : DataBoardS01.xfdl
        * DESCRIPTION   : 자료실 상세화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.getOwnerFrame().form.fnLoadComplete('DataBoardS01');
        ...
        */
        ...
        this.loadIncludeScript("DataBoardS01.xfdl");
