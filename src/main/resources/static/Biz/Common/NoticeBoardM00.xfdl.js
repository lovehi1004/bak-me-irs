(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdList","55","64",null,null,"55","98",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_autofittype("col");
            obj.set_binddataset("dsList");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"60\"/><Column size=\"150\"/><Column size=\"600\"/><Column size=\"90\"/><Column size=\"120\"/><Column size=\"90\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"구분\"/><Cell col=\"2\" text=\"제목\"/><Cell col=\"3\" text=\"조회수\"/><Cell col=\"4\" text=\"등록일자\"/><Cell col=\"5\" text=\"조회\" cssclass=\"bdNone\"/></Band><Band id=\"body\"><Cell textAlign=\"center\" text=\"bind:no\" tooltiptext=\"bind:no\"/><Cell col=\"1\" textAlign=\"center\" text=\"bind:typeNm\" tooltiptext=\"bind:typeNm\"/><Cell col=\"2\" textAlign=\"left\" text=\"bind:pstatNm\" tooltiptext=\"bind:pstatNm\"/><Cell col=\"3\" displaytype=\"normal\" edittype=\"none\" text=\"bind:inqCnt\" tooltiptext=\"bind:inqCnt\" textAlign=\"center\"/><Cell col=\"4\" displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" text=\"bind:regDt\" tooltiptext=\"bind:regDt\"/><Cell col=\"5\" displaytype=\"buttoncontrol\" edittype=\"button\" cssclass=\"Cell_WF_Search, bdNone\" textAlign=\"center\" accessibilitylabel=\"상세화면전환\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("staTotCnt","55",null,"140","32",null,"grdList:10",null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Div("divPaging","155","grdList:25",null,"20","155",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_url("Frame_Common::comPaging.xfdl");
            obj.set_text("  ");
            this.addChild(obj.name, obj);

            obj = new Button("btnNoticeReg",null,null,"80","32","55","grdList:10",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("등록");
            ...
            obj = new Button("btnSearch",null,"22","32","32","btnNoticeReg:4",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_cssclass("btn_WF_SchSmall");
            obj.set_accessibilitylabel("검색");
            this.addChild(obj.name, obj);

            obj = new Edit("edtSrhNm",null,"22","242","32","btnSearch:3",null,null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj = new Combo("cboSrh",null,"22","100","32","edtSrhNm:3",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_cssclass("WFSA");
            obj.set_accessibilitylabel("검색구분");
            var cboSrh_innerdataset = new nexacro.NormalDataset("cboSrh_innerdataset", obj);
            cboSrh_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">nm</Col><Col id=\"datacolumn\">제목</Col></Row><Row><Col id=\"codecolumn\">cn</Col><Col id=\"datacolumn\">내용</Col></Row></Rows>");
            obj.set_innerdataset(cboSrh_innerdataset);
            obj.set_text("제목");
            obj.set_value("nm");
            obj.set_index("0");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item0","edtSrhNm","value","dsSrh","srhNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item1","cboSrh","value","dsSrh","GbCd");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("NoticeBoardM00.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_Common
        * BUSINESS      : 공지사항 목록화면
        * FILE NAME     : NoticeBoardM00.xfdl
        * DESCRIPTION   : 공지사항 목록화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        {
        	trace("[NoticeBoardM00]Form onload 후 필요(설정)시 실행되는 callback 함수 ");
        	...
        	this.getOwnerFrame().form.fnLoadComplete('NoticeBoardM00');
        	this.getOwnerFrame().form.fnSearchAreaCtrl();
        	// 페이지표시 Div 초기화
        ...
        ***********************************************************************************/
        this.fnChangeDiv = function(objArgs)
        {
        	// TODO
        	this.getOwnerFrame().form.fnSearchAreaCtrl();
        	trace("[NoticeBoardM00]fnChangeDiv =========================");
        	this.scrollTo(0,0);
        	...
        	{
        		this.btnNoticeReg.set_visible(true);
        		this.btnNoticeReg.set_width(80);
        		this.btnSearch.set_right("btnNoticeReg:4");
        	}else
        	{
        		this.btnNoticeReg.set_visible(false);
        		this.btnNoticeReg.set_width(0);
        		this.btnSearch.set_right(55);
        	}
        	this.resetScroll();
        	this.fnSearch();
        	// 상세 호출
        ...
        */
        ...
        this.grdList_oncellclick = function(obj,e)
        {
        	if(e.col == 2 || e.col == 5)
        	{
        		...
        		this.getOwnerFrame().form.fnNoticeBoardDtlCall(objArgs);
        	}
        };

        this.btnNoticeReg_onclick = function(obj,e)
        {
        	if(this.fnAccessAuth(this.roleIdMgno))
        	{
        		var objArgs ={};
        		...
        		objArgs.sts = "REG"
        		this.getOwnerFrame().form.fnNoticeBoardRegCall(objArgs);
        	}else
        	{
        ...
        this.divSearch_edtSrhNm_onkeydown = function(obj,e)
        {
        	...
        	{
        		trace("111 ======================================> "  + e.keycode);
        		this.dsSrh.setColumn(0, "srhNm", this.edtSrhNm.text);
        		this.dsPageInfo.setColumn(0, "pageNo", 1);	// 페이지 초기화
        		this.fnSearch();
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.btnNoticeReg.addEventHandler("onclick",this.btnNoticeReg_onclick,this);
            this.btnSearch.addEventHandler("onclick",this.divSearch_btnSearch_onclick,this);
            this.edtSrhNm.addEventHandler("onkeydown",this.divSearch_edtSrhNm_onkeydown,this);
            this.cboSrh.addEventHandler("canitemchange",this.divSearch_cboSrh_canitemchange,this);
        };
        this.loadIncludeScript("NoticeBoardM00.xfdl");
