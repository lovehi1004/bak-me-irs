(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Grid("grdList","155","divSearch:81",null,null,"155","108",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_autofittype("col");
            obj.set_binddataset("dsList");
            obj.set_cssclass("grd_Bd_List");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"42\"/><Column size=\"76\"/><Column size=\"600\"/><Column size=\"80\"/><Column size=\"100\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"구분\"/><Cell col=\"2\" text=\"제목\"/><Cell col=\"3\" text=\"조회수\"/><Cell col=\"4\" text=\"등록일자\" cssclass=\"bdNone\"/></Band><Band id=\"body\"><Cell textAlign=\"center\" text=\"bind:no\" tooltiptext=\"bind:no\"/><Cell col=\"1\" textAlign=\"center\" text=\"bind:typeNm\" tooltiptext=\"bind:typeNm\"/><Cell col=\"2\" textAlign=\"center\" text=\"bind:pstatNm\" tooltiptext=\"bind:pstatNm\"/><Cell col=\"3\" displaytype=\"normal\" edittype=\"none\" text=\"bind:inqCnt\" tooltiptext=\"bind:inqCnt\" textAlign=\"center\"/><Cell col=\"4\" displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" text=\"bind:regDt\" tooltiptext=\"bind:regDt\" cssclass=\"bdNone\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnNoticeReg",null,null,"85","32","155","grdList:10",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("등록");
        ...
        // User Script
        this.addIncludeScript("NoticeBoardM00.xfdl","");
