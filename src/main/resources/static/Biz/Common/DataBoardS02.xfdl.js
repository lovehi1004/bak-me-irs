(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staPstatCnArea","0","staPstatNmArea:-1",null,"310","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staPstatCn","0","staPstatNm:-1","150","310",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("2");
            obj.set_text("내용");
            obj.set_cssclass("sta_WF_Label");
            this.divBoardInfo.addChild(obj.name, obj);
            ...
            obj = new TextArea("txaPstatCn","157","50",null,"296","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("3");
            obj.set_enable("true");
        ...
        // User Script
        this.registerScript("DataBoardS02.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_Common
        * BUSINESS      : 자료실 수정화면
        * FILE NAME     : DataBoardS02.xfdl
        * DESCRIPTION   : 자료실 수정화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.getOwnerFrame().form.fnLoadComplete('DataBoardS02');
        ...
        ***********************************************************************************/
        ...
        {
        	// TODO
        	trace("[DataBoardS02]fnChangeDiv =========================");
        	this.scrollTo(0,0);
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divBoardInfo.form.staPstatNmArea.addEventHandler("onclick",this.divBoardInfo_staUsrInfoL1_00_onclick,this);
        ...
        this.loadIncludeScript("DataBoardS02.xfdl");
