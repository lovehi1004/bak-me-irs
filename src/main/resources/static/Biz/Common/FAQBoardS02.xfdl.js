(function()
{
    return function()
    {
        ...
        // User Script
        this.registerScript("FAQBoardS02.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_Common
        * BUSINESS      : FAQ 수정화면
        * FILE NAME     : FAQBoardS02.xfdl
        * DESCRIPTION   : FAQ 수정화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.getOwnerFrame().form.fnLoadComplete('FAQBoardS02');
        ...
        */
        ...
        this.loadIncludeScript("FAQBoardS02.xfdl");
