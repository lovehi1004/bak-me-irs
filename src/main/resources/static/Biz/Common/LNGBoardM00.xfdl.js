(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnLNGReg",null,null,"80","32","55","grdList:10",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("등록");
            ...
            obj = new Button("btnSearch",null,"22","32","32","btnLNGReg:4",null,null,null,null,null,this);
            obj.set_taborder("3");
        ...
        // User Script
        this.registerScript("LNGBoardM00.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_Common
        * BUSINESS      : 법령과지침 목록
        * FILE NAME     : LNGBoardM00.xfdl
        * DESCRIPTION   : 법령과지침 목록 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        {
        	trace("[LNGBoardM00]Form onload 후 필요(설정)시 실행되는 callback 함수 ");
        	...
        	this.getOwnerFrame().form.fnLoadComplete('LNGBoardM00');
        ...
        ***********************************************************************************/
        this.fnChangeDiv = function(objArgs)
        {
        	...
        	{
        		this.btnLNGReg.set_visible(true);
        		this.btnLNGReg.set_width(80);
        		this.btnSearch.set_right("btnLNGReg:4");
        	}else
        	{
        		this.btnLNGReg.set_visible(false);
        		this.btnLNGReg.set_width(0);
        ...
        */
        ...
        this.btnLNGReg_onclick = function(obj,e)
        {
        	if(this.fnAccessAuth(this.roleIdMgno))
        	{
        		var objArgs ={};
        ...
        this.on_initEvent = function()
        {
            ...
            this.btnLNGReg.addEventHandler("onclick",this.btnLNGReg_onclick,this);
        ...
        this.loadIncludeScript("LNGBoardM00.xfdl");
