(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"60\"/><Column size=\"600\"/><Column size=\"90\"/><Column size=\"120\"/><Column size=\"90\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"제목\"/><Cell col=\"2\" text=\"조회수\"/><Cell col=\"3\" text=\"등록일자\"/><Cell col=\"4\" text=\"조회\" cssclass=\"bdNone\"/></Band><Band id=\"body\"><Cell textAlign=\"center\" text=\"bind:no\" tooltiptext=\"bind:no\"/><Cell col=\"1\" textAlign=\"left\" text=\"bind:pstatNm\" tooltiptext=\"bind:pstatNm\"/><Cell col=\"2\" displaytype=\"normal\" edittype=\"none\" text=\"bind:inqCnt\" tooltiptext=\"bind:inqCnt\" textAlign=\"center\"/><Cell col=\"3\" displaytype=\"normal\" edittype=\"none\" textAlign=\"center\" text=\"bind:regDt\" tooltiptext=\"bind:regDt\"/><Cell col=\"4\" displaytype=\"buttoncontrol\" edittype=\"button\" cssclass=\"Cell_WF_Search, bdNone\" textAlign=\"center\" accessibilitydescription=\"상세화면전환\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnFAQReg",null,null,"80","32","55","grdList:10",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("등록");
            ...
            obj = new Button("btnSearch",null,"22","32","32","btnFAQReg:4",null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new BindItem("item2","edtSrhNm","value","dsSrh","srhNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","cboSrh","value","dsSrh","GbCd");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("FAQBoardM00.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_Common
        * BUSINESS      : FAQ 목록화면
        * FILE NAME     : FAQBoardM00.xfdl
        * DESCRIPTION   : FAQ 목록화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        {
        	trace("[FAQBoardM00]Form onload 후 필요(설정)시 실행되는 callback 함수 ");
        	...
        	this.getOwnerFrame().form.fnLoadComplete('FAQBoardM00');
        ...
        ***********************************************************************************/
        this.fnChangeDiv = function(objArgs)
        {
        	...
        	{
        		this.btnFAQReg.set_visible(true);
        		this.btnFAQReg.set_width(80);
        		this.btnSearch.set_right("btnFAQReg:4");
        	}else
        	{
        		this.btnFAQReg.set_visible(false);
        		this.btnFAQReg.set_width(0);
        ...
        */
        ...
        this.divList_grdList_oncellclick = function(obj,e)
        {
        	if(e.col == 1 || e.col == 4)
        	{
        		...
        		this.getOwnerFrame().form.fnFAQBoardDtlCall(objArgs);
        	}
        };

        this.btnFAQReg_onclick = function(obj,e)
        {
        	if(this.fnAccessAuth(this.roleIdMgno))
        	{
        		var objArgs ={};
        		...
        		objArgs.sts = "REG"
        		this.getOwnerFrame().form.fnFAQBoardRegCall(objArgs);
        	}else
        	{
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdList.addEventHandler("oncellclick",this.divList_grdList_oncellclick,this);
            this.btnFAQReg.addEventHandler("onclick",this.btnFAQReg_onclick,this);
        ...
        this.loadIncludeScript("FAQBoardM00.xfdl");
