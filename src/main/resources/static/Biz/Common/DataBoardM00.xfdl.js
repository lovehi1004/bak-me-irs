(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnDataReg",null,null,"80","32","55","grdList:10",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("등록");
            obj.set_cssclass("btn_WF_Crud");
            obj.set_accessibilitylabel("자료실등록");
            this.addChild(obj.name, obj);

            obj = new Button("btnSearch",null,"22","32","32","btnDataReg:4",null,null,null,null,null,this);
            obj.set_taborder("3");
        ...
        // User Script
        this.registerScript("DataBoardM00.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_Common
        * BUSINESS      : 자료실 목록화면
        * FILE NAME     : DataBoardM00.xfdl
        * DESCRIPTION   : 자료실 목록화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.getOwnerFrame().form.fnLoadComplete('DataBoardM00');
        ...
        ***********************************************************************************/
        this.fnChangeDiv = function(objArgs)
        {
        	...
        	if(this.fnAccessAuth(this.roleIdMgno))
        	{
        		...
        		this.btnDataReg.set_width(80);
        		this.btnSearch.set_right("btnDataReg:4");

        	}else
        	{
        		this.btnDataReg.set_visible(false);
        		this.btnDataReg.set_width(0);
        ...
        */
        ...
        this.loadIncludeScript("DataBoardM00.xfdl");
