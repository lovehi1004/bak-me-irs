(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staFlmno","0","staPstatCnArea:-1",null,"207","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staFlmnoArea","0","staPstatCn:-1","150","207",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("4");
            obj.set_text("첨부파일");
            obj.set_cssclass("sta_WF_Label");
            this.divBoardInfo.addChild(obj.name, obj);
            ...
            obj = new Static("staPostPstatNmArea","0","staFlmno:-1",null,"44","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("15");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staPostPstatNm","0","staFlmnoArea:-1","150","44",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("6");
            obj.set_text("다음글");
            obj.set_cssclass("sta_WF_Label");
            this.divBoardInfo.addChild(obj.name, obj);
        ...
        * BUSINESS      : 법령과지침 상세화면
        * FILE NAME     : LNGBoardS01.xfdl
        * DESCRIPTION   : 법령과지침 상세화면 관련 스크립트
        *------------------------------------------------------------------
