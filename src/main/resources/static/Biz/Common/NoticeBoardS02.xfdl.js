(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divBoardInfo","55","22",null,"611","55",null,"1130",null,null,null,this);
            obj.set_taborder("0");
            obj.set_formscrollbartype("none none");
            obj.set_text("");
            this.addChild(obj.name, obj);

            obj = new Static("staTypeCdArea","0","0",null,"44","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("10");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staTypeCd","0","0","150","44",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("0");
            obj.set_text("공지구분");
            obj.set_cssclass("sta_WF_Label");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staLabelTop","0","0",null,"1","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_Label_Top");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staPstatNmArea","0","staTypeCdArea:-1",null,"44","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("11");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Edit("edtPstatNm","157","50",null,"30","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("3");
            ...
            obj = new Static("staPstatNm","0","staTypeCd:-1","150","44",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("2");
            obj.set_text("제목");
            obj.set_cssclass("sta_WF_Label");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staPstatCnArea","0","staPstatNmArea:-1",null,"267","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("12");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staPstatCn","0","staPstatNm:-1","150","267",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("4");
            obj.set_text("내용");
            obj.set_cssclass("sta_WF_Label");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staFlmnoArea","0","staPstatCnArea:-1",null,"207","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("13");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Static("staFlmno","0","staPstatCn:-1","150","207",null,null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("6");
            obj.set_text("첨부파일");
            obj.set_cssclass("sta_WF_Label");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Button("btnList",null,"staFlmnoArea:20","75","32","0",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("9");
            obj.set_text("목록");
            ...
            obj = new Button("btnSave",null,"staFlmnoArea:20","75","32","btnList:3",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("8");
            obj.set_text("저장");
            ...
            obj = new TextArea("txaPstatCn","157","93",null,"253","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("5");
            obj.set_enable("true");
            ...
            obj = new Combo("cboTypeCd","157","6",null,"32","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("1");
            obj.set_innerdataset("dsTypeCd");
            obj.set_codecolumn("cdMgno");
            obj.set_datacolumn("cdKornNm");
            obj.set_cssclass("WFSA");
            obj.set_accessibilitylabel("공지구분");
            obj.set_text("");
            obj.set_index("-1");
            this.divBoardInfo.addChild(obj.name, obj);

            obj = new Div("divEtcMultiFile","157","360",null,"190","7",null,null,null,null,null,this.divBoardInfo.form);
            obj.set_taborder("7");
            ...
            obj = new BindItem("item30","divBoardInfo.form.edtPstatNm","value","dsBbsInfo","pstatNm");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item32","divBoardInfo.form.cboTypeCd","value","dsBbsInfo","typeCd");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.addIncludeScript("NoticeBoardS02.xfdl","");
        this.registerScript("NoticeBoardS02.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_Common
        * BUSINESS      : 공지사항 수정화면
        * FILE NAME     : NoticeBoardS02.xfdl
        * DESCRIPTION   : 공지사항 수정화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.getOwnerFrame().form.fnLoadComplete('NoticeBoardS02');
        ...
        */
        ...
        // 공통Transaction 호출
         	var objArgs = {};
         	objArgs.svcId 			= "updateNoticeBoard";
        ...
        */
        ...
        // 공통Transaction 호출
         	var objArgs = {};
         	objArgs.svcId 			= "insertNoticeBoard";
        ...
        ***********************************************************************************/
        this.fnChangeDiv = function(objArgs)
        {
        	...
        	}else
        	{
        		...
        		this.gfnShowMessage(this, sMsgCode);
        		this.getOwnerFrame().form.fnNoticeBoardCall();
        	}
        ...
        */
        ...
        this.divBoardInfo_btnSave_onclick = function(obj,e)
        {
        	if(this.fnAccessAuth(this.roleIdMgno))
        	{
        		if(this.fvSts == "MOD")
        ...
        this.divBoardInfo_sta07_00_00_00_onclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.divBoardInfo.form.staPstatCnArea.addEventHandler("onclick",this.divBoardInfo_sta07_00_00_00_onclick,this);
            this.divBoardInfo.form.btnList.addEventHandler("onclick",this.divBoardInfo_btnList_onclick,this);
            this.divBoardInfo.form.btnSave.addEventHandler("onclick",this.divBoardInfo_btnSave_onclick,this);
        };
        this.loadIncludeScript("NoticeBoardS02.xfdl");
