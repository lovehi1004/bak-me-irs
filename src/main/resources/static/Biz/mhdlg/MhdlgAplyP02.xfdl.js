(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"no\" type=\"STRING\" size=\"256\"/><Column id=\"bizKrnNm\" type=\"STRING\" size=\"256\"/><Column id=\"bizOrgtNm\" type=\"STRING\" size=\"256\"/><Column id=\"btnNm\" type=\"STRING\" size=\"256\"/><Column id=\"bizMngNo\" type=\"STRING\" size=\"256\"/><Column id=\"vldBizDgr\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSrh", this);
            obj._setContents("<ColumnInfo><Column id=\"srhBizNm\" type=\"STRING\" size=\"256\"/><Column id=\"mhdlgMgno\" type=\"STRING\" size=\"256\"/><Column id=\"mhdlgGroupMgno\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"558\"/><Column size=\"91\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"27\"/><Row size=\"27\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"번호\"/><Cell col=\"1\" text=\"국제감축사업 원문명\"/><Cell col=\"2\" rowspan=\"2\" text=\"선택\"/><Cell row=\"1\" col=\"1\" text=\"국제감축사업 국문명\"/></Band><Band id=\"body\"><Cell rowspan=\"2\" textAlign=\"center\" text=\"bind:no\" tooltiptext=\"bind:no\"/><Cell col=\"1\" textAlign=\"left\" tooltiptext=\"bind:bizOrgtNm\" text=\"expr:dataset.parent.gfnGetRealColSizeText(comp, bizOrgtNm, currow, 1)\"/><Cell col=\"2\" rowspan=\"2\" displaytype=\"buttoncontrol\" edittype=\"button\" padding=\"10px\" text=\"bind:btnNm\" tooltiptext=\"bind:btnNm\" textAlign=\"center\"/><Cell row=\"1\" col=\"1\" textAlign=\"left\" text=\"bind:bizKrnNm\" tooltiptext=\"bind:bizKrnNm\"/></Band></Format></Formats>");
            this.divPop.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("MhdlgAplyP02.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	var mhdlgGroupMgno = this.gfnGetParameter(objFormFrame, "mhdlgGroupMgno");

        	// 검색 데이터셋 초기화.
        	this.dsSrh.addRow();
        	this.dsSrh.setColumn(0, "srhBizNm", "");
        	this.dsSrh.setColumn(0, "mhdlgMgno", "");
        	this.dsSrh.setColumn(0, "mhdlgGroupMgno", "");

        	if( mhdlgMgno != '') {
        		this.dsSrh.setColumn(0, "mhdlgMgno", mhdlgMgno);
        	}
        	if( mhdlgGroupMgno != '') {
        		this.dsSrh.setColumn(0, "mhdlgGroupMgno", mhdlgGroupMgno);
        	}
        ...
        ***********************************************************************************/
        this.fnCallSearchList = function()
        {
        	...
        	// 공통Transaction 호출
        	var callUrl = "/biz/mhdlg/mhdlgAply/selectIrbDtlByMhdlgMgno.irs";
        ...
        */
        ...
        this.divPop_grdList_oncellclick = function(obj,e)
        {
        	...
        	if(e.cell == 2)
        	{
        		var strRtn = this.gfnSetPopupReturn({bizMngNo:this.dsList.getColumn(e.row, "bizMngNo")
        											, vldBizDgr:this.dsList.getColumn(e.row, "vldBizDgr")
        											});
        		trace("=====strRtn========"+strRtn);
        ...
        this.loadIncludeScript("MhdlgAplyP02.xfdl");
