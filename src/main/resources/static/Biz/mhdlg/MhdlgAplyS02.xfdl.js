(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divRUsrInfo","1","divH1:0",null,"130","30",null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Div("divMhdlgInfoArea","0","248",null,"609","30",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_formscrollbartype("none none");
            ...
            obj.set_inputtype("alpha,comma,digit,dot,english,number,sign,space,numberandenglish,symbol");
            this.divMhdlgInfoArea.addChild(obj.name, obj);
            ...
            obj = new Radio("rdoAplyClCd","157","staAplyClCdNmArea:-37","699","30",null,null,null,null,null,null,this.divMhdlgInfoArea.form);
            obj.set_taborder("31");
            ...
            obj = new Edit("edtMhdlgUnqno","942","staAplyClCdNmArea:-37",null,"30","30",null,null,null,null,null,this.divMhdlgInfoArea.form);
            obj.set_taborder("8");
            obj.set_tooltiptext("방법론고유번호");
            this.divMhdlgInfoArea.addChild(obj.name, obj);
            ...
            obj = new Button("btnDelAgree",null,"staAgrStiplArea:-169","98","30","63",null,null,null,null,null,this.divMhdlgInfoArea.form);
            obj.set_taborder("22");
            obj.set_text("삭제");
            ...
            obj = new Button("btnDelMhdlg",null,"staBizFldArea:-166","98","30","63",null,null,null,null,null,this.divMhdlgInfoArea.form);
            obj.set_taborder("27");
            obj.set_text("삭제");
            obj.set_cssclass("btn_WF_Delete");
            this.divMhdlgInfoArea.addChild(obj.name, obj);

            obj = new Button("btnAddMhdlg",null,"staBizFldArea:-166","98","30","168",null,null,null,null,null,this.divMhdlgInfoArea.form);
            obj.set_taborder("26");
            obj.set_text("추가");
            ...
            obj = new Static("staAplyClCdNm00","783","staAplyClCdNmArea:-44","150","44",null,null,null,null,null,null,this.divMhdlgInfoArea.form);
            obj.set_taborder("33");
            ...
            obj = new Div("divFileInfo","0","divH3:0",null,"470","30",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_formscrollbartype("none none");
            obj.set_formscrolltype("none");
            obj.set_text("");
            ...
            obj = new Div("divComBtn","0","divFileInfo:20",null,"34","30",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item11","divMhdlgInfoArea.form.edtOldMhdlgNm","value","dsOldMhdlgInfo","oldMhdlgKrnNm");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item14","divMhdlgInfoArea.form.edtMhdlgUnqno","value","dsMhdlgDetail","mhdlgUnqno");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","divMhdlgInfoArea.form.rdoReddPlusYn","value","dsMhdlgDetail","reddPlusYn");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("MhdlgAplyS02.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
           ...
           var objParam4 = { objDs:this.dsMhdlgDetail								// 바인딩 데이터셋
        	...
        	//set_url 성공시 원래화면 호출
        	this.getOwnerFrame().form.divWork.form.fnLoadComplete('MhdlgAplyS02');
        ...
        this.fnCallback = function(sSvcId, nErrCode, sErrMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		case "regInfo" :
        			...
        			//신청구분 - 사전심의신청
        			this.dsMhdlgDetail.setColumn(0,'aplyClCd','MAC0001');
        			//제정·개정구분 - 제정
        		...
        		case "tempDataSearch" : //임시저장된 정보를 가져올시 콜백
        			...
        			this.fnRegRsnCdCtrl(this.dsMhdlgDetail.getColumn(0,'regRsnCd'),this.dsMhdlgDetail.getColumn(0,'agreeClausCd'));
        	...
        	switch (sPopupId)
        	{
        		...
        		case "popModalMhdlgP01" :
        			...
        			if(!this.gfnIsNull(objRtnValue["pvMhdlgMgno"]))
        			{
        				...
        				this.dsRegInfo.setColumn(0, 'sts', 'SEARCH');
        				var svcId = "rtnInfo"
        ...
        ***********************************************************************************/
        ...
        this.divComBtn_btnTempSave_onclick = function(obj,e)
        {
        	this.gfnShowMessage(this, 'C000001', '', function(svcid, variant) {
        		if (variant == "OK")
        		{
        			...
        			var svcId = 'tempSave';
        			var url	= "/biz/mhdlg/mhdlgAply/insertMhdlgAply.irs";
        ...
        this.divComBtn_btnAply_onclick = function(obj,e)
        {
        	...
        	if(this.divMhdlgInfoArea.form.rdoAplyClCd.value == 'MAC0003' )
        	{
        		if(this.gfnIsNull(this.divMhdlgInfoArea.form.edtMhdlgUnqno.value))
        		{
        			this.gfnShowMessage(this, "W000014", this.divMhdlgInfoArea.form.edtMhdlgUnqno.tooltiptext, function(svcid, variant) {
        				this.divMhdlgInfoArea.form.edtMhdlgUnqno.set_cssclass("error");
        				this.divMhdlgInfoArea.form.edtMhdlgUnqno.setFocus();
        			});
        			return false;
        		}else
        		{
        			this.divMhdlgInfoArea.form.edtMhdlgUnqno.set_cssclass("");
        		}
        	}
        	...
        	this.gfnShowMessage(this, "C000001", "", function(svcid, variant) {
        		...
        		var nRowCnt = this.dsEtcDataFile.copyData(this.divFileInfo.form.divEtcMultiFile.form.dsAtchFileDetail);
        			...
        			this.dsMhdlgDetail.setColumn(0,'prcsTypeCd','MPT0002'); // 신청 코드 부여
        			var svcId 		= 'mhdlgAply';
        			var url			= "/biz/mhdlg/mhdlgAply/insertMhdlgAply.irs";
        			var inds 		= "dsRegInfo=dsRegInfo"
        							+ " dsMhdlgDetail=dsMhdlgDetail" 	//방법론상세
        ...
        {
        	var svcId 			= "regInfo";
         	var url 			= "/biz/mhdlg/mhdlgAply/selectRegUsrInfo.irs";
         	var inds      		= "dsRegInfo=dsRegInfo";
        ...
        {
        	var svcId 			= svcId;
         	var url 			= "/biz/mhdlg/mhdlgAply/selectTempMhdlgAplyDetail.irs";
         	var inds      		= "dsRegInfo=dsRegInfo";
         	var outds     		= "dsRegUsrInfo=dsRegUsrInfo"
        ...
        {
        	var svcId 			= 'regReUp';
         	var url 			= "/biz/mhdlg/mhdlgAply/selectNewMhdlgAplyDetail.irs";
         	var inds      		= "dsRegInfo=dsRegInfo";
         	var outds     		= "dsRegUsrInfo=dsRegUsrInfo"
        						+ " dsMhdlgDetail=dsMhdlgDetail"
        						+ " dsAgrStiplList=dsAgrStiplList"
        ...
        */
        ...
        this.fnAgrStipInit = function()
        {
        	...
        	if(this.gfnIsNull(agreeClausCd) || agreeClausCd != 'AGC0001'){
        		...
        		this.divMhdlgInfoArea.form.edtOldMhdlgNm.set_height(0);
        		//고유번호
        		this.divMhdlgInfoArea.form.staAplyClCdNm00.set_height(0);
        		this.divMhdlgInfoArea.form.edtMhdlgUnqno.set_height(0);
        		//고유번호끝
        		this.divMhdlgInfoArea.set_height(388);
        		this.divMhdlgInfoArea.form.resetScroll();
        		this.resetScroll();
        ...
        //협정약정MOU 그리드 고유번호 컨트롤
        this.divMhdlgInfoArea_rdoAplyClCd_onitemchanged = function(obj,e)
        {
        	//기승인 신청의 경우 고유번호를 입력할 수 있도록 함.
        	if(e.postvalue == 'MAC0003')
        	{
        		this.divMhdlgInfoArea.form.grdBizFldsList.setCellProperty('body',3,'displaytype','editcontrol');
        		this.divMhdlgInfoArea.form.grdBizFldsList.setCellProperty('body',3,'edittype','text');
        		this.divMhdlgInfoArea.form.staAplyClCdNm00.set_height(44);
        		this.divMhdlgInfoArea.form.edtMhdlgUnqno.set_height(33);
        	}else
        	{
        		this.divMhdlgInfoArea.form.grdBizFldsList.setCellProperty('body',3,'displaytype','normal');
        		this.divMhdlgInfoArea.form.grdBizFldsList.setCellProperty('body',3,'edittype','none');
        		this.divMhdlgInfoArea.form.staAplyClCdNm00.set_height(0);
        		this.divMhdlgInfoArea.form.edtMhdlgUnqno.set_height(0);
        		this.dsMhdlgDetail.setColumn(0,'mhdlgUnqno','');
        		this.divMhdlgInfoArea.form.edtMhdlgUnqno.set_value("");
        		this.fnUpdtaeBisFldUnqno();
        	}
        };
        ...
        this.on_initEvent = function()
        {
            ...
            this.divMhdlgInfoArea.form.edtMhdlgUnqno.addEventHandler("onchanged",this.divMhdlgInfoArea_edtMhdlgUnqno_onchanged,this);
            ...
            this.divMhdlgInfoArea.form.staAplyClCdNm00.addEventHandler("onclick",this.div01_00_00_00_sta02_onclick,this);
            this.divMhdlgInfoArea.form.staReddPlusYn.addEventHandler("onclick",this.div01_00_00_00_sta02_onclick,this);
        ...
        this.loadIncludeScript("MhdlgAplyS02.xfdl");
