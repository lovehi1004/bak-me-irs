(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("협정약정관리 MOU상세");
            ...
            obj = new Static("staUsrInfoL2_00_00_00_00","7","129",null,"44","0",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Static("staBzentNm01_01_00_00_00","0","129","150","44",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("10");
            obj.set_text("체결국가");
            obj.set_cssclass("sta_WF_Label");
            this.divAgrInfo.addChild(obj.name, obj);
            ...
            obj = new Edit("edtntlNm","158","135","600","30",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("15");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Static("sta07_00_00_00_00","0","611",null,"197","0",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("17");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Static("sta08_00_00_00_00_00","0","611","150","197",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("18");
            obj.set_text("방법론");
            obj.set_cssclass("sta_WF_Label");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Grid("Grid00_00","157","618",null,"182","7",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("19");
            ...
            obj = new Button("btnList00",null,"828","75","32","6",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("21");
            obj.set_text("목록");
            obj.set_cssclass("btn_WF_CrudSub");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Static("staCalPdctCncld","770","129",null,"44","646",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("22");
            obj.set_text("예상체결일자");
            obj.set_cssclass("sta_WF_Label");
            ...
            obj = new Static("sta07_00_00_00","0","172",null,"131","0",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Static("sta07_00_00_00_02","0","sta07_00_00_00:-1",null,"131","0",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("24");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Static("sta07_00_00_00_02_00","0","432",null,"180","0",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("25");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Static("sta08_00_00_00_00","0","171","150","131",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("26");
            obj.set_text("원문파일");
            obj.set_cssclass("sta_WF_Label_E");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Static("sta08_00_00_00_00_02","0","301","150","131",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("27");
            obj.set_text("국문 파일");
            obj.set_cssclass("sta_WF_Label_E");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Static("sta08_00_00_00_00_02_00","0","431","150","181",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("28");
            obj.set_text("기타 문서");
            obj.set_cssclass("sta_WF_Label");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Div("divOrgtCncldFlmno","160","179","1090","120",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("29");
            obj.set_text("div00");
            obj.set_url("Frame_Common::comRaonK.xfdl");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Div("divKrnCncldFlmno","161","311","1089","120",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("30");
            obj.set_text("div00");
            obj.set_url("Frame_Common::comRaonK.xfdl");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Div("divEtcDataFlmno","157","442","1095","164",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("31");
            obj.set_url("Frame_Common::comRaonK.xfdl");
            obj.set_text("");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Edit("edtPdctDt","927","136","600","30",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("32");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Button("btnDocList","163","20","80","30",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("이력보기");
            ...
            obj = new BindItem("item22","divAgrInfo.form.edtCncldKrnNm00","value","dsAgrInfo","cncldKrnNm");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item11","divAgrInfo.form.edtPdctDt","value","dsAgrInfo","pdctCncldDt");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("AgrStiplPrcndS03.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        {
        	trace("[AgrStiplMngS03]Form onload 후 필요(설정)시 실행되는 callback 함수 ");
        	/* ■■■■■■■■■■■■■■■■■■■■■■■■ 업로드 START ■■■■■■■■■■■■■■■■■■■■■■■■ */
        	// 값 초기화
        ...
        */
        ...
        this.loadIncludeScript("AgrStiplPrcndS03.xfdl");
