(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"42\"/><Column size=\"76\"/><Column size=\"80\"/><Column size=\"76\"/><Column size=\"170\"/><Column size=\"84\"/><Column size=\"77\"/><Column size=\"69\"/><Column size=\"48\"/><Column size=\"48\"/></Columns><Rows><Row size=\"27\" band=\"head\"/><Row size=\"27\" band=\"head\"/><Row size=\"27\"/><Row size=\"27\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"0\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" expr=\"dataset.getCaseCount(&quot;chk==undefined || chk==&apos;&apos; || chk==&apos;N&apos;&quot;) == 0 ? &apos;1&apos; : &apos;0&apos;\"/><Cell col=\"1\" rowspan=\"2\" text=\"번호\"/><Cell col=\"2\" rowspan=\"2\" text=\"구분\"/><Cell col=\"3\" rowspan=\"2\" text=\"체결국가\"/><Cell col=\"4\" rowspan=\"2\" text=\"등록유형\"/><Cell col=\"5\" text=\"원문\"/><Cell col=\"6\" rowspan=\"2\" text=\"조약번호\"/><Cell col=\"7\" rowspan=\"2\" text=\"서명일자\"/><Cell col=\"8\" rowspan=\"2\" text=\"발효일자\"/><Cell col=\"9\" rowspan=\"2\" text=\"이력\"/><Cell col=\"10\" rowspan=\"2\" text=\"조회\"/><Cell row=\"1\" col=\"5\" text=\"국문\"/></Band><Band id=\"body\"><Cell rowspan=\"2\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\" text=\"bind:chk\" checkboxfalsevalue=\"N\" checkboxtruevalue=\"Y\"/><Cell col=\"1\" rowspan=\"2\" textAlign=\"center\" text=\"bind:no\" tooltiptext=\"bind:no\"/><Cell col=\"2\" rowspan=\"2\" textAlign=\"center\" text=\"bind:cncldClNm\"/><Cell col=\"3\" rowspan=\"2\" textAlign=\"center\" text=\"bind:ntnNm\"/><Cell col=\"4\" rowspan=\"2\" textAlign=\"center\" text=\"bind:regTypeNm\"/><Cell col=\"5\" textAlign=\"center\" text=\"bind:cncldOrgtNm\"/><Cell col=\"6\" rowspan=\"2\" textAlign=\"center\" text=\"bind:cncldNo\" displaytype=\"normal\"/><Cell col=\"7\" rowspan=\"2\" textAlign=\"center\" displaytype=\"date\" edittype=\"none\" text=\"bind:sgntYmd\" calendardateformat=\"yyyy-MM-dd\"/><Cell col=\"8\" rowspan=\"2\" text=\"bind:eftvnYmd\" textAlign=\"center\" displaytype=\"date\" calendardateformat=\"yyyy-MM-dd\" calendardisplaynulltext=\"-\" calendardisplayinvalidtype=\"none\"/><Cell col=\"9\" rowspan=\"2\" displaytype=\"buttoncontrol\" edittype=\"button\" text=\"이력\" tooltiptext=\"이력\"/><Cell col=\"10\" rowspan=\"2\" displaytype=\"buttoncontrol\" edittype=\"button\" text=\"조회\" tooltiptext=\"조회\"/><Cell row=\"1\" col=\"5\" text=\"bind:cncldKrnNm\" textAlign=\"center\"/></Band></Format></Formats>");
            this.divList.addChild(obj.name, obj);
            ...
            obj = new Button("btnMouReg",null,"133","95","32","btnExcelDown:3",null,null,null,null,null,this.divList.form);
            obj.set_taborder("4");
            obj.set_text("MOU등록");
            obj.set_cssclass("btn_WF_Crud");
            this.divList.addChild(obj.name, obj);

            obj = new Button("btnStiplReg",null,"133","88","32","btnMouReg:3",null,null,null,null,null,this.divList.form);
            obj.set_taborder("6");
            obj.set_text("약정등록");
            obj.set_cssclass("btn_WF_Crud");
            this.divList.addChild(obj.name, obj);

            obj = new Button("btnAgreeReg",null,"133","88","32","btnStiplReg:3",null,null,null,null,null,this.divList.form);
            obj.set_taborder("7");
            obj.set_text("협정등록");
            obj.set_cssclass("btn_WF_Crud");
            this.divList.addChild(obj.name, obj);
            ...
            obj = new Div("divReg02","1995","280","294","184",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("divReg03");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        // User Script
        this.registerScript("AgrStiplMngM00.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.form_oninit = function(obj,e)
        {
        	...
        	this.divReg02.set_left(0);
        	this.divReg02.set_top(0);
        	this.divReg02.set_width(null);
        	this.divReg02.set_height(null);
        	this.divReg02.set_right(0);
        	this.divReg02.set_bottom(0);
        };
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	// 협정 상세
        	this.divDetail01.set_url("Biz_agrstipl::AgrStiplMngS01.xfdl");
        	// 약정 상세
        	this.divDetail02.set_url("Biz_agrstipl::AgrStiplMngS02.xfdl");
        	// MOU 상세
        	this.divDetail03.set_url("Biz_agrstipl::AgrStiplMngS03.xfdl");

        	// 협정 약정 등록
        	this.divReg01.set_url("Biz_agrstipl::AgrStiplMngS04.xfdl");
        	// MOU 등록
        	this.divReg02.set_url("Biz_agrstipl::AgrStiplMngS05.xfdl");
        ...
        ***********************************************************************************/
        ...
        this.fnRegBtnCtrl = function()
        {
        	...
        	{
        		this.divList.form.btnAgreeReg.set_visible(true);
        		this.divList.form.btnStiplReg.set_visible(true);
        		this.divList.form.btnMouReg.set_visible(true);

        	}else
        	{
        		this.divList.form.btnAgreeReg.set_visible(false);
        		this.divList.form.btnStiplReg.set_visible(false);
        		this.divList.form.btnMouReg.set_visible(false);
        	}
        }
        ...
        this.divList_grdList_oncellclick = function(obj,e)
        {
        	...
        	if(e.cell == 10)												//상세조회 이동
        	{
        		...
        		if(objArgs.cncldClNm == "협정"){
        			...
        			this.divReg02.set_visible(false);

        			trace("[cncldMgno:"+objArgs.cncldMgno+"|cncldClCd:"+objArgs.cncldClCd +"|cncldClNm:"+objArgs.cncldClNm +"|cncldDgr:"+objArgs.cncldDgr);
        ...
        this.divList_btnAgreeReg_onclick = function(obj,e)
        {
        	...
        	var objArgs = {};
        	objArgs.cncldClCd = "CNC0001";

        	this.divReg01.form.fnChangeDiv(objArgs);
        };
        //약정 등록 화면 전환
        this.divList_btnStiplReg_onclick = function(obj,e)
        {
        	// 화면전환
        	this.divList.set_visible(false);
        	this.divDetail01.set_visible(false);
        	...
        	// 상세화면 전환 후 초기작업이 필요한 경우 function 호출
        	var objArgs = {};
        	objArgs.cncldClCd = "CNC0002";


        	this.divReg01.form.fnChangeDiv(objArgs);
        };
        //MOU 등록 화면 전환
        this.divList_btnMouReg_onclick = function(obj,e)
        {
        	// 화면전환
        	this.divList.set_visible(false);
        	this.divDetail01.set_visible(false);
        	...
        	this.divDetail03.set_visible(false);
        	this.divReg01.set_visible(false);
        	this.divReg02.set_visible(true);

        	// 상세화면 전환 후 초기작업이 필요한 경우 function 호출
        	var objArgs = {};
        	objArgs.cncldClCd = "CNC0003";

        	this.divReg02.form.fnChangeDiv(objArgs);
        };
        ...
        {
        	var url = nexacro.getApplication().Tran.fwUrl + "/adm/agrstipl/agrStiplMng/selectAgrMngListExcel.irs";
        	...
        	this.fdtExcel.setPostData("downloadExcelFileNm","협정약정관리목록.xlsx");
        ...
        this.on_initEvent = function()
        {
            ...
            this.divList.form.divSearch.form.cboNewRvsmTypeCd.addEventHandler("onitemchanged",this.divList_divSearch_cboNewRvsmTypeCd_onitemchanged,this);
            ...
            this.divList.form.btnMouReg.addEventHandler("onclick",this.divList_btnMouReg_onclick,this);
            this.divList.form.btnStiplReg.addEventHandler("onclick",this.divList_btnStiplReg_onclick,this);
        ...
        this.loadIncludeScript("AgrStiplMngM00.xfdl");
