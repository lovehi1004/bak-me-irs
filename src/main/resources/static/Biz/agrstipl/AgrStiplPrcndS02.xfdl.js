(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("협정약정현황 약정상세");
            ...
            obj = new Static("sta07_00_00_00_00","0","654",null,"197","0",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("23");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Static("sta08_00_00_00_00_00","0","654","150","197",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("24");
            obj.set_text("방법론");
            obj.set_cssclass("sta_WF_Label");
            this.divAgrInfo.addChild(obj.name, obj);

            obj = new Grid("Grid00_00","157","661",null,"182","7",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("25");
            ...
            obj = new Button("btnList00",null,"856","75","32","6",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("27");
            obj.set_text("목록");
            obj.set_cssclass("btn_WF_CrudSub");
            this.divAgrInfo.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("AgrStiplPrcndS02.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        {
        	trace("[AgrStiplPrcndS02]Form onload 후 필요(설정)시 실행되는 callback 함수 ");
        	/* ■■■■■■■■■■■■■■■■■■■■■■■■ 업로드 START ■■■■■■■■■■■■■■■■■■■■■■■■ */
        	// 값 초기화
        ...
        ***********************************************************************************/
        this.fnCallDtlInfo = function()
        {
        	...
        	// 공통Transaction 호출
         	...
         	objArgs.url 			= "/biz/agrstipl/agrStiplPrcnd/selectStiplPrcndDetail.irs";
        ...
        */
        ...
        this.loadIncludeScript("AgrStiplPrcndS02.xfdl");
