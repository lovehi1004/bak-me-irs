(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("협정약정현황 협정상세");
            ...
            obj._setContents("<ColumnInfo><Column id=\"cncldMgno\" type=\"STRING\" size=\"256\"/><Column id=\"cncldDgr\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj = new Div("divAgrInfo","0","293",null,"930","30",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Edit("edtntlNm","158","180","600","30",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("20");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Button("btnTopList",null,"255","71","30","30",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("사업");
            obj.set_cssclass("btn_WF_Confirm");
            this.addChild(obj.name, obj);

            obj = new Button("btnTopReg",null,"255","71","30","104",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("방법론");
            obj.set_cssclass("btn_WF_Confirm");
            this.addChild(obj.name, obj);

            obj = new Button("btnTopPrivateReg",null,"255","71","30","btnTopReg:3",null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("협의체");
            obj.set_cssclass("btn_WF_Confirm");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item11","divAgrInfo.form.edtMou","value","dsAgrInfo","mouOrgtNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item12","divAgrInfo.form.edtPdctDt","value","dsAgrInfo","pdctCncldDt");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("AgrStiplPrcndS01.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        {
        	trace("[AgrStiplPrcndS01]Form onload 후 필요(설정)시 실행되는 callback 함수 ");
        	/* ■■■■■■■■■■■■■■■■■■■■■■■■ 업로드 START ■■■■■■■■■■■■■■■■■■■■■■■■ */
        	// 값 초기화
        ...
        ***********************************************************************************/
        this.fnCallDtlInfo = function()
        {
        	...
        	// 공통Transaction 호출
         	...
         	objArgs.url 			= "/biz/agrstipl/agrStiplPrcnd/selectAgrStiplPrcndDetail.irs";
        ...
        */
        ...
        {
        	// TODO
        	trace("[AgrStipPrcndS01]fnChangeDiv =========================");
        	this.scrollTo(0,0);
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divAgrInfo.form.edtntlNm.addEventHandler("onchanged",this.divAgrInfo_edtntlNm_onchanged,this);
        ...
        this.loadIncludeScript("AgrStiplPrcndS01.xfdl");
