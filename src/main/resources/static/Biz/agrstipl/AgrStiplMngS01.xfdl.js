(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("협정약정관리 협정상세");
            ...
            obj._setContents("<ColumnInfo><Column id=\"cncldMgno\" type=\"STRING\" size=\"256\"/><Column id=\"cncldDgr\" type=\"STRING\" size=\"256\"/><Column id=\"cncldClCd\" type=\"STRING\" size=\"256\"/><Column id=\"sts\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row/></Rows>");
            ...
            obj.set_taborder("0");
            obj.set_text("협정 등록 이력");
            obj.set_cssclass("sta_WF_Title");
            obj.set_fittocontents("width");
            this.addChild(obj.name, obj);

            obj = new Div("divAgrInfo","0","293",null,"950","30",null,null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj = new Edit("edtNewRvsmTypeNm","157","7","600","30",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("15");
            ...
            obj = new Edit("edtCncldOrgtNm","157","47","600","30",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("17");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Edit("edtRegTypeNm","157","136","600","30",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("18");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Edit("edtSgntYmd","157","90","600","30",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("19");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Button("btnList00",null,"864","75","32","0",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("26");
            obj.set_text("목록");
            obj.set_cssclass("btn_WF_CrudSub");
            this.divAgrInfo.addChild(obj.name, obj);
            ...
            obj = new Edit("edtMou","1037","7","323","30",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("28");
            ...
            obj = new Static("staCalPdctCncld","770","172",null,"44","646",null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("35");
            obj.set_text("예상체결일자");
            obj.set_cssclass("sta_WF_Label");
            ...
            obj = new Edit("edtNtnNm","157","179","600","30",null,null,null,null,null,null,this.divAgrInfo.form);
            obj.set_taborder("37");
            obj.set_readonly("true");
            obj.set_cssclass("output");
            obj.set_text("");
            ...
            obj = new Static("staDocList00","0","250","370","30",null,null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("협정 정보");
            obj.set_cssclass("sta_WF_Title");
            obj.set_fittocontents("width");
            ...
            obj = new BindItem("item24","divAgrInfo.form.edtntlNm","value","dsAgrInfo","ntnNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item25","divAgrInfo.form.edtNtnNm","value","dsAgrInfo","ntnNm");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item17","divAgrInfo.form.edtntlNm1","value","dsAgrInfo","ntnNm");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item32","divAgrInfo.form.rdo00","value","dsAgrInfo","newRvsnTypeNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item33","divAgrInfo.form.rdo00_00","value","dsAgrInfo","newRvsnTypeNm");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("AgrStiplMngS01.xfdl", function() {
        /***********************************************************************************
        ...
        */
        this.fnChangeDiv = function(objArgs)
        {
        	...
        	this.dsCurInfo.setColumn(0, "cncldClCd", objArgs.cncldClCd);
        ...
        */
        ...
        this.divAgrInfo_btnUpdate_onclick = function(obj,e)
        {
        	// 화면전환
        ...
        this.on_initEvent = function()
        {
            ...
            this.divAgrInfo.form.edtMou.addEventHandler("onchanged",this.divAgrInfo_edtMou_onchanged,this);
        ...
        this.loadIncludeScript("AgrStiplMngS01.xfdl");
