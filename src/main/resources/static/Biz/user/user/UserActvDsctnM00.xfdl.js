(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"srhLgnId\" type=\"STRING\" size=\"256\"/><Column id=\"srhAcsYmdFrom\" type=\"STRING\" size=\"256\"/><Column id=\"srhAcsYmdTo\" type=\"STRING\" size=\"256\"/><Column id=\"srhFrom\" type=\"STRING\" size=\"256\"/><Column id=\"srhTo\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj = new Div("divList","0","0",null,null,"0","0","1300",null,"405",null,this);
            obj.set_taborder("0");
            obj.set_text("div00");
            this.addChild(obj.name, obj);
            ...
            obj = new Static("staLgnId","35","30","120","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("0");
            obj.set_text("사용자아이디 ");
            ...
            obj = new Static("staPrvcInqAcsYmd","edtLgnId:30","29","100","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("2");
            obj.set_text("사용일시 ");
            obj.set_cssclass("sta_WFSA_Label");
            obj.set_fittocontents("width");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"140\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"110\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"사용자아이디\"/><Cell col=\"2\" text=\"사용자명\"/><Cell col=\"3\" text=\"사용내역\"/><Cell col=\"4\" text=\"사용일시\"/><Cell col=\"5\" text=\"IP\"/></Band><Band id=\"body\"><Cell text=\"bind:no\" tooltiptext=\"bind:no\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:lgnId\" tooltiptext=\"bind:lgnId\" textAlign=\"left\"/><Cell col=\"2\" text=\"bind:flnm\" tooltiptext=\"bind:flnm\" textAlign=\"center\"/><Cell col=\"3\" text=\"bind:inqCn\" tooltiptext=\"bind:inqCn\" textAlign=\"center\" displaytype=\"normal\" maskedittype=\"string\" maskeditformat=\"@@@-@@-@@@@@\"/><Cell col=\"4\" text=\"bind:acsTime\" tooltiptext=\"bind:acsTime\" textAlign=\"center\" displaytype=\"normal\" maskedittype=\"string\" maskeditformat=\"@@@-@@-@@@@@\"/><Cell col=\"5\" text=\"bind:ipAddr\" tooltiptext=\"bind:ipAddr\" textAlign=\"center\" displaytype=\"normal\" combodataset=\"dsResult02\" combocodecol=\"cdMgno\" combodatacol=\"cdKornNm\"/></Band></Format></Formats>");
            this.divList.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("UserActvDsctnM00.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_user
        * BUSINESS      : 사용자활동내역 목록화면
        * FILE NAME     : UserActvDsctnM00xfdl
        * DESCRIPTION   : 사용자활동내역 목록화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	var objParam = { objDs:this.dsSrh									// 바인딩 데이터셋
        					,sBindFromCol:"srhAcsYmdFrom"								// 바인딩 컬럼(From)
        					,sBindToCol:"srhAcsYmdTo"									// 바인딩 컬럼(To)
        ...
        ***********************************************************************************/
        ...
        this.fnCallSearchList = function()
        {
        	...
        	objArgs.url 			= "/adm/user/userActvDsctn/selectUserActvDsctnList.irs";
        ...
        */
        ...
        {
        	var callUrl = "/adm/user/userActvDsctn/selectUserActvDsctnExcel.irs";
        	var url = nexacro.getApplication().Tran.fwUrl + callUrl;
        	var srhLgnId = this.dsSrh.getColumn(0,"srhLgnId");
        	var srhAcsYmdFrom =  this.dsSrh.getColumn(0,"srhPrslYmdFrom");
        	var srhAcsYmdTo = this.dsSrh.getColumn(0,"srhPrslYmdTo");
        	...
        	if(this.gfnIsNull(srhAcsYmdFrom))
        	{
        		this.fdtExcel.setPostData("srhAcsYmdFrom", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhAcsYmdFrom", srhAcsYmdFrom);
        	}

        	if(this.gfnIsNull(srhAcsYmdTo))
        	{
        		this.fdtExcel.setPostData("srhAcsYmdTo", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhAcsYmdTo", srhAcsYmdTo);
        	}
        	...
        	this.fdtExcel.setPostData("downloadExcelFileNm","사용자활동내역.xlsx");
        	this.fdtExcel.setPostData("sheetname","사용자활동내역");
        ...
        */
        this.divList_onkeyup = function(obj,e)
        {
        	...
        	if(e.keycode == 13 && e.altkey == false && e.ctrlkey == false && e.shiftkey == false)
        	{
        		...
        		if(focusComponent == this.divList.form.divSearch.form.edtLgnId
        		|| focusComponent == "[object Calendar]")
        		{
        			this.dsSrh.setColumn(0,'srhLgnId',this.divList.form.divSearch.form.edtLgnId.value)
        ...
        this.loadIncludeScript("UserActvDsctnM00.xfdl");
