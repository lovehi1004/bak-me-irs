(function()
{
    return function()
    {
        ...
        ***********************************************************************************/
        ...
        {
        	this.fnClosePage(this.divDetail01);			// 정보관리 > 업체 목록
        	this.fnClosePage(this.divDetail02);			// 정보관리 > 상세화면
        	this.fnClosePage(this.divDetail03);			// 정보관리 > 변경신청 화면
        };
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	if(this.fvApp.User.roleIdMgno == "RL00000001") {		// 전체관리자
        		this.divDetail01.set_url("Biz_user::user/BzentMngS01.xfdl");			// 정보관리 > 업체 목록
        		this.divDetail02.set_url("Biz_user::user/BzentMngS02.xfdl");			// 정보관리 > 상세화면

        		// 화면전환 목록화면
        		this.fnMovePage(this.divDetail01);

        	// 계정관리인, 계정대표자 권한은 소속 업체 상세화면이 나와야 됨
        	} else {												// 관장기관, 위탁기관, 외교부, 기타부처, 계정관리인, 계정대표자
        		this.divDetail02.set_url("Biz_user::user/BzentMngS02.xfdl");			// 정보관리 > 상세화면
        		this.divDetail03.set_url("Biz_user::user/BzentMngS03.xfdl");			// 정보관리 > 업체정보 변경신청

        		this.fnMovePage(this.divDetail02);
        	}
        };
