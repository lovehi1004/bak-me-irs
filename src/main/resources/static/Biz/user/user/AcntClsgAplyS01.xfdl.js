(function()
{
    return function()
    {
        ...
        {
            this.set_name("AcntClsgAplyS01");
            this.set_titletext("계정폐쇄신청 등록 및 수정");
        ...
        // User Script
        this.registerScript("AcntClsgAplyS01.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.fnChangeDiv = function(objArgs) {
        	...
        	if(objArgs.status == "APLY") { //폐쇄신청
        		this.divClsgAplyRvw.set_visible(false);
        		this.divCmmnBtn.set_top("divClsgAply:25");
        		this.fnCallClsgAplyInfo();
        	} else if(objArgs.status == "RVW") { //심의
        ...
        ***********************************************************************************/
        ...
        this.fnCallComCdoe = function()
        {
        	...
        	arrParam[2] = {outDs:"dsRvwTypeCd", 	groupId:"RVW_TYPE_CD", 			headflag:"", useYn:"Y"}; //전송시스템코드
        ...
        {
        	var callUrl = "";
        	if(this.fvApp.User.roleIdMgno == "RL00000005") {
        		callUrl = "/biz/user/acntClsgAply/selectAcntClsgAply.irs";
        	}else {
        		callUrl = "";
        	}
        ...
        this.fnCallSave = function()
        {
        	var callUrl = "";
        	if(this.fvApp.User.roleIdMgno == "RL00000005") {
        		callUrl = "/biz/user/acntClsgAply/insertAcntClsgAply.irs"; // 폐쇄신청 저장
        	} else {
        		callUrl = "";
        	}
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("AcntClsgAplyS01.xfdl");
