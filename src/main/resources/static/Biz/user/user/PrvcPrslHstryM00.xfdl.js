(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"srhCmptncInstNo\" type=\"STRING\" size=\"256\"/><Column id=\"srhLgnId\" type=\"STRING\" size=\"256\"/><Column id=\"srhFlnm\" type=\"STRING\" size=\"256\"/><Column id=\"srhPrslYmdFrom\" type=\"STRING\" size=\"256\"/><Column id=\"srhPrslYmdTo\" type=\"STRING\" size=\"256\"/><Column id=\"srhFrom\" type=\"STRING\" size=\"256\"/><Column id=\"srhTo\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_accessibilitylabel("사용자아아디");
            obj.set_text("");
            this.divList.form.divSearch.addChild(obj.name, obj);
        ...
        * BUSINESS      : 개인정보열람이력 목록화면
        * FILE NAME     : PrvcPrslHstryM00.xfdl
        * DESCRIPTION   : 개인정보열람이력 목록화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        */
        ...
        {
        	var callUrl = "/adm/user/prvcPrslHstry/selectPrvcPrslHstryExcel.irs";
        	...
        	var srhPrslYmdFrom =  this.dsSrh.getColumn(0,"srhPrslYmdFrom");
        	var srhPrslYmdTo = this.dsSrh.getColumn(0,"srhPrslYmdTo");
        	...
        	if(this.gfnIsNull(srhPrslYmdFrom))
        	{
        		this.fdtExcel.setPostData("srhPrslYmdFrom", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhPrslYmdFrom", srhPrslYmdFrom);
        	}

        	if(this.gfnIsNull(srhPrslYmdTo))
        	{
        		this.fdtExcel.setPostData("srhPrslYmdTo", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhPrslYmdTo", srhPrslYmdTo);
        	}
        ...
        */
        this.divList_onkeyup = function(obj,e)
        {
        	...
        	if(e.keycode == 13 && e.altkey == false && e.ctrlkey == false && e.shiftkey == false)
        	{
        		...
        		{
        			this.dsSrh.setColumn(0,'srhFlnm',this.divList.form.divSearch.form.edtFlnm.value);
