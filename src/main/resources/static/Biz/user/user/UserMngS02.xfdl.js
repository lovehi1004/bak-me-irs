(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"instMgno\" type=\"STRING\" size=\"256\"/><Column id=\"instClsfCd\" type=\"STRING\" size=\"256\"/><Column id=\"instDtlsClsfCd\" type=\"STRING\" size=\"256\"/><Column id=\"govInstYn\" type=\"STRING\" size=\"256\"/><Column id=\"acntSttsClCd\" type=\"STRING\" size=\"256\"/><Column id=\"bzentNm\" type=\"STRING\" size=\"256\"/><Column id=\"bzentClCd\" type=\"STRING\" size=\"256\"/><Column id=\"crno\" type=\"STRING\" size=\"256\"/><Column id=\"brno\" type=\"STRING\" size=\"256\"/><Column id=\"rprsvNm\" type=\"STRING\" size=\"256\"/><Column id=\"corpTelDdd\" type=\"STRING\" size=\"256\"/><Column id=\"corpTelTlpno\" type=\"STRING\" size=\"256\"/><Column id=\"corpTelPhino\" type=\"STRING\" size=\"256\"/><Column id=\"rdnmCd\" type=\"STRING\" size=\"256\"/><Column id=\"addr\" type=\"STRING\" size=\"256\"/><Column id=\"dtlAddr\" type=\"STRING\" size=\"256\"/><Column id=\"upInstMgno\" type=\"STRING\" size=\"256\"/><Column id=\"upInstNm\" type=\"STRING\" size=\"256\"/><Column id=\"fullCorpTelNo\" type=\"STRING\" size=\"256\"/><Column id=\"instClsfCdNm\" type=\"STRING\" size=\"256\"/><Column id=\"bzentClCdNm\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divFile","0","776",null,"132","30",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_formscrollbartype("none none");
            obj.set_formscrolltype("none");
            obj.set_text("");
            ...
            obj = new Div("divComBtn","0","divFile:20",null,"64","30",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divUser","0","divH2:0",null,"339","30",null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_formscrollbartype("none none");
            obj.set_formscrolltype("none");
            obj.set_text("");
            ...
            obj = new CheckBox("chkSmsNtiYn","staSmsNtiYn:7","265","570","67",null,null,null,null,null,null,this.divUser.form);
            obj.set_taborder("33");
            ...
            obj = new Div("divH3","0","717",null,"59","30",null,null,null,null,null,this);
            obj.set_taborder("6");
            this.addChild(obj.name, obj);
            ...
            obj = new BindItem("item14","divUser.form.edtPswd","value","dsUserInfo","pswd");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item15","divUser.form.edtPswdConfirm","value","dsUserInfo","pswdConfirm");
            this.addChild(obj.name, obj);
            obj.bind();
            ...
            obj = new BindItem("item33","divInst.form.cboInstDtlsClsfCd","value","dsInstInfo","instDtlsClsfCd");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        this.fnPopupCallback = function(sPopupId, objRtn)
        {
        	...
        	switch (sPopupId)
        	{
        		...
        		case "comInstPop" :
        			...
        			this.dsInstInfo.setColumn(0, "fullCorpTelNo" , objRtnValue["corpTelDdd"] + "-" + objRtnValue["corpTelTlpno"] + "-" + objRtnValue["corpTelPhino"]       );		// 전체법인전화번호
        ...
        */
        this.fnSetDivInstText = function()
        {
        	if(this.divInst.form.rdoInstRegistType.value == 0) {				// 기관
        		this.divH1.form.staHeaderInst.set_text("기관 정보");
        ...
        */
        this.divInst_btnBzentNm_onclick = function(obj,e)
        {
        	...
        	var objArgs		= {pvInstSearchType:this.divInst.form.rdoInstRegistType.value};			// 0 : 일반사업체 제외 조회, 1 : [그외 정부기관|관장기관|위탁기관] 정부기관 조회, 2: 일반사업체 조회, 3 : 관장기관만 조회, 4 : 전체 조회
