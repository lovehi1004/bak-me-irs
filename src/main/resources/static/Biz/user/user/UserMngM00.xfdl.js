(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staInstClsfCd","35","30","131","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("0");
            ...
            obj = new Static("staBzentNm","cboInstClsfCd:30","30","131","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("2");
            ...
            obj = new Static("staCrno","btnBzentNm:30","30","131","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("5");
            ...
            obj = new Static("staUpInstNm","mseBrno:30","30","110","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("7");
            obj.set_text("상위기관");
            obj.set_cssclass("sta_WFSA_Label");
            ...
            obj = new Static("staLgnId","34","staInstClsfCd:5","131","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("아이디");
            obj.set_cssclass("sta_WFSA_Label");
            obj.set_fittocontents("none");
            ...
            obj = new Static("staFlnm","edtLgnId:30","staBzentNm:5","131","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("12");
            obj.set_text("성명");
            obj.set_cssclass("sta_WFSA_Label");
            ...
            obj = new Static("staUserClCd","edtFlnm:30","staCrno:5","131","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("14");
            obj.set_text("계정구분");
            obj.set_cssclass("sta_WFSA_Label");
            ...
            obj = new Static("staAcntSttsClCd","cboUserClCd:30","staUpInstNm:5","110","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("16");
            obj.set_text("계정상태");
            obj.set_cssclass("sta_WFSA_Label");
            ...
            obj = new Button("btnUpInstNm","edtUpInstNm:7","30","53","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("검색");
            obj.set_tooltiptext("검색");
            obj.set_accessibilitylabel("검색");
            ...
            obj = new Static("staSearchType","34","staLgnId:5","131","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("18");
            obj.set_text("조회구분");
            obj.set_cssclass("sta_WFSA_Label");
            obj.set_fittocontents("none");
            ...
            obj = new Combo("cboSearchType","staSearchType:0","edtLgnId:5","180","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("19");
            obj.set_cssclass("WFSA");
            obj.set_tooltiptext("조회구분");
            ...
            obj = new Static("staCalFromTo","cboSearchType:30","staFlnm:5","131","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("20");
            obj.set_text("접속기간");
            obj.set_cssclass("sta_WFSA_Label");
            obj.set_tooltiptext("접속기간");
            this.divList.form.divSearch.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"120\"/><Column size=\"140\"/><Column size=\"110\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"100\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"140\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"110\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"기관/사업체분류\"/><Cell col=\"2\" text=\"기관/사업체명\"/><Cell col=\"3\" text=\"사업체구분\" tooltiptext=\"사업체구분\"/><Cell col=\"4\" text=\"대표자명\"/><Cell col=\"5\" text=\"사업자등록번호\"/><Cell col=\"6\" text=\"아이디\"/><Cell col=\"7\" text=\"성명\"/><Cell col=\"8\" text=\"휴대폰번호\" tooltiptext=\"휴대폰번호\"/><Cell col=\"9\" text=\"계정구분\"/><Cell col=\"10\" text=\"계정상태\"/><Cell col=\"11\" text=\"가입일자\"/><Cell col=\"12\" text=\"최종접속일자\" tooltiptext=\"최종접속일자\"/><Cell col=\"13\" text=\"작업구분\" tooltiptext=\"작업구분\"/></Band><Band id=\"body\"><Cell text=\"bind:no\" textAlign=\"center\" tooltiptext=\"bind:no\"/><Cell col=\"1\" text=\"bind:instClsfCd\" displaytype=\"combotext\" combodataset=\"dsResult02\" combocodecol=\"cdMgno\" combodatacol=\"cdKornNm\" tooltiptext=\"bind:instClsfCd\"/><Cell col=\"2\" text=\"bind:bzentNm\" tooltiptext=\"bind:bzentNm\"/><Cell col=\"3\" displaytype=\"combotext\" combodataset=\"dsResult04\" combocodecol=\"cdMgno\" combodatacol=\"cdKornNm\" text=\"bind:bzentClCd\" tooltiptext=\"bind:bzentClCd\"/><Cell col=\"4\" text=\"bind:rprsvNm\" textAlign=\"center\" tooltiptext=\"bind:rprsvNm\"/><Cell col=\"5\" text=\"bind:brno\" displaytype=\"mask\" textAlign=\"center\" maskeditformat=\"@@@-@@-@@@@@\" maskedittype=\"string\" tooltiptext=\"bind:brno\"/><Cell col=\"6\" text=\"bind:lgnId\" textAlign=\"center\" tooltiptext=\"bind:lgnId\"/><Cell col=\"7\" text=\"bind:flnm\" textAlign=\"center\" tooltiptext=\"bind:flnm\"/><Cell col=\"8\" text=\"bind:fullHdponNo\" tooltiptext=\"bind:fullHdponNo\"/><Cell col=\"9\" text=\"bind:userClCd\" displaytype=\"combotext\" combodataset=\"dsResult03\" combocodecol=\"cdMgno\" combodatacol=\"cdKornNm\" tooltiptext=\"bind:userClCd\"/><Cell col=\"10\" text=\"bind:acntSttsClCd\" displaytype=\"combotext\" combodataset=\"dsResult01\" combocodecol=\"cdMgno\" combodatacol=\"cdKornNm\" tooltiptext=\"bind:acntSttsClCd\" cssclass=\"expr:acntSttsClCd==&apos;ASC0001&apos; ? &apos;cell_WF_Point01&apos; : &apos;&apos;\"/><Cell col=\"11\" text=\"bind:aprvYmd\" displaytype=\"mask\" maskeditformat=\"@@@@-@@-@@\" maskedittype=\"string\" textAlign=\"center\" tooltiptext=\"bind:aprvYmd\"/><Cell col=\"12\" text=\"bind:lastCntnYmd\" displaytype=\"mask\" maskeditformat=\"@@@@-@@-@@\" maskedittype=\"string\" textAlign=\"center\" tooltiptext=\"bind:lastCntnYmd\"/><Cell col=\"13\" displaytype=\"buttoncontrol\" edittype=\"button\" padding=\"7px 8px\" text=\"bind:acntSttsGbnNm\" tooltiptext=\"작업구분\" accessibilitylabel=\"작업구분\" accessibilitydescription=\"상세조회\"/></Band></Format></Formats>");
            this.divList.addChild(obj.name, obj);
            ...
            obj = new Button("btnShowHide","47.52%","divSearch:-5","50","20",null,null,null,null,null,null,this.divList.form);
            obj.set_taborder("5");
            ...
            obj = new Button("btnRegAdmin",null,null,"101","32","btnReg:3","grdList:10",null,null,null,null,this.divList.form);
            obj.set_taborder("7");
            obj.set_text("관리자등록");
            obj.set_cssclass("btn_WF_Crud");
            this.divList.addChild(obj.name, obj);
            ...
            obj = new Div("divDetail03","1624","544","294","184",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("사용자관리 관리자 등록화면");
            obj.set_visible("false");
            this.addChild(obj.name, obj);
            // Layout Functions
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	// 관리자 등록화면
        	this.divDetail03.set_url("Biz_user::user/UserMngS03.xfdl");
        	...
        	switch (svcID)
        	{
        		case "getCommonCode" :
        			...
        			for (var i = this.dsResult03.rowcount - 1; i >= 0; i--) {
        				if(['UCC0008'].includes(this.dsResult03.getColumn(i, "cdMgno"))) {		// 비승인사용자 코드만 제거
        ...
        this.fnPopupCallback = function(sPopupId, objRtn)
        {
        	...
        	switch (sPopupId)
        	{
        		...
        		case "comInstPop" :
        			...
        			//팝업에서 넘어온 값 설정하기
        			this.dsSrh.setColumn(0, "srhBzentNm"      , objRtnValue["bzentNm"]       );		// 상위기관명
        ...
        */
        ...
        /**
         * @description 관리자등록 버튼 클릭 - 화면전환 관리자 등록화면
        */
        this.divList_btnRegAdmin_onclick = function(obj,e)
        {
        	// 화면전환 상세화면
        	this.divList.set_visible(false);
        	this.divDetail01.set_visible(false);
        	...
        	this.divDetail03.form.fnChangeDiv();
        	// 상세화면 전환 후 초기작업이 필요한 경우 function 호출
        };

        /**
         * @description 기관/사업체명 검색 클릭 - 업체 검색 팝업 열기
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divList.form.btnRegAdmin.addEventHandler("onclick",this.divList_btnRegAdmin_onclick,this);
