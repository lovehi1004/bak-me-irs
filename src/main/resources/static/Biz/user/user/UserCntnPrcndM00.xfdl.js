(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"srhUserClCd\" type=\"STRING\" size=\"256\"/><Column id=\"srhFrom\" type=\"STRING\" size=\"256\"/><Column id=\"srhTo\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
        ...
        * BUSINESS      : 사용자접속현황 목록화면
        * FILE NAME     : UserCntnPrcndM00.xfdl
        * DESCRIPTION   : 사용자접속현황 목록화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        */
        ...
        {
        	var callUrl = "/adm/user/userCntnPrcnd/selectUserCntnPrcndExcel.irs";
        	var url = nexacro.getApplication().Tran.fwUrl + callUrl;
        	var srhUserClCd = this.dsSrh.getColumn(0,"srhUserClCd");
        	var srhTo = this.dsSrh.getColumn(0,"srhTo");
        	var srhFrom = this.dsSrh.getColumn(0,"srhFrom");

        	if(this.gfnIsNull(srhUserClCd))
        	{
        		this.fdtExcel.setPostData("srhUserClCd", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhUserClCd", srhUserClCd);
        	}
        	...
        	this.fdtExcel.setPostData("downloadExcelFileNm","사용자접속현황.xlsx");
        	this.fdtExcel.setPostData("sheetname","사용자접속현황");
