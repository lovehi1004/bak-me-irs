(function()
{
    return function()
    {
        ...
        {
            this.set_name("UserMngS03");
            this.set_titletext("사용자관리 관리자 등록화면");
            ...
            obj.set_taborder("6");
            obj.set_text("관리기관 검색");
            obj.set_tooltiptext("관리기관 검색");
            obj.set_accessibilitylabel("관리기관 검색");
            ...
            divInst_form_rdoInstRegistType_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">4</Col><Col id=\"datacolumn\">관리운영</Col></Row></Rows>");
        ...
        // User Script
        this.registerScript("UserMngS03.xfdl", function() {
        /***********************************************************************************
        ...
        ************************************************************************************/
        ...
        this.fnCallback = function(sSvcId, nErrCode, sErrMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		...
        		case "createUser" :
        			// 후처리 코드
        			this.gfnShowMessage(this, ["Alert","관리자 등록이 완료되었습니다."], "", "fnMsgCallback", "msgAlertCreateUser");
        			break;
        		default:
        			break;
        	}
        ...
        this.fnPopupCallback = function(sPopupId, objRtn)
        {
        	...
        	switch (sPopupId)
        	{
        		...
        		case "comInstPop" :
        			...
        			// 게정구분 표시하기
        			this.divUser.form.cboUserClCd.set_readonly(true);					// 관리운영은 게정구분 선택 불가
        ...
        */
        ...
        this.fnSetCode = function()
        {
        	...
        	// 게정구분 표시하기
        	// 관리운영
        	this.dsResult04.filter("cdMgno == 'UCC0001'");
        ...
        */
        ...
        this.loadIncludeScript("UserMngS03.xfdl");
