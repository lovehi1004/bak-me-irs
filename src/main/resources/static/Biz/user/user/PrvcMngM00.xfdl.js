(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"no\" type=\"STRING\" size=\"256\"/><Column id=\"sysClCd\" type=\"STRING\" size=\"256\"/><Column id=\"userId\" type=\"STRING\" size=\"256\"/><Column id=\"lgnId\" type=\"STRING\" size=\"256\"/><Column id=\"flnm\" type=\"STRING\" size=\"256\"/><Column id=\"inqCn\" type=\"STRING\" size=\"256\"/><Column id=\"acsYmd\" type=\"STRING\" size=\"256\"/><Column id=\"acsHr\" type=\"STRING\" size=\"256\"/><Column id=\"acsTime\" type=\"STRING\" size=\"256\"/><Column id=\"ipAddr\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSrh", this);
            obj._setContents("<ColumnInfo><Column id=\"srhCmptncInstNo\" type=\"STRING\" size=\"256\"/><Column id=\"srhLgnId\" type=\"STRING\" size=\"256\"/><Column id=\"srhFlnm\" type=\"STRING\" size=\"256\"/><Column id=\"srhPrvcInqAcsYmdFrom\" type=\"STRING\" size=\"256\"/><Column id=\"srhPrvcInqAcsYmdTo\" type=\"STRING\" size=\"256\"/><Column id=\"srhTo\" type=\"STRING\" size=\"256\"/><Column id=\"srhFrom\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsPageInfo", this);
            obj._setContents("<ColumnInfo><Column id=\"totalCount\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"pageNo\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"listSize\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"from\" type=\"STRING\" size=\"256\"/><Column id=\"to\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"pageNo\">1</Col><Col id=\"listSize\">9</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divList","0","0",null,null,"0","0","1450",null,"405",null,this);
            obj.set_taborder("0");
            obj.set_text("div00");
            this.addChild(obj.name, obj);

            obj = new Div("divSearch","0","0",null,"90","25",null,null,null,null,null,this.divList.form);
            obj.set_taborder("0");
            ...
            obj.set_tooltiptext("관장기관");
            obj.set_accessibilitylabel("관장기관");
            obj.set_text("");
            obj.set_value("1");
            obj.set_index("0");
            this.divList.form.divSearch.addChild(obj.name, obj);
            ...
            obj.set_accessibilitylabel("사용자아이디");
            obj.set_text("");
            this.divList.form.divSearch.addChild(obj.name, obj);
            ...
            obj = new Static("staPrvcInqAcsYmd","edtFlnm:30","29","100","32",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("사용일시 ");
            obj.set_cssclass("sta_WFSA_Label");
            obj.set_fittocontents("width");
            ...
            obj = new Div("divCalFromTo","staPrvcInqAcsYmd:0","30","252","30",null,null,null,null,null,null,this.divList.form.divSearch.form);
            obj.set_taborder("7");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"120\"/><Column size=\"140\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"110\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"소속\"/><Cell col=\"2\" text=\"사용자아이디\"/><Cell col=\"3\" text=\"사용자명\"/><Cell col=\"4\" text=\"수행내역\"/><Cell col=\"5\" text=\"사용일시\"/><Cell col=\"6\" text=\"IP\"/></Band><Band id=\"body\"><Cell text=\"bind:no\" tooltiptext=\"bind:no\" textAlign=\"center\"/><Cell col=\"1\" text=\"bind:bzentNm\" tooltiptext=\"bind:bzentNm\" textAlign=\"center\" displaytype=\"normal\" combodataset=\"dsResult01\" combocodecol=\"cdMgno\" combodatacol=\"cdKornNm\"/><Cell col=\"2\" text=\"bind:lgnId\" tooltiptext=\"bind:lgnId\" textAlign=\"left\"/><Cell col=\"3\" text=\"bind:flnm\" tooltiptext=\"bind:flnm\" textAlign=\"center\"/><Cell col=\"4\" text=\"bind:inqCn\" tooltiptext=\"bind:inqCn\" textAlign=\"center\" displaytype=\"normal\" maskedittype=\"string\" maskeditformat=\"@@@-@@-@@@@@\"/><Cell col=\"5\" text=\"bind:prvcInqAcsTime\" tooltiptext=\"bind:prvcInqAcsTime\" textAlign=\"center\" displaytype=\"normal\" maskedittype=\"string\" maskeditformat=\"@@@-@@-@@@@@\"/><Cell col=\"6\" text=\"bind:ipAddr\" tooltiptext=\"bind:ipAddr\" textAlign=\"center\" displaytype=\"normal\" combodataset=\"dsResult02\" combocodecol=\"cdMgno\" combodatacol=\"cdKornNm\"/></Band></Format></Formats>");
            this.divList.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("PrvcMngM00.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Biz_user
        * BUSINESS      : 개인정보취급자관리 목록화면
        * FILE NAME     : PrvcMngM00.xfdl
        * DESCRIPTION   : 개인정보취급자관리 목록화면 관련 스크립트
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.dsSrh.addRow();
        	this.dsSrh.setColumn(0,'srhCmptncInstNo','');
        	// 페이지표시 Div 초기화
        	this.divList.form.divPaging.form.fnInitPage(this.dsPageInfo, "fnPagingCallback");


        	var objParam = { objDs:this.dsSrh									// 바인딩 데이터셋
        					,sBindFromCol:"srhPrvcInqAcsYmdFrom"								// 바인딩 컬럼(From)
        					,sBindToCol:"srhPrvcInqAcsYmdTo"									// 바인딩 컬럼(To)
        ...
        this.fnCallback = function(sSvcId, nErrCode, sErrMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		case "searchList" :
        			...
        			break;
        		case "searchCommonCode":
        			nRow = this.dsInstCd.insertRow(0);
        			this.dsInstCd.setColumn(nRow,"code", '');
        			this.dsInstCd.setColumn(nRow,"name", '- 전체 -');
        			this.dsSrh.setColumn(0,'srhCmptncInstNo','');
        			break;
        		default:
        			break;
        ...
        ***********************************************************************************/
        ...
        this.fnCallSearchList = function()
        {
        	...
        	objArgs.url 			= "/adm/user/prvcMng/selectPrvcMngList.irs";
        ...
        this.fnCallCommonCodeList = function()
        {
        	...
        	// 공통Transaction 호출
         	var objArgs = {};
         	objArgs.svcId 			= "searchCommonCode";
        ...
        */
        ...
        {
        	var callUrl = "/adm/user/prvcMng/selectPrvcMngExcel.irs";
        	var url = nexacro.getApplication().Tran.fwUrl + callUrl;
        	var srhCmptncInstNo = this.dsSrh.getColumn(0,"srhCmptncInstNo");
        	var srhLgnId = this.dsSrh.getColumn(0,"srhLgnId");
        	var srhFlnm = this.dsSrh.getColumn(0,"srhFlnm");
        	var srhPrvcInqAcsYmdFrom =  this.dsSrh.getColumn(0,"srhPrvcInqAcsYmdFrom");
        	var srhPrvcInqAcsYmdTo = this.dsSrh.getColumn(0,"srhPrvcInqAcsYmdTo");
        	var srhTo = this.dsSrh.getColumn(0,"srhTo");
        	var srhFrom = this.dsSrh.getColumn(0,"srhFrom");

        	if(this.gfnIsNull(srhCmptncInstNo))
        	{
        		this.fdtExcel.setPostData("srhCmptncInstNo", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhCmptncInstNo", srhCmptncInstNo);
        	}

        	if(this.gfnIsNull(srhLgnId))
        	{
        		this.fdtExcel.setPostData("srhLgnId", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhLgnId", srhLgnId);
        	}

        	if(this.gfnIsNull(srhFlnm))
        	{
        		this.fdtExcel.setPostData("srhFlnm", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhFlnm", srhFlnm);
        	}

        	if(this.gfnIsNull(srhPrvcInqAcsYmdFrom))
        	{
        		this.fdtExcel.setPostData("srhPrvcInqAcsYmdFrom", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhPrvcInqAcsYmdFrom", srhPrvcInqAcsYmdFrom);
        	}

        	if(this.gfnIsNull(srhPrvcInqAcsYmdTo))
        	{
        		this.fdtExcel.setPostData("srhPrvcInqAcsYmdTo", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhPrvcInqAcsYmdTo", srhPrvcInqAcsYmdTo);
        	}

        	if(this.gfnIsNull(srhTo))
        	{
        		this.fdtExcel.setPostData("srhTo", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhTo", srhTo);
        	}

        	if(this.gfnIsNull(srhFrom))
        	{
        		this.fdtExcel.setPostData("srhFrom", "");
        	}else
        	{
        		this.fdtExcel.setPostData("srhFrom", srhFrom);
        	}

        	this.fdtExcel.set_url(url);
        	this.fdtExcel.setPostData("downloadExcelFileNm","개인정보취급자관리현황.xlsx");
        	this.fdtExcel.setPostData("sheetname","개인정보취급자관리현황");
        ...
        ***********************************************************************************/
        ...
        this.divList_btnExcelDown_onclick = function(obj,e)
        {
        	...
        	var oPosition	= {width:800,height:670};
        	var objArgs		= {};
        	objArgs.totalCount	= this.dsPageInfo.getColumn(0, "totalCount");
        	objArgs.menuMgno = "MN06030300";
        	var oOption		= {callback:"fnPopupCallback",titletext:"엑셀다운로드 팝업", resizable:false};
        ...
        */
        this.divList_onkeyup = function(obj,e)
        {
        	// enter 키 입력시 검색 버튼 클릭 처리
        	if(e.keycode == 13 && e.altkey == false && e.ctrlkey == false && e.shiftkey == false)
        	{
        		var focusComponent = this.getFocus();
        		if( focusComponent == this.divList.form.divSearch.form.cboCmptncInstNo
        		||  focusComponent == this.divList.form.divSearch.form.edtFlnm
        		||  focusComponent == this.divList.form.divSearch.form.edtLgnId
        		||  focusComponent == "[object Calendar]")
        		{
        			this.dsSrh.setColumn(0,'srhFlnm',this.divList.form.divSearch.form.edtLgnId.value);
        			this.dsSrh.setColumn(0,'srhLgnId',this.divList.form.divSearch.form.edtFlnm.value);
        ...
        this.on_initEvent = function()
        {
            ...
            this.divList.addEventHandler("onkeyup",this.divList_onkeyup,this);
            ...
            this.divList.form.divSearch.form.staPrvcInqAcsYmd.addEventHandler("onclick",this.divList_divSearch_sta00_onclick,this);
        ...
        this.loadIncludeScript("PrvcMngM00.xfdl");
