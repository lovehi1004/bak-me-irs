(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"srhCmptncInstNo\" type=\"STRING\" size=\"256\"/><Column id=\"srhLgnId\" type=\"STRING\" size=\"256\"/><Column id=\"srhFlnm\" type=\"STRING\" size=\"256\"/><Column id=\"srhPrvcInqAcsYmdFrom\" type=\"STRING\" size=\"256\"/><Column id=\"srhPrvcInqAcsYmdTo\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsPageInfo", this);
            obj._setContents("<ColumnInfo><Column id=\"totalCount\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"pageNo\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"listSize\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"from\" type=\"STRING\" size=\"256\"/><Column id=\"to\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"pageNo\">1</Col><Col id=\"listSize\">10</Col></Row></Rows>");
            this.addChild(obj.name, obj);
        ...
        this.fnPopupCallback = function(sPopupId, objRtn)
        {
        	...
        	switch (sPopupId)
        	{
        		...
        		case "popModalExcelDownP01" :
        			...
        			this.dsPageInfo.addColumn("from", "STRING", 255);
        			this.dsPageInfo.addColumn("to", "STRING", 255);
        			this.dsPageInfo.setColumn(0,'from',objRtnValue["from"])
        			this.dsPageInfo.setColumn(0,'to',objRtnValue["to"])
        			break;
        		default:
        			break;
        	}
