(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("국가코드 등록 팝업 > 국가코드 등록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"iataNtnCd\" type=\"STRING\" size=\"256\"/><Column id=\"checkYn\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnDupl","edtIataNtnCd:3","7","111","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("2");
            obj.set_text("중복 검색");
            ...
            obj.set_accessibilitylabel("국가코드 초기화");
            obj.set_accessibilitydescription("국가코드 초기화");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("NtnCdP01.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.dsDtl.setColumn(0, "iataNtnCd"    , ""    );
        	this.dsDtl.setColumn(0, "ntnKornNm"  , ""    );
        	this.dsDtl.setColumn(0, "ntnEngNm"   , ""    );
        	this.dsDtl.setColumn(0, "delYn"          , "N"   );

        	// 중복체크 초기화
        	this.fnClearDsCheckInfo();

        	this.divFrm.form.divEvlReg.form.edtIataNtnCd.setFocus();
        };
        	...
        	switch (sSvcId)
        	{
        		...
        		case "checkNtnCd" :
        			...
        			if(this.dsCheckInfo.getColumn(0, "checkYn") == "Y") {
        				...
        				this.divFrm.form.divEvlReg.form.edtIataNtnCd.set_readonly(true);
        ...
        */
        this.fnCallInsert = function()
        {
        	// 공통Transaction 호출
         	var objArgs = {};
         	objArgs.svcId 			= "insertNtnCd";
        	objArgs.url 			= "/adm/cd/ntnCd/insertNtnCd.irs";
        ...
        /**
         * @description 국가코드 중복체크 하기
        */
        this.fnCallCheckDupl = function(sIataNtnCd)
        {
        	// 중복체크 초기화
        	this.fnClearDsCheckInfo();

        	this.dsCheckInfo.setColumn(0, "iataNtnCd", sIataNtnCd);

        	var objArgs = {};
         	objArgs.svcId 			= "checkNtnCd";
        	objArgs.url 			= "/adm/cd/ntnCd/checkNtnCd.irs";
        ...
        */
        this.btnSave_onclick = function(obj,e)
        {
        	...
        	// 국가코드
        	if(this.gfnIsNull(this.divFrm.form.divEvlReg.form.edtIataNtnCd.value)) {
        		this.gfnShowMessage(this, "W000014", this.divFrm.form.divEvlReg.form.edtIataNtnCd.tooltiptext, function(svcid, variant) {
        			this.divFrm.form.divEvlReg.form.edtIataNtnCd.setFocus();
        		});
        		return false;
        	}
        ...
        */
        this.divFrm_divEvlReg_btnDupl_onclick = function(obj,e)
        {
        	...
        	if(this.gfnIsNull(this.divFrm.form.divEvlReg.form.edtIataNtnCd.value)) {
        		...
        		var sIataNtnCd = this.divFrm.form.divEvlReg.form.edtIataNtnCd.value;
        		var containsNonUpperCase = /[^A-Z]/.test(sIataNtnCd);

        		if (containsNonUpperCase) {
        			this.gfnShowMessage(this, ["Alert","대문자로만 입력하세요."], "", function(svcid, variant) {
        				this.divFrm.form.divEvlReg.form.edtIataNtnCd.setFocus();
        			});
        			return false;
        		}
        	...
        	// 길이체크
        	if(this.divFrm.form.divEvlReg.form.edtIataNtnCd.value.length != 2) {
        		this.gfnShowMessage(this, ["Alert","국가코드는 2자리로 입력하세요."], "", function(svcid, variant) {
        			this.divFrm.form.divEvlReg.form.edtIataNtnCd.setFocus();
        		});
        		return false;
        	}
        	...
        	// 중복체크 하기
        	this.fnCallCheckDupl(this.divFrm.form.divEvlReg.form.edtIataNtnCd.value);
        };
        ...
        */
        ...
        {
        	this.divFrm.form.divEvlReg.form.edtIataNtnCd.set_readonly(false);
        ...
        this.loadIncludeScript("NtnCdP01.xfdl");
