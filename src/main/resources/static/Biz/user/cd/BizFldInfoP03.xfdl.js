(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("사업분야 정보 관리 > 사업세부분야 등록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"bizFldCdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"bizFldKornNm\" type=\"STRING\" size=\"256\"/><Column id=\"bizFldDtlCdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"bizDtlFldKornNm\" type=\"STRING\" size=\"256\"/><Column id=\"bizDtlFldEngNm\" type=\"STRING\" size=\"256\"/><Column id=\"bizDtlFldCn\" type=\"STRING\" size=\"256\"/><Column id=\"sortSeqo\" type=\"STRING\" size=\"256\"/><Column id=\"useYn\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCheckInfo", this);
            obj._setContents("<ColumnInfo><Column id=\"bizFldCdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"bizFldDtlCdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"checkYn\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_taborder("8");
            obj.set_text("사업세부분야한글명");
            obj.set_cssclass("sta_WF_Label_E");
            obj.set_tooltiptext("사업세부분야 한글명");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);
            ...
            obj.set_taborder("10");
            obj.set_text("사업세부분야영문명");
            obj.set_cssclass("sta_WF_Label_E");
            obj.set_tooltiptext("사업세부분야 영문명");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);
            ...
            obj.set_text("사업세부분야\r\n코드 설명");
            obj.set_cssclass("sta_WF_Label_E");
            obj.set_tooltiptext("사업세부분야 코드 설명");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);
            ...
            obj = new Button("btnDupl","edtBizFldDtlCdMgno:3","93","111","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("6");
            obj.set_text("중복 검색");
            obj.set_tooltiptext("중복 검색");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Button("btnDelDupl","btnDupl:3","93","40","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("7");
        ...
        // User Script
        this.registerScript("BizFldInfoP03.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Develop_Sample
        * BUSINESS      : BizFldInfoP01 Form
        * FILE NAME     : BizFldInfoP01.xfdl
        * DESCRIPTION   : 사업세부분야 등록
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.dsDtl.setColumn(0, "bizFldCdMgno"    , this.pvBizFldCdMgno    );
        	this.dsDtl.setColumn(0, "bizFldKornNm"    , this.pvBizFldKornNm    );
        	this.dsDtl.setColumn(0, "bizFldDtlCdMgno"    , ""    );
        	this.dsDtl.setColumn(0, "bizDtlFldKornNm"  , ""    );
        	this.dsDtl.setColumn(0, "bizDtlFldEngNm"   , ""    );
        	this.dsDtl.setColumn(0, "bizDtlFldCn"      , ""    );
        	this.dsDtl.setColumn(0, "sortSeqo"  , ""    );
        	this.dsDtl.setColumn(0, "useYn"     , "Y"    );

        	// 중복체크 초기화
        	this.fnClearDsCheckInfo();

        	this.divFrm.form.divEvlReg.form.edtBizFldDtlCdMgno.setFocus();
        };
        	...
        	switch (sSvcId)
        	{
        		...
        		case "checkBizFldDtl" :
        			...
        			if(this.dsCheckInfo.getColumn(0, "checkYn") == "Y") {
        				...
        				this.divFrm.form.divEvlReg.form.edtBizFldDtlCdMgno.set_readonly(true);
        ...
        */
        this.fnCallInsert = function()
        {
        	...
        	objArgs.url 			= "/adm/cd/bizFldInfo/insertBizSubFldInfo.irs";
        ...
        /**
         * @description 사업세부분야 중복체크 하기
        */
        this.fnCallCheckDupl = function(sBizFldDtlCdMgno)
        {
        	// 중복체크 초기화
        	this.fnClearDsCheckInfo();
        	this.dsCheckInfo.setColumn(0, "bizFldCdMgno", this.pvBizFldCdMgno);
        	this.dsCheckInfo.setColumn(0, "bizFldDtlCdMgno", sBizFldDtlCdMgno);

        	var objArgs = {};
         	objArgs.svcId 			= "checkBizFldDtl";
        	objArgs.url 			= "/adm/cd/bizFldInfo/selectBizSubFldCnt.irs";
        ...
        */
        this.btnSave_onclick = function(obj,e)
        {
        	...
        	// 코드
        	if(this.gfnIsNull(this.divFrm.form.divEvlReg.form.edtBizFldDtlCdMgno.value)) {
        		this.gfnShowMessage(this, "W000014", this.divFrm.form.divEvlReg.form.edtBizFldDtlCdMgno.tooltiptext, function(svcid, variant) {
        			this.divFrm.form.divEvlReg.form.edtBizFldDtlCdMgno.setFocus();
        		});
        		return false;
        	}
        ...
        */
        this.divFrm_divEvlReg_btnDupl_onclick = function(obj,e)
        {
        	...
        	// 길이체크
        // 	if(this.divFrm.form.divEvlReg.form.edtBizFldDtlCdMgno.value.length != 7) {
        // 		this.gfnShowMessage(this, ["Alert","코드는 7자리로 입력하세요."], "", function(svcid, variant) {
        // 			this.divFrm.form.divEvlReg.form.edtBizFldDtlCdMgno.setFocus();
        // 		});
        // 		return false;
        // 	}
        	...
        	// 중복체크 하기
        	this.fnCallCheckDupl(this.divFrm.form.divEvlReg.form.edtBizFldDtlCdMgno.value);
        };
        ...
        */
        ...
        {
        	this.divFrm.form.divEvlReg.form.edtBizFldDtlCdMgno.set_readonly(false);
        ...
        this.loadIncludeScript("BizFldInfoP03.xfdl");
