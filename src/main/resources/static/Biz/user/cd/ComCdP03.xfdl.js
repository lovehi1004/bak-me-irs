(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("공통코드 관리 > 코드 등록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"groupCdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"groupCdKornNm\" type=\"STRING\" size=\"256\"/><Column id=\"cdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"cdKornNm\" type=\"STRING\" size=\"256\"/><Column id=\"cdEngNm\" type=\"STRING\" size=\"256\"/><Column id=\"cdCn\" type=\"STRING\" size=\"256\"/><Column id=\"sortSeqo\" type=\"STRING\" size=\"256\"/><Column id=\"delYn\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCheckInfo", this);
            obj._setContents("<ColumnInfo><Column id=\"groupCdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"cdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"checkYn\" type=\"STRING\" size=\"256\"/><Column id=\"cdCnt\" type=\"STRING\" size=\"256\"/><Column id=\"cdRegLmtCnt\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj = new Button("btnDupl","edtCdMgno:3","93","111","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("6");
            obj.set_text("중복 검색");
        ...
        // User Script
        this.registerScript("ComCdP03.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.dsDtl.setColumn(0, "groupCdMgno"    , this.pvGroupCdMgno    );
        	this.dsDtl.setColumn(0, "groupCdKornNm"    , this.pvGroupCdKornNm    );
        	this.dsDtl.setColumn(0, "cdMgno"    , ""    );
        	this.dsDtl.setColumn(0, "cdKornNm"  , ""    );
        	this.dsDtl.setColumn(0, "cdEngNm"   , ""    );
        	this.dsDtl.setColumn(0, "cdCn"      , ""    );
        ...
        this.fnCallback = function(sSvcId, nErrCode, sErrMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		...
        		case "checkComCd" :
        			...
        			var cdCnt = this.dsCheckInfo.getColumn(0, "cdCnt");					// 코드등록건수
        			var cdRegLmtCnt = this.dsCheckInfo.getColumn(0, "cdRegLmtCnt");		// 코드등록제한수, 0 : 무제한

        			// 코드등록제한수 만큼 코드가 등록된 경우 등록 불가 메세지처리
        			if(cdRegLmtCnt != 0 && cdCnt >= cdRegLmtCnt) {
        				this.gfnShowMessage(this, ["Alert","코드등록제한건수를 초과하였습니다.\n코드 추가등록이 불가능합니다."], "", function(svcid, variant) {
        				...
        				if(this.dsCheckInfo.getColumn(0, "checkYn") == "Y") {
        					...
        					this.divFrm.form.divEvlReg.form.edtCdMgno.set_readonly(true);
        					...
        					this.gfnShowMessage(this, ["Alert","이미 사용중입니다.\n다시 입력해주세요."], "", function(svcid, variant) {
        						this.divFrm.form.divEvlReg.form.edtCdMgno.setFocus();
        					});
        				}
        			}
        			break;
        ...
        */
        this.fnCallInsert = function()
        {
        	// 공통Transaction 호출
         	var objArgs = {};
         	objArgs.svcId 			= "insertComCd";
        	objArgs.url 			= "/adm/cd/comCd/insertComCd.irs";
        ...
        */
        this.fnCallCheckDupl = function(sCdMgno)
        {
        	// 중복체크 초기화
        	this.fnClearDsCheckInfo();
        	this.dsCheckInfo.setColumn(0, "groupCdMgno", this.pvGroupCdMgno);
        	this.dsCheckInfo.setColumn(0, "cdMgno", sCdMgno);

        	var objArgs = {};
         	objArgs.svcId 			= "checkComCd";
        	objArgs.url 			= "/adm/cd/comCd/checkComCd.irs";
        ...
        */
        this.btnSave_onclick = function(obj,e)
        {
        	...
        	// 코드
        	if(this.gfnIsNull(this.divFrm.form.divEvlReg.form.edtCdMgno.value)) {
        		this.gfnShowMessage(this, "W000014", this.divFrm.form.divEvlReg.form.edtCdMgno.tooltiptext, function(svcid, variant) {
        			this.divFrm.form.divEvlReg.form.edtCdMgno.setFocus();
        		});
        		return false;
        	}
        ...
        */
        this.divFrm_divEvlReg_btnDupl_onclick = function(obj,e)
        {
        	...
        	// 길이체크
        	if(this.divFrm.form.divEvlReg.form.edtCdMgno.value.length != 7) {
        	...
        	// 중복체크 하기
        	this.fnCallCheckDupl(this.divFrm.form.divEvlReg.form.edtCdMgno.value);
        };
        ...
        */
        ...
        {
        	this.divFrm.form.divEvlReg.form.edtCdMgno.set_readonly(false);
        ...
        this.loadIncludeScript("ComCdP03.xfdl");
