(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"no\" type=\"STRING\" size=\"256\"/><Column id=\"groupCdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"groupCdKornNm\" type=\"STRING\" size=\"256\"/><Column id=\"groupCdEngNm\" type=\"STRING\" size=\"256\"/><Column id=\"groupCdCn\" type=\"STRING\" size=\"256\"/><Column id=\"cdRegLmtCnt\" type=\"STRING\" size=\"256\"/><Column id=\"cdRegLmtCntNm\" type=\"STRING\" size=\"256\"/><Column id=\"delYn\" type=\"STRING\" size=\"256\"/><Column id=\"cdCnt\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            ...
            obj.set_accessibilitylabel("그룹코드한글명");
            obj.set_text("");
            this.divList.form.divSearch.addChild(obj.name, obj);
            ...
            obj.set_tooltiptext("그룹코드영문명");
            obj.set_maxlength("100");
            obj.set_accessibilitylabel("그룹코드영문명");
            obj.set_text("");
            this.divList.form.divSearch.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"150\"/><Column size=\"140\"/><Column size=\"140\"/><Column size=\"160\"/><Column size=\"120\"/><Column size=\"50\"/><Column size=\"80\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"54\"/></Rows><Band id=\"head\"><Cell text=\"번호\" tooltiptext=\"번호\"/><Cell col=\"1\" text=\"그룹코드\" tooltiptext=\"그롭코드\"/><Cell col=\"2\" text=\"그룹코드 한글명\" tooltiptext=\"그룹코드 한글명\"/><Cell col=\"3\" text=\"그룹코드 영문명\" tooltiptext=\"그룹코드 영문명\"/><Cell col=\"4\" text=\"그룹코드 설명\" tooltiptext=\"그룹코드 설명\"/><Cell col=\"5\" text=\"코드등록제한수\" tooltiptext=\"코드등록제한수\"/><Cell col=\"6\" text=\"건수\" tooltiptext=\"건수\"/><Cell col=\"7\" text=\"사용여부\" tooltiptext=\"사용여부\"/></Band><Band id=\"body\"><Cell text=\"bind:no\" tooltiptext=\"번호\" textAlign=\"center\" accessibilitylabel=\"번호\"/><Cell col=\"1\" text=\"bind:groupCdMgno\" tooltiptext=\"그롭코드\" edittype=\"none\" displaytype=\"normal\" font=\"normal 700 15px/17px &quot;NotoSansKR&quot;\" accessibilitylabel=\"그롭코드\"/><Cell col=\"2\" text=\"bind:groupCdKornNm\" tooltiptext=\"그룹코드 한글명\" edittype=\"none\" displaytype=\"normal\" accessibilitylabel=\"그룹코드 한글명\"/><Cell col=\"3\" text=\"bind:groupCdEngNm\" tooltiptext=\"그룹코드 영문명\" edittype=\"none\" displaytype=\"normal\" accessibilitylabel=\"그룹코드 영문명\"/><Cell col=\"4\" text=\"bind:groupCdCn\" tooltiptext=\"그룹코드 설명\" edittype=\"none\" displaytype=\"normal\" accessibilitylabel=\"그룹코드 설명\"/><Cell col=\"5\" text=\"bind:cdRegLmtCntNm\" tooltiptext=\"코드등록제한수\" cssclass=\"expr:cdRegLmtCnt&gt;0 ? &apos;cell_WF_Point01&apos; : &apos;&apos;\" textAlign=\"center\" accessibilitylabel=\"코드등록제한수\"/><Cell col=\"6\" text=\"bind:cdCnt\" tooltiptext=\"건수\" textAlign=\"center\" cssclass=\"expr:cdCnt==0 ? &apos;cell_WF_Point01&apos; : &apos;&apos;\" font=\"normal 700 15px/17px &quot;NotoSansKR&quot;\" accessibilitylabel=\"건수\"/><Cell col=\"7\" text=\"bind:delYn\" displaytype=\"combotext\" edittype=\"none\" combodataset=\"dsStaticYn\" combocodecol=\"code\" combodatacol=\"value\" tooltiptext=\"사용여부\" font=\"normal 900 15px/17px &quot;NotoSansKR&quot;\" cssclass=\"expr:delYn==&apos;Y&apos; ? &apos;cell_WF_Point01&apos; : &apos;cell_WF_Point03&apos;\" accessibilitylabel=\"사용여부\"/></Band></Format></Formats>");
            this.divList.addChild(obj.name, obj);
            ...
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"120\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"172\"/><Column size=\"50\"/><Column size=\"80\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"54\"/></Rows><Band id=\"head\"><Cell text=\"코드\" tooltiptext=\"코드\"/><Cell col=\"1\" text=\"코드 한글명\" tooltiptext=\"코드 한글명\"/><Cell col=\"2\" text=\"코드 영문명 \" tooltiptext=\"코드 영문명\"/><Cell col=\"3\" text=\"코드 설명\" tooltiptext=\"코드 설명\"/><Cell col=\"4\" text=\"순서\" tooltiptext=\"순서\"/><Cell col=\"5\" text=\"사용여부\" tooltiptext=\"사용여부\"/></Band><Band id=\"body\"><Cell text=\"bind:cdMgno\" displaytype=\"normal\" edittype=\"none\" tooltiptext=\"코드\" textAlign=\"center\" font=\"normal 700 15px/17px &quot;NotoSansKR&quot;\" accessibilitylabel=\"코드\"/><Cell col=\"1\" text=\"bind:cdKornNm\" edittype=\"none\" displaytype=\"normal\" tooltiptext=\"코드 한글명\" textAlign=\"center\" accessibilitylabel=\"코드 한글명\"/><Cell col=\"2\" text=\"bind:cdEngNm\" edittype=\"none\" displaytype=\"normal\" tooltiptext=\"코드 영문명\" textAlign=\"center\" accessibilitylabel=\"코드 영문명\"/><Cell col=\"3\" text=\"bind:cdCn\" edittype=\"none\" displaytype=\"normal\" tooltiptext=\"코드 설명\" accessibilitylabel=\"코드 설명\"/><Cell col=\"4\" text=\"bind:sortSeqo\" displaytype=\"normal\" edittype=\"none\" tooltiptext=\"순서\" editinputtype=\"digit\" textAlign=\"center\" accessibilitylabel=\"순서\"/><Cell col=\"5\" text=\"bind:delYn\" displaytype=\"combotext\" edittype=\"none\" combodataset=\"dsStaticYn\" combocodecol=\"code\" combodatacol=\"value\" tooltiptext=\"사용여부\" cssclass=\"expr:delYn==&apos;Y&apos; ? &apos;cell_WF_Point01&apos; : &apos;cell_WF_Point03&apos;\" font=\"normal 900 15px/17px &quot;NotoSansKR&quot;\" accessibilitylabel=\"사용여부\"/></Band></Format></Formats>");
            this.divList.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("ComCdM00.xfdl","");
        this.registerScript("ComCdM00.xfdl", function() {
        /***********************************************************************************
        ...
        this.fnPopupCallback = function(sPopupId, objRtn)
        {
        	...
        	switch (sPopupId)
        	{
        		...
        		case "ComCdP02" :
        			...
        			if(objRtnValue["isReLoad"] == "Y") {
        				var groupCdMgno = "";
        				if(!this.gfnIsNull(objRtnValue["groupCdMgno"])) {
        					groupCdMgno = objRtnValue["groupCdMgno"];
        				}

        				this.fnReload(groupCdMgno);			// 재조회
        			}
        	...
        	switch (sSvcId)
        	{
        		case "searchList" :
        			...
        			if(this.dsList.rowcount > 0) {
        				var groupCdMgno = this.dsList.getColumn(0, "groupCdMgno");

        				trace("값 확인 -> [groupCdMgno]["+groupCdMgno+"]");
        				this.dsDtlSrh.clearData();
        				this.dsDtlSrh.addRow();
        				this.dsDtlSrh.setColumn(0, "srhGroupCdMgno", groupCdMgno);
        ...
        */
        ...
        this.fnCallSearchDtlList = function()
        {
        	...
        	objArgs.url 			= "/adm/cd/comCd/selectComCdList.irs";
        ...
        */
         ...
         * @desc 재조회
        */
        this.fnReload = function(groupCdMgno)
        {
        	this.dsSrh.clearData();
        	this.dsSrh.addRow();

        	if(!this.gfnIsNull(groupCdMgno)) {
        		this.dsSrh.setColumn(0, "srhGroupCdMgno", groupCdMgno);
        	} else {
        		this.dsSrh.setColumn(0, "srhGroupCdMgno", "");
        	}
        	this.dsSrh.setColumn(0, "srhGroupCdEngNm", "");
        ...
        */
        ...
        {
        	var groupCdMgno = this.dsList.getColumn(e.row, "groupCdMgno");
        	trace("값 확인 -> [groupCdMgno]["+groupCdMgno+"]");
        	this.dsDtlSrh.clearData();
        	this.dsDtlSrh.addRow();
        	this.dsDtlSrh.setColumn(0, "srhGroupCdMgno", groupCdMgno);
        ...
        */
        this.divList_divLeftHeader_btnUpt_onclick = function(obj,e)
        {
        	...
        	if(selectedRows.length == 0) {
        		// 선택된 행이 없음
        		this.gfnShowMessage(this, ["Alert","그룹코드 목록에서 수정할 그룹코드를 선택하세요."], "");
        	} else {
        		var groupCdMgno = this.dsList.getColumn(selectedRows[0], "groupCdMgno");

        		var sPopupId 	= "ComCdP02";
        		var sMnuId 		= "MN06064300";
        		var oPosition	= {width:590,height:542};
        		var objArgs		= {pvGroupCdMgno : groupCdMgno};

        		var oOption		= {callback:"fnPopupCallback",titletext:"그룹코드 수정"};
        ...
        */
        this.divList_divRightHeader_btnDtlReg_onclick = function(obj,e)
        {
        	...
        	if(selectedRows.length == 0) {
        		// 선택된 행이 없음
        		this.gfnShowMessage(this, ["Alert","그룹코드 목록에서 등록할 그룹코드를 선택하세요."], "");
        	} else {
        		var groupCdMgno = this.dsList.getColumn(selectedRows[0], "groupCdMgno");
        		var groupCdKornNm = this.dsList.getColumn(selectedRows[0], "groupCdKornNm");

        		var sPopupId 	= "ComCdP03";
        		var sMnuId 		= "MN06064400";
        		var oPosition	= {width:590,height:628};
        		var objArgs		= {pvGroupCdMgno : groupCdMgno, pvGroupCdKornNm : groupCdKornNm};

        		var oOption		= {callback:"fnPopupCallback",titletext:"코드 등록"};
        ...
        */
        this.divList_divRightHeader_btnDtlUpt_onclick = function(obj,e)
        {
        	...
        	if(selectedRows.length == 0) {
        		// 선택된 행이 없음
        		this.gfnShowMessage(this, ["Alert","코드 목록에서 수정할 코드를 선택하세요."], "");
        	} else {
        		var groupCdMgno = this.dsDtlList.getColumn(selectedRows[0], "groupCdMgno");
        		var cdMgno = this.dsDtlList.getColumn(selectedRows[0], "cdMgno");

        		/* 좌측그리드에서 꺼내오기 */
        		var groupSelectedRows = this.divList.form.grdList.getSelectedRows();
        		var groupCdKornNm = this.dsList.getColumn(groupSelectedRows[0], "groupCdKornNm");

        		var sPopupId 	= "ComCdP04";
        		var sMnuId 		= "MN06064500";
        		var oPosition	= {width:590,height:628};
        		var objArgs		= {pvGroupCdMgno : groupCdMgno, pvGroupCdKornNm : groupCdKornNm, pvCdMgno : cdMgno};

        		var oOption		= {callback:"fnPopupCallback",titletext:"코드 수정"};
        ...
        this.loadIncludeScript("ComCdM00.xfdl");
