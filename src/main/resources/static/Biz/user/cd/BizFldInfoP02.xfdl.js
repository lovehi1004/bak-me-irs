(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("사업분야 정보 관리 > 사업분야 수정");
            ...
            obj = new Static("staGroupCdCn","0","129","150","174",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("6");
            ...
            obj = new Static("staLine5","0","301",null,"44","0",null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("15");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Static("staDelYn","0","301","150","44",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("8");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WF_Label");
            ...
            obj = new Combo("cboUseYn","staDelYn:7","308","120","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("9");
        ...
        // User Script
        this.registerScript("BizFldInfoP02.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Develop_Sample
        * BUSINESS      : BizFldInfoP02 Form
        * FILE NAME     : BizFldInfoP02.xfdl
        * DESCRIPTION   : 사업분야 수정 팝업
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	try
        	{
        		this.pvBizFldCdMgno  	= this.getOwnerFrame().arguments["pvBizFldCdMgno"];		// 사업분야
        	}
        	catch (e)
        	{
        ...
        */
        this.fnCallSelectDtl = function()
        {
        	...
        	objArgs.url 			= "/adm/cd/bizFldInfo/selectBizFldInfoDetail.irs";
        ...
        */
        this.fnCallDelete = function()
        {
        	...
        	objArgs.url 			= "/adm/cd/bizFldInfo/deleteBizFldInfo.irs";
        ...
        */
        this.fnCallSave = function()
        {
        	...
        	objArgs.url 			= "/adm/cd/bizFldInfo/updateBizFldInfo.irs";
         	objArgs.inds      		= "dsDtl=dsDtl";
         	objArgs.outds     		= "";
         	objArgs.args 			= "";
         	objArgs.callback		= "fnCallback";
        ...
        */
        ...
        this.loadIncludeScript("BizFldInfoP02.xfdl");
