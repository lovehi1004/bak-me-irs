(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("사업분야 정보 관리 > 사업분야 등록");
            ...
            obj._setContents("<ColumnInfo><Column id=\"bizFldCdMgno\" type=\"STRING\" size=\"256\"/><Column id=\"checkYn\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_cssclass("sta_WF_Label_E");
            obj.set_tooltiptext("사업분야 영문명");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Static("staLine4","0","129",null,"174","0",null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("14");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Static("staGroupCdCn","0","129","150","173",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("9");
            obj.set_text("사업분야 내용");
            obj.set_cssclass("sta_WF_Label_E");
            obj.set_tooltiptext("사업분야 내용");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Edit("edtBizFldCdMgno","staGroupCdMgno:7","7","169","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("2");
            obj.set_textAlign("left");
            obj.set_tooltiptext("사업분야코드");
            obj.set_maxlength("20");
            obj.set_readonly("false");
            obj.set_inputtype("number");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Edit("edtBizFldKornNm","staGroupCdKornNm:7","50",null,"30","7",null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("6");
            obj.set_textAlign("left");
            ...
            obj = new Edit("edtBizFldEngNm","staGroupCdEngNm:7","93",null,"30","7",null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("8");
            obj.set_textAlign("left");
            ...
            obj = new TextArea("txaBizFldCn","staGroupCdCn:7","136",null,"160","7",null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("10");
            obj.set_enable("true");
            ...
            obj = new Button("btnDupl","edtBizFldCdMgno:3","7","111","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("3");
            obj.set_text("중복 검색");
            ...
            obj = new Static("staDelYn","0","302","150","44",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("16");
            obj.set_text("사용여부");
            ...
            obj = new Combo("cboUseYn","157","309","120","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("17");
            ...
            obj = new BindItem("item1","divFrm.form.divEvlReg.form.edtBizFldKornNm","value","dsDtl","bizFldKornNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item2","divFrm.form.divEvlReg.form.edtBizFldEngNm","value","dsDtl","bizFldEngNm");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item3","divFrm.form.divEvlReg.form.txaBizFldCn","value","dsDtl","bizFldCn");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item4","divFrm.form.divEvlReg.form.cboUseYn","value","dsDtl","useYn");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("BizFldInfoP01.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Develop_Sample
        * BUSINESS      : BizFldInfoP01 Form
        * FILE NAME     : BizFldInfoP01.xfdl
        * DESCRIPTION   : 사업분야 등록 팝업
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.dsDtl.setColumn(0, "bizFldCdMgno"    , ""    );
        	this.dsDtl.setColumn(0, "bizFldEngNm"  , ""    );
        	this.dsDtl.setColumn(0, "bizFldKornNm"   , ""    );
        	this.dsDtl.setColumn(0, "bizFldCn"      , ""    );
        	this.dsDtl.setColumn(0, "useYn"          , "Y"   );

        	// 중복체크 초기화
        	this.fnClearDsCheckInfo();

        	this.divFrm.form.divEvlReg.form.edtBizFldCdMgno.setFocus();
        };
        	...
        	switch (sSvcId)
        	{
        		...
        		case "checkBizfldCd" :
        			...
        			if(this.dsCheckInfo.getColumn(0, "checkYn") == "Y") {
        				...
        				this.divFrm.form.divEvlReg.form.edtBizFldCdMgno.set_readonly(true);
        				...
        				this.divFrm.form.divEvlReg.form.edtBizFldKornNm.setFocus();
        ...
        */
        this.fnCallInsert = function()
        {
        	// 공통Transaction 호출
         	var objArgs = {};
         	objArgs.svcId 			= "insertBizfldCd";
        	objArgs.url 			= "/adm/cd/bizFldInfo/insertBizFldInfo.irs";
        ...
        */
        this.fnCallCheckDupl = function(sBizFldCdMgno)
        {
        	// 중복체크 초기화
        	this.fnClearDsCheckInfo();

        	this.dsCheckInfo.setColumn(0, "bizFldCdMgno", sBizFldCdMgno);

        	var objArgs = {};
         	objArgs.svcId 			= "checkBizfldCd";
        	objArgs.url 			= "/adm/cd/bizFldInfo/selectBizFldCnt.irs";
        ...
        */
        this.btnSave_onclick = function(obj,e)
        {
        	...
        	// 사업분야코드
        	if(this.gfnIsNull(this.divFrm.form.divEvlReg.form.edtBizFldCdMgno.value)) {
        		this.gfnShowMessage(this, "W000014", this.divFrm.form.divEvlReg.form.edtBizFldCdMgno.tooltiptext, function(svcid, variant) {
        			this.divFrm.form.divEvlReg.form.edtBizFldCdMgno.setFocus();
        		});
        		return false;
        	}
        	...
        	// 사업분야 한글명
        	if(this.gfnIsNull(this.divFrm.form.divEvlReg.form.edtBizFldKornNm.value)) {
        		this.gfnShowMessage(this, "W000014", this.divFrm.form.divEvlReg.form.edtBizFldKornNm.tooltiptext, function(svcid, variant) {
        			this.divFrm.form.divEvlReg.form.edtBizFldKornNm.setFocus();
        		});
        		return false;
        	}
        	...
        	// 사업분야 영문명
        	if(this.gfnIsNull(this.divFrm.form.divEvlReg.form.edtBizFldEngNm.value)) {
        		this.gfnShowMessage(this, "W000014", this.divFrm.form.divEvlReg.form.edtBizFldEngNm.tooltiptext, function(svcid, variant) {
        			this.divFrm.form.divEvlReg.form.edtBizFldEngNm.setFocus();
        		});
        		return false;
        	}

        	// 사업분야 설명
        	if(this.gfnIsNull(this.divFrm.form.divEvlReg.form.txaBizFldCn.value)) {
        		this.gfnShowMessage(this, "W000014", this.divFrm.form.divEvlReg.form.txaBizFldCn.tooltiptext, function(svcid, variant) {
        			this.divFrm.form.divEvlReg.form.txaBizFldCn.setFocus();
        		});
        		return false;
        	}
        ...
        */
        this.divFrm_divEvlReg_btnDupl_onclick = function(obj,e)
        {
        	...
        	// 길이체크
        	if(this.divFrm.form.divEvlReg.form.edtBizFldCdMgno.value.length < 1) {
        		this.gfnShowMessage(this, ["Alert","최소 1자리이상 입력하세요."], "", function(svcid, variant) {
        			this.divFrm.form.divEvlReg.form.edtBizFldCdMgno.setFocus();
        		});
        		return false;
        	}
        	...
        	// 중복체크 하기
        	this.fnCallCheckDupl(this.divFrm.form.divEvlReg.form.edtBizFldCdMgno.value);
        };
        ...
        */
        ...
        {
        	this.divFrm.form.divEvlReg.form.edtBizFldCdMgno.set_readonly(false);
        ...
        this.loadIncludeScript("BizFldInfoP01.xfdl");
