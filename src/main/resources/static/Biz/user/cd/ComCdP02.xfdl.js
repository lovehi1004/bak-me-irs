(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            this.set_titletext("공통코드 관리 > 그룹코드 수정");
            ...
            obj = new Static("staEvlH3","0","43",null,"44","0",null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("1");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);
            ...
            obj = new Static("staEvlOpnn","0","43","150","44",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("3");
            ...
            obj = new Static("staEvlH3_00","0","86",null,"44","0",null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("5");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Static("staEvlOpnn00","0","86","150","44",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("6");
            obj.set_text("그룹코드영문명");
            obj.set_cssclass("sta_WF_Label_E");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Static("staEvlH3_01","0","129",null,"44","0",null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("7");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Static("staEvlOpnn01","0","129","150","44",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("8");
            obj.set_text("그룹코드설명");
            obj.set_cssclass("sta_WF_Label");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Static("staEvlH3_02","0","172",null,"44","0",null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_WF_LabelBg");
            obj.set_text("");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Static("staEvlOpnn02","0","172","150","44",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("10");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WF_Label");
            this.divFrm.form.divEvlReg.addChild(obj.name, obj);

            obj = new Combo("cboEvlTypeCd00","staEvlOpnn02:7","179","227","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("11");
            ...
            obj = new Edit("edtRprsvNm","staEvlTypeCd:7","7","236","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("12");
            ...
            obj = new Edit("edtRprsvNm00","staEvlOpnn:7","50","236","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("13");
            obj.set_textAlign("left");
            obj.set_tooltiptext("대표자명");
            ...
            obj = new Edit("edtRprsvNm00_00","staEvlOpnn00:7","93","236","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("14");
            obj.set_textAlign("left");
            obj.set_tooltiptext("대표자명");
            obj.set_maxlength("100");
            ...
            obj = new Button("Button03_01","219",null,"75","32",null,"45",null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("저장");
            obj.set_cssclass("btn_POP_Confirm");
            this.addChild(obj.name, obj);

            obj = new Button("Button03_01_00","Button03_01:3",null,"75","32",null,"45",null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("닫기");
            ...
            obj = new BindItem("item23","divFrm.form.divEvlReg.form.cboEvlTypeCd00","value","dsEvlReg","evlTypeCd");
            this.addChild(obj.name, obj);
            obj.bind();

            obj = new BindItem("item24","divFrm.form.divEvlReg.form.edtRprsvNm","value","dsInstInfo","rprsvNm");
            this.addChild(obj.name, obj);
            obj.bind();
        ...
        // User Script
        this.registerScript("ComCdP02.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.loadIncludeScript("ComCdP02.xfdl");
