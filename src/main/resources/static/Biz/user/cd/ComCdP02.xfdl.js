(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Edit("edtGroupCdMgno","staGroupCdMgno:10","10","169","30",null,null,null,null,null,null,this.divFrm.form.divEvlReg.form);
            obj.set_taborder("1");
        ...
        ************************************************************************************/
        ...
        this.fnCallback = function(sSvcId, nErrCode, sErrMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		...
        		case "deleteComGrpCd" :
        			// 후처리 코드
        			var cdCnt = this.dsDtl.getColumn(0, "cdCnt");
        			...
        			if(cdCnt == 0) {
        				...
        				this.gfnShowMessage(this, ["Alert","그룹코드내 코드가 발견되어 삭제가 불가능 합니다.\n코드 삭제 후 그룹코드 삭제가 가능합니다."], "", "");
        			}
        ...
        */
        this.fnCallSelectDtl = function()
        {
        	// 공통Transaction 호출
         	var objArgs = {};
         	objArgs.svcId 			= "selectComGrpCdDetail";
        	objArgs.url 			= "/adm/cd/comCd/selectComGrpCdDetail.irs";
        ...
        */
        this.fnCallDelete = function()
        {
        	// 공통Transaction 호출
         	var objArgs = {};
         	objArgs.svcId 			= "deleteComGrpCd";
        	objArgs.url 			= "/adm/cd/comCd/deleteComGrpCd.irs";
        ...
        */
        this.fnCallSave = function()
        {
        	// 공통Transaction 호출
         	var objArgs = {};
         	objArgs.svcId 			= "updateComGrpCd";
        	objArgs.url 			= "/adm/cd/comCd/updateComGrpCd.irs";
         	objArgs.inds      		= "dsDtl=dsDtl";
         	objArgs.outds     		= "";
         	objArgs.args 			= "";
         	objArgs.callback		= "fnCallback";
