(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"cncldMgno\" type=\"STRING\" size=\"256\"/><Column id=\"cncldDgr\" type=\"STRING\" size=\"256\"/><Column id=\"relCncldMgno\" type=\"STRING\" size=\"256\"/><Column id=\"cncldOrgtNm\" type=\"STRING\" size=\"256\"/><Column id=\"cncldKrnNm\" type=\"STRING\" size=\"256\"/><Column id=\"cncldNo\" type=\"STRING\" size=\"256\"/><Column id=\"sgntYmd\" type=\"STRING\" size=\"256\"/><Column id=\"cncldClNm\" type=\"STRING\" size=\"256\"/><Column id=\"cncldClCd\" type=\"STRING\" size=\"256\"/><Column id=\"cncldYn\" type=\"STRING\" size=\"256\"/><Column id=\"newRvsnTypeNm\" type=\"STRING\" size=\"256\"/><Column id=\"newRvsnTypeCd\" type=\"STRING\" size=\"256\"/><Column id=\"regTypeCd\" type=\"STRING\" size=\"256\"/><Column id=\"eftvnYmd\" type=\"STRING\" size=\"256\"/><Column id=\"cncldFlmno\" type=\"STRING\" size=\"256\"/><Column id=\"etcDataFlmno\" type=\"STRING\" size=\"256\"/><Column id=\"no\" type=\"STRING\" size=\"256\"/><Column id=\"cncldDgrNm\" type=\"STRING\" size=\"256\"/><Column id=\"ntnNm\" type=\"STRING\" size=\"256\"/><Column id=\"ntnCd\" type=\"STRING\" size=\"256\"/><Column id=\"btnNm\" type=\"STRING\" size=\"256\"/><Column id=\"cncldClCdNm\" type=\"STRING\" size=\"256\"/><Column id=\"cnsltngrpYn\" type=\"STRING\" size=\"256\"/><Column id=\"orgtCncldFlmno\" type=\"STRING\" size=\"256\"/><Column id=\"krnCncldFlmno\" type=\"STRING\" size=\"256\"/><Column id=\"mhdlgMgno\" type=\"STRING\" size=\"256\"/><Column id=\"pactNo\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsSrh", this);
            obj._setContents("<ColumnInfo><Column id=\"srhCncldDgrCd\" type=\"STRING\" size=\"256\"/><Column id=\"srhCncldNm\" type=\"STRING\" size=\"256\"/><Column id=\"cncldClCd\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsPageInfo", this);
            obj._setContents("<ColumnInfo><Column id=\"totalCount\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"pageNo\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"listSize\" type=\"BIGDECIMAL\" size=\"256\"/><Column id=\"cnsltngrpFlag\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"pageNo\">1</Col><Col id=\"listSize\">6</Col></Row></Rows>");
            this.addChild(obj.name, obj);


            obj = new Dataset("dsCncldDgrCd", this);
            obj._setContents("<ColumnInfo><Column id=\"code\" type=\"STRING\" size=\"256\"/><Column id=\"name\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"name\">-전체-</Col><Col id=\"code\"/></Row><Row><Col id=\"name\">신규</Col><Col id=\"code\">NEW</Col></Row><Row><Col id=\"name\">개정</Col><Col id=\"code\">CHG</Col></Row></Rows>");
            this.addChild(obj.name, obj);
            ...
            obj = new Div("divPop","45","89",null,null,"40","50",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("");
            this.addChild(obj.name, obj);
            ...
            obj.set_innerdataset("dsCncldDgrCd");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"208\"/><Column size=\"59\"/><Column size=\"76\"/><Column size=\"96\"/><Column size=\"97\"/><Column size=\"117\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"27\"/><Row size=\"27\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"번호\"/><Cell col=\"1\" text=\"협정.약정.MOU 원문명\"/><Cell col=\"2\" rowspan=\"2\" text=\"구분\"/><Cell col=\"3\" rowspan=\"2\" text=\"신규/개정\"/><Cell col=\"4\" text=\"서명일자\"/><Cell col=\"5\" rowspan=\"2\" text=\"체결국가\"/><Cell col=\"6\" rowspan=\"2\" text=\"선택\"/><Cell row=\"1\" col=\"1\" text=\"협정.약정.MOU 국문명\"/><Cell row=\"1\" col=\"4\" text=\"발효일자\"/></Band><Band id=\"body\"><Cell rowspan=\"2\" textAlign=\"center\" text=\"bind:no\" tooltiptext=\"bind:no\"/><Cell col=\"1\" textAlign=\"left\" tooltiptext=\"bind:cncldOrgtNm\" text=\"expr:dataset.parent.gfnGetRealColSizeText(comp, cncldOrgtNm, currow, 1)\"/><Cell col=\"2\" rowspan=\"2\" textAlign=\"center\" text=\"bind:cncldClNm\" tooltiptext=\"bind:cncldClCdNm\"/><Cell col=\"3\" rowspan=\"2\" textAlign=\"center\" text=\"bind:newRvsnTypeNm\" tooltiptext=\"bind:cncldDgrNm\"/><Cell col=\"4\" textAlign=\"center\" text=\"bind:sgntYmd\" tooltiptext=\"bind:sgntYmd\" border=\"1px solid #dcdee4,1px solid #eeeff3,0px solid #dcdee4\"/><Cell col=\"5\" rowspan=\"2\" text=\"expr:dataset.parent.gfnGetRealColSizeText(comp, ntnNm, currow, 5)\" tooltiptext=\"bind:ntnNm\"/><Cell col=\"6\" rowspan=\"2\" displaytype=\"buttoncontrol\" edittype=\"button\" padding=\"10px\" text=\"bind:btnNm\" tooltiptext=\"bind:btnNm\" textAlign=\"center\"/><Cell row=\"1\" col=\"1\" textAlign=\"left\" text=\"bind:cncldKrnNm\" tooltiptext=\"bind:cncldKrnNm\"/><Cell row=\"1\" col=\"4\" text=\"bind:eftvnYmd\" tooltiptext=\"bind:eftvnYmd\" textAlign=\"center\"/></Band></Format></Formats>");
            this.divPop.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("AgrstipP01.xfdl", function() {
        /***********************************************************************************
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	var cncldClCd = this.gfnGetParameter(objFormFrame, "cncldClCd");
        	var cnsltngrpReg = this.gfnGetParameter(objFormFrame, "cnsltngrpReg");
        	var cnsltngrpFlag = this.gfnGetParameter(objFormFrame, "cnsltngrpFlag");
        	// 검색 데이터셋 초기화.
        	this.dsSrh.addRow();
        	this.dsSrh.setColumn(0, "srhCncldDgrCd", "");
        	this.dsSrh.setColumn(0, "srhCncldNm", "");
        	this.dsSrh.setColumn(0, "cncldClCd", "");
        	if( cncldClCd != '') {
        		this.dsSrh.setColumn(0, "cncldClCd", cncldClCd);
        	}
        	...
        	if(cnsltngrpFlag == "cnsltngrpFlag"){		//국제감축협의체 등록화면에서 팝업 실행했을때
        		this.dsPageInfo.setColumn(0, "cnsltngrpFlag", cnsltngrpFlag);
        	}
        	//목록조회
        ...
        ***********************************************************************************/
        ...
        this.fnCallSearchListCnsltngrp = function ()
        {
        	trace("국제감축협의체 등록에서 체결 목록 호출...");

        	var callUrl = "/common/pop/selectAgreeStiplListCnsltngrp.irs";
        ...
        */
        ...
        this.divPop_grdList_oncellclick = function(obj,e)
        {
        	...
        	if(e.cell == 6)
        	{
        		var strRtn = this.gfnSetPopupReturn({ cncldMgno:this.dsList.getColumn(e.row, "cncldMgno")
        											, cncldDgr:this.dsList.getColumn(e.row, "cncldDgr")
        											, cncldOrgtNm:this.dsList.getColumn(e.row, "cncldOrgtNm")
        											, cncldKrnNm:this.dsList.getColumn(e.row, "cncldKrnNm")
        											, ntnNm:this.dsList.getColumn(e.row, "ntnNm")
        											, cnsltngrpYn:this.dsList.getColumn(e.row, "cnsltngrpYn")
        											, ntnCd:this.dsList.getColumn(e.row, "ntnCd")
        											, sgntYmd:this.dsList.getColumn(e.row, "sgntYmd")
        											, eftvnYmd:this.dsList.getColumn(e.row, "eftvnYmd")
        											, newRvsnTypeCd:this.dsList.getColumn(e.row, "newRvsnTypeCd")
        											, cncldNo:this.dsList.getColumn(e.row, "cncldNo")
        											, cncldClCd:this.dsList.getColumn(e.row, "cncldClCd")
        											, cncldYn:this.dsList.getColumn(e.row, "cncldYn")
        											, etcDataFlmno:this.dsList.getColumn(e.row, "etcDataFlmno")
        											, orgtCncldFlmno:this.dsList.getColumn(e.row, "orgtCncldFlmno")
        											, krnCncldFlmno:this.dsList.getColumn(e.row, "krnCncldFlmno")
        											, mhdlgMgno:this.dsList.getColumn(e.row, "mhdlgMgno")
        											, pactNo:this.dsList.getColumn(e.row, "pactNo")
        											});
        		trace("=====strRtn========"+strRtn);
        ...
        this.loadIncludeScript("AgrstipP01.xfdl");
