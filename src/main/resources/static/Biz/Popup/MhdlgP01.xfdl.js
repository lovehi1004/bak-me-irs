(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"208\"/><Column size=\"59\"/><Column size=\"76\"/><Column size=\"96\"/><Column size=\"97\"/><Column size=\"92\"/></Columns><Rows><Row size=\"24\" band=\"head\"/><Row size=\"24\" band=\"head\"/><Row size=\"27\"/><Row size=\"27\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"번호\"/><Cell col=\"1\" text=\"방법론 원문명\"/><Cell col=\"2\" rowspan=\"2\" text=\"제·개정\"/><Cell col=\"3\" rowspan=\"2\" text=\"방법론분야\"/><Cell col=\"4\" rowspan=\"2\" text=\"방법론고유번호\"/><Cell col=\"5\" rowspan=\"2\" text=\"유효시작일자\"/><Cell col=\"6\" rowspan=\"2\" text=\"선택\"/><Cell row=\"1\" col=\"1\" text=\"방법론 국문명\"/></Band><Band id=\"body\"><Cell rowspan=\"2\" textAlign=\"center\" text=\"bind:no\" tooltiptext=\"bind:no\"/><Cell col=\"1\" textAlign=\"left\" text=\"bind:mhdlgOrgtNm\" tooltiptext=\"bind:mhdlgOrgtNm\"/><Cell col=\"2\" rowspan=\"2\" textAlign=\"center\" text=\"bind:regRsnCdNm\" tooltiptext=\"bind:regRsnCdNm\"/><Cell col=\"3\" rowspan=\"2\" textAlign=\"center\" text=\"bind:mhdlgFldNm\" tooltiptext=\"bind:mhdlgFldNm\"/><Cell col=\"4\" rowspan=\"2\" textAlign=\"center\" border=\"1px solid #dcdee4,1px solid #eeeff3\" text=\"bind:mhdlgUnqno\" tooltiptext=\"bind:mhdlgUnqno\"/><Cell col=\"5\" rowspan=\"2\" text=\"bind:vldBgngYmd\" tooltiptext=\"bind:vldBgngYmd\"/><Cell col=\"6\" rowspan=\"2\" displaytype=\"buttoncontrol\" edittype=\"button\" padding=\"10px\" text=\"bind:btnNm\" tooltiptext=\"bind:btnNm\"/><Cell row=\"1\" col=\"1\" textAlign=\"left\" text=\"bind:mhdlgKrnNm\" tooltiptext=\"bind:mhdlgKrnNm\"/></Band></Format></Formats>");
            this.divPop.addChild(obj.name, obj);
        ...
        */
        ...
        this.divPop_grdList_oncellclick = function(obj,e)
        {
        	...
        	if(e.cell == 6)
        	{
        		...
        		var strRtn = this.gfnSetPopupReturn({pvMhdlgMgno:mhdlgMgno, pvMMhdlgDgr:vldMhdlgDgr, pvMhdlgOrgtNm:mhdlgOrgtNm, pvMhdlgKrnNm:mhdlgKrnNm});
