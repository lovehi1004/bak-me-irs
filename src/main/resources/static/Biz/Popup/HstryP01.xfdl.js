(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"157\"/><Column size=\"158\"/><Column size=\"165\"/><Column size=\"164\"/><Column size=\"229\"/><Column size=\"220\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"번호\"/><Cell col=\"1\" text=\"이력일시\"/><Cell col=\"2\" text=\"구분\"/><Cell col=\"3\" text=\"이력유형\"/><Cell col=\"4\" text=\"이력결과\"/><Cell col=\"5\" text=\"이력사유\"/><Cell col=\"6\" text=\"등록자\"/></Band><Band id=\"body\"><Cell textAlign=\"center\" text=\"bind:hstrySn\" tooltiptext=\"bind:hstrySn\"/><Cell col=\"1\" textAlign=\"center\" text=\"bind:regDt\" tooltiptext=\"bind:regDt\" calendardateformat=\"yyyy-MM-dd\" displaytype=\"date\"/><Cell col=\"2\" textAlign=\"center\" text=\"bind:dgrRegRsnCdNm\" tooltiptext=\"bind:dgrRegRsnCdNm\"/><Cell col=\"3\" textAlign=\"center\" text=\"bind:hstryTypeCdNm\" tooltiptext=\"bind:hstryTypeCdNm\"/><Cell col=\"4\" textAlign=\"center\" border=\"1px solid #dcdee4,1px solid #eeeff3\" text=\"bind:hstryRsltCdNm\" tooltiptext=\"bind:hstryRsltCdNm\"/><Cell col=\"5\" text=\"bind:hstryDtlRsn\" tooltiptext=\"bind:hstryDtlRsn\"/><Cell col=\"6\" text=\"bind:logNm\" tooltiptext=\"bind:logNm\" textAlign=\"center\"/></Band></Format></Formats>");
            this.divPop.addChild(obj.name, obj);
            ...
            obj = new Div("divPaging","340","grdList:20","468","20",null,null,null,null,null,null,this.divPop.form);
            obj.set_taborder("3");
            obj.set_text("");
