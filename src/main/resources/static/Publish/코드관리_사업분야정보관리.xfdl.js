(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta00","35","31","80","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("사업분야");
            obj.set_cssclass("sta_WFSA_Label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cbo02_00","115","31","150","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            divSearch_form_cbo02_00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">에너지산업</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">에너지수요</Col></Row><Row><Col id=\"datacolumn\">제조업</Col><Col id=\"codecolumn\">4</Col></Row><Row><Col id=\"codecolumn\">5</Col><Col id=\"datacolumn\">화학산업</Col></Row><Row><Col id=\"codecolumn\">6</Col><Col id=\"datacolumn\">건설</Col></Row><Row><Col id=\"codecolumn\">7</Col><Col id=\"datacolumn\">수송</Col></Row></Rows>");
            ...
            obj = new Combo("cbo02_00_00","405","31","300","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_cssclass("WFSA");
            var divSearch_form_cbo02_00_00_innerdataset = new nexacro.NormalDataset("divSearch_form_cbo02_00_00_innerdataset", obj);
            divSearch_form_cbo02_00_00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">열에너지 생산</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">신생에너지로부터의 에너지 생산</Col></Row><Row><Col id=\"codecolumn\">4</Col><Col id=\"datacolumn\">기타</Col></Row></Rows>");
            ...
            obj = new Static("sta01_00","295","31","110","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("사업세부분야");
            obj.set_cssclass("sta_WFSA_Label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta00_00","735","30","80","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WFSA_Label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Combo("cbo02_00_01","815","30","100","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_cssclass("WFSA");
            ...
            obj = new Grid("grd00","5","175","47.93%",null,null,"123",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_binddataset("ds_grid");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"70\"/><Column size=\"120\"/><Column size=\"450\"/><Column size=\"90\"/><Column size=\"90\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"분류번호\"/><Cell col=\"2\" text=\"사업분야\"/><Cell col=\"3\" text=\"사업분야명\"/><Cell col=\"4\" text=\"건수\"/><Cell col=\"5\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/><Cell col=\"5\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            ...
            obj.set_binddataset("ds_grid");
            obj.set_autofittype("col");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"90\"/><Column size=\"300\"/><Column size=\"300\"/><Column size=\"90\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"세부번호\"/><Cell col=\"1\" text=\"세부분야\"/><Cell col=\"2\" text=\"세부분야명\"/><Cell col=\"3\" text=\"사용여부\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Div("div00","5","133","47.93%","32",null,null,null,null,null,null,this);
            obj.set_taborder("10");
            obj.set_text("div00");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.registerScript("코드관리_사업분야정보관리.xfdl", function() {
        ...
        this.loadIncludeScript("코드관리_사업분야정보관리.xfdl");
