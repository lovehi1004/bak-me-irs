(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("sta00_00_00_00","155","28",null,"30","1256",null,null,null,null,null,this);
            obj.set_taborder("0");
            ...
            obj = new Grid("grdList","155","sta00_00_00_00:14",null,"151","155",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_autofittype("col");
            obj.set_binddataset("searchList");
            obj.set_cssclass("grd_SR_List");
            obj.set_scrollbartype("none");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"900\"/><Column size=\"100\"/></Columns><Rows><Row size=\"50\"/></Rows><Band id=\"body\"><Cell text=\"bind:제목\"/><Cell col=\"1\" text=\"내용보기\" cssclass=\"Cell_Grd_Btn\" displaytype=\"buttoncontrol\" edittype=\"button\" padding=\"10px\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Button("Button36_00_00","47.18%","grdList:-1","90","25",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("더보기");
            obj.set_cssclass("btn_SR_More");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_00_00_00_00","155","grdList:40","185","30",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("방법론 현황");
            obj.set_cssclass("sta_WF_Title");
            obj.set_fittocontents("width");
            ...
            obj = new Grid("grdList00","155","sta00_00_00_00_00:14",null,"151","155",null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_autofittype("col");
            obj.set_binddataset("searchList");
            obj.set_cssclass("grd_SR_List");
            ...
            obj = new Button("Button36_00_00_00","47.12%","grdList00:-1","90","25",null,null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("더보기");
            obj.set_cssclass("btn_SR_More");
            this.addChild(obj.name, obj);

            obj = new Static("sta00_00_00_00_00_00","155","grdList00:40","185","30",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            ...
            obj = new Grid("grdList00_00","155","sta00_00_00_00_00_00:14",null,"151","155",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_autofittype("col");
            obj.set_binddataset("searchList");
            obj.set_cssclass("grd_SR_List");
            ...
            obj = new Button("Button36_00_00_00_00","47.12%","grdList00_00:-1","90","25",null,null,null,null,null,null,this);
            obj.set_taborder("8");
            obj.set_text("더보기");
            obj.set_cssclass("btn_SR_More");
            this.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("통합검색.xfdl","");
        this.registerScript("통합검색.xfdl", function() {
        /***********************************************************************************
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.grdList00.addEventHandler("oncellclick",this.grdList_oncellclick,this);
            this.sta00_00_00_00_00_00.addEventHandler("onclick",this.sta00_00_00_00_onclick,this);
            this.grdList00_00.addEventHandler("oncellclick",this.grdList_oncellclick,this);
        };
        this.loadIncludeScript("통합검색.xfdl");
