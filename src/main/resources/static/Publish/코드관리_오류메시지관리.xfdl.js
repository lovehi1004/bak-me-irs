(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cbo02_00","85","31","150","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            divSearch_form_cbo02_00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">메시지코드</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">오류메시지명</Col></Row></Rows>");
            ...
            obj = new Combo("cbo02_00_00","548","31","150","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_cssclass("WFSA");
            var divSearch_form_cbo02_00_00_innerdataset = new nexacro.NormalDataset("divSearch_form_cbo02_00_00_innerdataset", obj);
            divSearch_form_cbo02_00_00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">Y</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">N</Col></Row></Rows>");
            ...
            obj = new Static("sta01_00","468","31","80","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("사용여부");
            obj.set_cssclass("sta_WFSA_Label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edt09","238","31","200","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_cssclass("WFSA");
            obj.set_text("");
            this.divSearch.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"40\"/><Column size=\"60\"/><Column size=\"120\"/><Column size=\"450\"/><Column size=\"90\"/><Column size=\"90\"/><Column size=\"120\"/><Column size=\"150\"/><Column size=\"150\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"chk\" displaytype=\"checkboxcontrol\" edittype=\"checkbox\"/><Cell col=\"1\" text=\"번호\"/><Cell col=\"2\" text=\"메시지코드\"/><Cell col=\"3\" text=\"오류메시지명\"/><Cell col=\"4\" text=\"입력건수\"/><Cell col=\"5\" text=\"사용여부\"/><Cell col=\"6\" text=\"등록자\"/><Cell col=\"7\" text=\"등록일자\"/><Cell col=\"8\" text=\"수정일시\"/></Band><Band id=\"body\"><Cell/><Cell col=\"1\"/><Cell col=\"2\"/><Cell col=\"3\"/><Cell col=\"4\"/><Cell col=\"5\"/><Cell col=\"6\"/><Cell col=\"7\"/><Cell col=\"8\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static01","5",null,"140","32",null,"grd00:10",null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("총 <fc v=\'#f96262\'>41</fc>건");
            obj.set_usedecorate("true");
            obj.set_cssclass("sta_WF_Total");
            this.addChild(obj.name, obj);

            obj = new Button("btnExcelUp",null,null,"120","32","30","grd00:10",null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("엑셀다운로드");
            obj.set_cssclass("btn_WF_Excel");
            this.addChild(obj.name, obj);

            obj = new Button("btnExcelDown",null,"133","75","32","btnExcelUp:3",null,null,null,null,null,this);
            obj.set_taborder("5");
            obj.set_text("수정");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);

            obj = new Div("Div01","551","grd00:25","468","20",null,null,null,null,null,null,this);
            obj.set_taborder("6");
            obj.set_text("");
            ...
            obj = new Button("btnExcelDown00",null,"133","75","32","btnExcelDown:3",null,null,null,null,null,this);
            obj.set_taborder("7");
            obj.set_text("등록");
            obj.set_cssclass("btn_WF_Crud");
            this.addChild(obj.name, obj);
        ...
        this.on_initEvent = function()
        {
            ...
            this.btnExcelDown00.addEventHandler("onclick",this.divCmmnBtn_btnExcelDown_onclick,this);
        };
        this.loadIncludeScript("코드관리_오류메시지관리.xfdl");
