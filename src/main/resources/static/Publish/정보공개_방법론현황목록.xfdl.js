(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"번호\" type=\"STRING\" size=\"256\"/><Column id=\"구분\" type=\"STRING\" size=\"256\"/><Column id=\"체결국가\" type=\"STRING\" size=\"256\"/><Column id=\"협정명원문\" type=\"STRING\" size=\"256\"/><Column id=\"협정명국문\" type=\"STRING\" size=\"256\"/><Column id=\"조약번호\" type=\"STRING\" size=\"256\"/><Column id=\"서명일자\" type=\"STRING\" size=\"256\"/><Column id=\"조회\" type=\"STRING\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"번호\">4</Col><Col id=\"구분\">협정</Col><Col id=\"체결국가\">베트남</Col><Col id=\"협정명원문\">Basic Agreement on Korea-Vietnam Climate Change Cooperation</Col><Col id=\"협정명국문\">한-베트남 기후변화 협력 기본협정</Col><Col id=\"조약번호\">제2493호</Col><Col id=\"서명일자\">2021-05-31</Col><Col id=\"조회\">조회</Col></Row><Row><Col id=\"번호\">3</Col><Col id=\"구분\">협정</Col><Col id=\"체결국가\">몽골</Col><Col id=\"협정명원문\">Korea-Mongolia Climate Cooperation Agreement</Col><Col id=\"협정명국문\">한-몽골 기후협력협정</Col><Col id=\"조약번호\">제2551호</Col><Col id=\"서명일자\">2023-02-15</Col><Col id=\"조회\">조회</Col></Row><Row><Col id=\"번호\">2</Col><Col id=\"구분\">협정</Col><Col id=\"체결국가\">가봉</Col><Col id=\"협정명원문\">Korea-Gabong Climate Cooperation Agreement</Col><Col id=\"협정명국문\">한-가봉 기후협력협정</Col><Col id=\"조약번호\">제2552호</Col><Col id=\"서명일자\">2023-05-06</Col><Col id=\"조회\">조회</Col></Row><Row><Col id=\"번호\">1</Col><Col id=\"구분\">협정</Col><Col id=\"체결국가\">우즈베키스탄</Col><Col id=\"협정명원문\">Korea-Uzbekistan Climate Cooperation Agreement</Col><Col id=\"협정명국문\">한-우즈베키스탄 기후협력협정</Col><Col id=\"조약번호\">제2556호</Col><Col id=\"서명일자\">2023-06-01</Col><Col id=\"조회\">조회</Col></Row><Row/><Row/><Row/><Row/></Rows>");
            ...
            obj = new Grid("grdList","155","192",null,"543","155",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_autofittype("col");
            obj.set_binddataset("dsList");
            obj.set_cssclass("grd_Bd_List");
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"60\"/><Column size=\"100\"/><Column size=\"100\"/><Column size=\"400\"/><Column size=\"80\"/><Column size=\"220\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"80\"/><Column size=\"60\"/></Columns><Rows><Row size=\"30\" band=\"head\"/><Row size=\"30\" band=\"head\"/><Row size=\"30\"/><Row size=\"30\"/></Rows><Band id=\"head\"><Cell rowspan=\"2\" text=\"번호\"/><Cell col=\"1\" rowspan=\"2\" text=\"신청구분\"/><Cell col=\"2\" rowspan=\"2\" text=\"파리협정&#13;&#10;조항\"/><Cell col=\"3\" text=\"방법론명(원문)\" cssclass=\"bdColor\"/><Cell col=\"4\" rowspan=\"2\" text=\"신규/개정\"/><Cell col=\"5\" rowspan=\"2\" text=\"방법론분야\"/><Cell col=\"6\" rowspan=\"2\" text=\"방법론고유번호\"/><Cell col=\"7\" rowspan=\"2\" text=\"방법론&#13;&#10;유효시작일자\"/><Cell col=\"8\" rowspan=\"2\" text=\"설정파일\"/><Cell col=\"9\" rowspan=\"2\" text=\"조회\" cssclass=\"bdNone\"/><Cell row=\"1\" col=\"3\" text=\"방법론명(국문)\"/></Band><Band id=\"body\"><Cell rowspan=\"2\" text=\"4\" textAlign=\"center\"/><Cell col=\"1\" rowspan=\"2\" text=\"사전승인&#13;&#10;신청\" textAlign=\"center\"/><Cell col=\"2\" rowspan=\"2\" text=\"제 6.2조\" textAlign=\"center\"/><Cell col=\"3\" text=\"Methodology for Vegetation Restoration Project\" cssclass=\"bdColor\"/><Cell col=\"4\" rowspan=\"2\" text=\"신규\" textAlign=\"center\"/><Cell col=\"5\" rowspan=\"2\" text=\"산림 – 탄소흡수원 유치 및 증진\" textAlign=\"center\"/><Cell col=\"6\" rowspan=\"2\" textAlign=\"center\" text=\"06A-002-Ver01\"/><Cell col=\"7\" rowspan=\"2\" text=\"2023-12-02\" textAlign=\"center\"/><Cell col=\"8\" rowspan=\"2\" text=\"다운로드\" textAlign=\"center\" cssclass=\"Cell_Grd_Btn\" displaytype=\"buttoncontrol\" edittype=\"button\" padding=\"15px 10px\"/><Cell col=\"9\" rowspan=\"2\" text=\"조회\" textAlign=\"center\" cssclass=\"Cell_Grd_Btn, bdNone\" edittype=\"button\" displaytype=\"buttoncontrol\" padding=\"15px 10px\"/><Cell row=\"1\" col=\"3\" text=\"식생복구 사업의 방법론\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Div("div00","154","28","475","35",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("div00");
            this.addChild(obj.name, obj);

            obj = new Button("btnAprTab01","0","0","100","35",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("0");
            obj.set_text("협정·약정 현황");
            obj.set_cssclass("btn_Board_TabMenu");
            this.div00.addChild(obj.name, obj);

            obj = new Button("btnAprTab02","140","0","77","35",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("1");
            obj.set_text("방법론 현황");
            obj.set_cssclass("btn_Board_TabMenu_on");
            this.div00.addChild(obj.name, obj);

            obj = new Button("btnAprTab03","257","0","123","35",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("2");
            obj.set_text("국제감축사업 현황");
            obj.set_cssclass("btn_Board_TabMenu");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static20_00","120","11","1","16",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("3");
            obj.set_cssclass("sta_TitleLine");
            this.div00.addChild(obj.name, obj);

            obj = new Static("Static20_00_00","238","11","1","16",null,null,null,null,null,null,this.div00.form);
            obj.set_taborder("4");
            obj.set_cssclass("sta_TitleLine");
            this.div00.addChild(obj.name, obj);

            obj = new Div("divSearch","150","78",null,"94","150",null,null,null,null,null,this);
            obj.set_taborder("3");
            ...
            obj = new Static("sta00","35","31","110","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("6");
            obj.set_text("파리협정조항");
            ...
            obj = new Combo("cbo02_00","145","31","130","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("7");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            ...
            divSearch_form_cbo02_00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">협정</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">약정</Col></Row><Row><Col id=\"codecolumn\">4</Col><Col id=\"datacolumn\">MOU</Col></Row></Rows>");
            ...
            obj = new Combo("cbo02_00_00","385","31","150","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("8");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            obj.set_cssclass("WFSA");
            var divSearch_form_cbo02_00_00_innerdataset = new nexacro.NormalDataset("divSearch_form_cbo02_00_00_innerdataset", obj);
            divSearch_form_cbo02_00_00_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">1</Col><Col id=\"datacolumn\">전체</Col></Row><Row><Col id=\"codecolumn\">2</Col><Col id=\"datacolumn\">발효</Col></Row><Row><Col id=\"codecolumn\">3</Col><Col id=\"datacolumn\">미발효</Col></Row><Row><Col id=\"codecolumn\">4</Col><Col id=\"datacolumn\">체결중</Col></Row></Rows>");
            ...
            obj = new Static("sta01_00","305","31","80","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("9");
            obj.set_text("등록유형");
            obj.set_cssclass("sta_WFSA_Label");
            this.divSearch.addChild(obj.name, obj);

            obj = new Edit("edt09","645","31","300","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("10");
            obj.set_cssclass("WFSA");
            obj.set_text("");
            this.divSearch.addChild(obj.name, obj);

            obj = new Static("sta01_00_00","565","30","80","32",null,null,null,null,null,null,this.divSearch.form);
            obj.set_taborder("11");
            obj.set_text("체결국가");
            obj.set_cssclass("sta_WFSA_Label");
            this.divSearch.addChild(obj.name, obj);
        ...
        // User Script
        this.addIncludeScript("정보공개_방법론현황목록.xfdl","");
        this.registerScript("정보공개_방법론현황목록.xfdl", function() {
        /***********************************************************************************
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.div00.form.btnAprTab01.addEventHandler("onclick",this.divTop_btnNoticeBoard_onclick,this);
            this.div00.form.btnAprTab02.addEventHandler("onclick",this.divTop_btnNoticeBoard_onclick,this);
            this.div00.form.btnAprTab03.addEventHandler("onclick",this.divTop_btnNoticeBoard_onclick,this);
        };
        this.loadIncludeScript("정보공개_방법론현황목록.xfdl");
