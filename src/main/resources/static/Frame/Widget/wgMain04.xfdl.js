(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnNoticeMore",null,"5","96","34","0",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("더보기");
            obj.set_cssclass("btn_LOGIN_NoticeMore");
            obj.set_accessibilitylabel("공지사항더보기");
            this.addChild(obj.name, obj);

            obj = new Grid("grdNoticeList","-4","55",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"474\"/></Columns><Rows><Row size=\"37\"/></Rows><Band id=\"body\"><Cell text=\"expr:dataset.parent.gfnGetRealColSizeText(comp, pstatNm, currow, 0)\" tooltiptext=\"bind:pstatNm\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
