(function()
{
    return function()
    {
        ...
        {
            this.set_name("wgMain04");
            this.set_titletext("메인 화면 위젯 > 공지사항");
            ...
            obj = new Button("btnNoticeMore",null,"7","96","34","9",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("더보기");
            obj.set_cssclass("btn_LOGIN_NoticeMore");
            this.addChild(obj.name, obj);

            obj = new Grid("grdNoticeList","0","48",null,null,"0","0",null,null,null,null,this);
            obj.set_taborder("2");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"474\"/></Columns><Rows><Row size=\"34\"/></Rows><Band id=\"body\"><Cell text=\"expr:dataset.parent.gfnGetRealColSizeText(comp, pstatNm, currow, 0)\" tooltiptext=\"bind:pstatNm\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);
            // Layout Functions
            //-- Default Layout : this
        ...
        // User Script
        this.registerScript("wgMain04.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Frame_Widget
        * BUSINESS      : wgMain04 Form
        * FILE NAME     : wgMain04.xfdl
        * DESCRIPTION   : 메인 화면 위젯 > 공지사항
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        {
        	trace("[wgMain04]Form onload 후 필요(설정)시 실행되는 callback 함수 ");
        ;
        ...
        */
        this.fnSearch = function()
        {
        	// 공통Transaction 호출
         	...
         	objArgs.url 			= "/common/board/selectBoardListMainNotice.irs";
        ...
        ***********************************************************************************/
        ...
        this.grdNoticeList_oncellclick = function(obj,e)
        {
        	...
        	var objArgs		= {bbsGroupMgno:'BS00000010',bbsSn:bbsSn};
        ...
        this.loadIncludeScript("wgMain04.xfdl");
