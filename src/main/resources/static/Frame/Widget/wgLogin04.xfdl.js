(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            {
                this._setFormPosition(1020,116);
            }
            ...
            obj = new Button("btnNoticeMore","921","4","96","34",null,null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_text("더보기");
            obj.set_cssclass("btn_LOGIN_NoticeMore");
            this.addChild(obj.name, obj);

            obj = new Grid("grdNoticeList","0",null,null,"68","0","0",null,null,null,null,this);
            obj.set_taborder("1");
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"800\"/><Column size=\"100\"/></Columns><Rows><Row size=\"34\"/></Rows><Band id=\"body\"><Cell text=\"bind:pstatNm\" tooltiptext=\"bind:pstatNm\"/><Cell col=\"1\" text=\"bind:regDt\" cssclass=\"Cell_NoticeDate\"/></Band></Format></Formats>");
            this.addChild(obj.name, obj);

            obj = new Static("Static00","0","0","120","48",null,null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_text("공지사항");
            ...
            // Layout Functions
            //-- Default Layout : this
            obj = new Layout("default","",1020,116,this,function(p){});
