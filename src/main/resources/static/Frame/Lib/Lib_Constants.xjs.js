...
(function()
{
    return function(path)
    {
        ...
        this.Frame = {
        			 ...
        			 , sSeparateLFold		: "77,*"			// LeftFrame 접힘 일때 Separate Size
        ...
        this.Tran = {
        			...
        			, webUrl				: "http://127.0.0.1:28080/irs"
        			, webUrlInfo			: { LOCAL 	: "http://127.0.0.1:28080/irs" //"http://127.0.0.1:8081"
        									  , DEV 	: "http://192.168.0.140:28080/irs" //"http://127.0.0.1:8081"
        									  , REAL 	: "" //"http://127.0.0.1:8081"
        									}
        			, fwUrl					: "http://127.0.0.1:28080/irs"
        			, fwUrlInfo 			: { LOCAL 	: "http://127.0.0.1:28080/irs" 		//"http://127.0.0.1:8081"
        									  , DEV 	: "http://192.168.0.140:28080/irs" // http://dev.gov.irs" //"http://127.0.0.1:8081"
        									  , REAL 	: "" //"http://127.0.0.1:8081"
        									}
        			, fileDownInfo 			: []
        			};
        ...
        this.File = {
        			   fileSingleUpLoadUrl		: "http://127.0.0.1:28080/irs/common/file/single/upload.irs"
        			 , fileSingleUpLoadUrlInfo	: { LOCAL 	: "http://127.0.0.1:28080/irs/common/file/single/upload.irs"
        									       , DEV 	: "http://192.168.0.140:28080/irs/common/file/single/upload.irs"
        									       , REAL 	: "/common/file/single/upload.irs"
        									       }
        			 , fileMultiUpLoadUrl		: "http://127.0.0.1:28080/irs/common/file/multi/upload.irs"
        			 , fileMultiUpLoadUrlInfo	: { LOCAL 	: "http://127.0.0.1:28080/irs/common/file/multi/upload.irs"
        									       , DEV 	: "http://192.168.0.140:28080/irs/common/file/multi/upload.irs"
        									       , REAL 	: "/common/file/multi/upload.irs"
        									       }
        			 , fileSingleDownLoadUrl	: "http://127.0.0.1:28080/irs/common/file/single/download.irs"
        			 , fileSingleDownLoadUrlInfo: { LOCAL 	: "http://127.0.0.1:28080/irs/common/file/single/download.irs"
        										   , DEV 	: "http://192.168.0.140:28080/irs/common/file/single/download.irs"
        										   , REAL 	: "/common/file/single/download.irs"
        										  }
        			 , fileMultiDownLoadUrl		: "http://127.0.0.1:28080/irs/common/file/multi/download.irs"
        			 , fileMultiDownLoadUrlInfo : { LOCAL 	: "http://127.0.0.1:28080/irs/common/file/multi/download.irs"
        										   , DEV 	: "http://192.168.0.140:28080/irs/common/file/multi/download.irs"
        										   , REAL 	: "/common/file/multi/download.irs"
        										 }
        			 , fileDownLoadRootPath : "%MYDOCUMENT%IRS"
        			};

        this.ExcelInfo = {
        				   excelImportUrl		: "http://127.0.0.1:28080/nexacro-xeni-java/XExportImport"
        				 , excelImportUrlInfo	: { LOCAL 	: "http://127.0.0.1:28080/nexacro-xeni-java/XExportImport"
        										  , DEV 	: "http://192.168.0.140:28080/nexacro-xeni-java/XExportImport"
        										  , REAL 	: "/nexacro-xeni-java/XExportImport"
        										  }
        				 , excelExportUrl		: "http://127.0.0.1:28080/nexacro-xeni-java/XExportImport"
        				 , excelExportUrlInfo	: { LOCAL 	: "http://127.0.0.1:28080/nexacro-xeni-java/XExportImport"
        										  , DEV 	: "http://192.168.0.140:28080/nexacro-xeni-java/XExportImport"
        										  , REAL 	: "/nexacro-xeni-java/XExportImport"
        										  }
        				 };
        ...
        this.ReportInfo = {
        				   reportUrl			: "http://127.0.0.1:28080/irs/common/report.irs"
        				 , reportUrlInfo		: { LOCAL 	: "http://127.0.0.1:28080/irs/common/report.irs"
        										  , DEV 	: "http://192.168.0.140:28080/irs/common/report.irs"
        										  , REAL 	: "/common/report.irs"
        										  }
        				 };

        this.ViewerInfo = {
        				   viewerUrl			: "http://127.0.0.1:28080/irs/thirdParty/viewer/skin"
        				 , viewerUrlInfo		: { LOCAL 	: "http://127.0.0.1:28080/irs/thirdParty/viewer/skin"
        										  , DEV 	: "http://192.168.0.140:28080/irs/thirdParty/viewer/skin"
        										  , REAL 	: "/irs/thirdParty/viewer/skin"
        										  }
        				 };

        this.RaonKInfo = {
        				   handlerUrl			: "http://127.0.0.1:28080/irs/common/raonk/check.irs"
        				 , handlerUrlInfo		: { LOCAL 	: "http://127.0.0.1:28080/irs/common/raonk/check.irs"
        										  , DEV 	: "http://192.168.0.140:28080/irs/common/raonk/check.irs"
        										  , REAL 	: "/irs/common/raonk/check.irs"
        										  }
        				 , fileFullDownLoadUrl		: "http://127.0.0.1:28080/irs/common/raonk/download.irs"
        				 , fileFullDownLoadUrlInfo : { LOCAL 	: "http://127.0.0.1:28080/irs/common/raonk/download.irs"
        											  , DEV 	: "http://192.168.0.140:28080/irs/common/raonk/download.irs"
        											  , REAL 	: "/irs/common/raonk/download.irs"
        											  }
        				 , checkFileDownLoadUrl		: "http://127.0.0.1:28080/irs/common/raonk/selected/download.irs"
        				 , checkFileDownLoadUrlInfo : { LOCAL 	: "http://127.0.0.1:28080/irs/common/raonk/selected/download.irs"
        											  , DEV 	: "http://192.168.0.140:28080/irs/common/raonk/selected/download.irs"
