(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divMain","50","65",null,null,"50","25","1400",null,"600",null,this);
            obj.set_taborder("1");
            obj.set_text("");
            obj.set_formscrollbartype("none none");
            this.addChild(obj.name, obj);

            obj = new Div("divWgMain01","10","30","30.80%","330",null,null,null,null,null,null,this.divMain.form);
            obj.set_taborder("2");
            obj.set_cssclass("div_MF_Box bdColor01");
            obj.set_text("협정");
            obj.set_url("Frame_Widget::wgMain01.xfdl");
            this.divMain.addChild(obj.name, obj);

            obj = new Div("divWgMain02","divWgMain01:47.99200000000002","30","30.80%","330",null,null,null,null,null,null,this.divMain.form);
            obj.set_taborder("1");
            obj.set_cssclass("div_MF_Box bdColor02");
            obj.set_text("방법론");
            obj.set_url("Frame_Widget::wgMain02.xfdl");
            this.divMain.addChild(obj.name, obj);

            obj = new Div("divWgMain04","14","405","30.20%",null,null,"10",null,null,null,null,this.divMain.form);
            obj.set_taborder("3");
            obj.set_text("공지사항");
            obj.set_url("Frame_Widget::wgMain04.xfdl");
            this.divMain.addChild(obj.name, obj);

            obj = new Div("divWgMain05","divWgMain04:62","405","30.20%",null,null,"10",null,null,null,null,this.divMain.form);
            obj.set_taborder("4");
            obj.set_text("자료실");
            obj.set_url("Frame_Widget::wgMain05.xfdl");
            this.divMain.addChild(obj.name, obj);

            obj = new Div("divWgMain06","divWgMain05:58","405",null,null,"15","10",null,null,null,null,this.divMain.form);
            obj.set_taborder("5");
            obj.set_text("법령과지침");
            obj.set_url("Frame_Widget::wgMain06.xfdl");
            this.divMain.addChild(obj.name, obj);

            obj = new Div("divWgMain03","divWgMain02:48.983999999999924","30",null,"330","18",null,null,null,null,null,this.divMain.form);
            obj.set_taborder("0");
            obj.set_cssclass("div_MF_Box bdColor03");
            obj.set_text("사업");
            obj.set_url("Frame_Widget::wgMain03.xfdl");
            this.divMain.addChild(obj.name, obj);

            obj = new Static("stcDesc01","63","39","300","35",null,null,null,null,null,null,this);
            obj.set_taborder("0");
        ...
        ***********************************************************************************/
        ...
        /**
         메인화면 타이틀 문구 권한 수정
        */
        this.fnChangeTitle = function()
        {
        	var roleIdMgno = this.fvApp.User.roleIdMgno;
        	var uesrText = '사업수행자';
        	if(roleIdMgno == 'RL00000001')
        	{
        		uesrText = '전체관리자';
        	}else if(roleIdMgno == 'RL00000002')
        	{
        		uesrText = '관장기관';
        	}else if(roleIdMgno == 'RL00000003')
        	{
        		uesrText = '위탁기관';
        	}else if(roleIdMgno == 'RL00000004' || roleIdMgno == 'RL00000005' )
        	{
        		uesrText = '사업수행자';
        	}else if(roleIdMgno == 'RL00000006')
        	{
        		uesrText = '외교부'
        	}else if(roleIdMgno == 'RL00000007')
        	{
        		uesrText = '기타부처'
        	}else if(roleIdMgno == 'RL00000008')
        	{
        		uesrText = '비승인사용자'
        	}else if(roleIdMgno == 'RL00000009')
        	{
        		uesrText = '관장기관 사업수행자'
        	}else if (roleIdMgno == 'RL00000010')
        	{
        		uesrText = '위탁기관 사업수행자'
        	}else if (roleIdMgno == 'RL00000011')
        	{
        		uesrText = '비승인위탁기관'
        	}
        	var titleText = '<b v="true">업무현황</b>('+uesrText+')';
        	this.stcDesc01.set_text(titleText);
        	this.resetScroll();
        }
        });
