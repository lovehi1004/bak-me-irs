(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnOpenList",null,"7","31","31","33",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_tooltiptext("오픈된 화면 목록");
            obj.set_cssclass("btn_MDI_List");
            this.addChild(obj.name, obj);

            obj = new Button("btnNext",null,"7","21","31","101",null,null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_tooltiptext("다음 화면목록으로");
            obj.set_cssclass("btn_MDI_Right");
            this.addChild(obj.name, obj);

            obj = new Button("btnPrev",null,"7","21","31","129",null,null,null,null,null,this);
            obj.set_taborder("2");
            obj.set_tooltiptext("이전 화면목록으로");
            obj.set_cssclass("btn_MDI_Left");
            this.addChild(obj.name, obj);

            obj = new Button("btnAllClose",null,"7","19","31","70",null,null,null,null,null,this);
            obj.set_taborder("3");
