(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnMenu02","0","156","80","84",null,null,null,null,null,null,this.divFrameLeftShow.form);
            obj.set_taborder("1");
            obj.set_text("협의체 관리");
            obj.set_cssclass("btn_LF_Menu02");
            this.divFrameLeftShow.addChild(obj.name, obj);

            obj = new Button("btnMenu03","0","240","80","84",null,null,null,null,null,null,this.divFrameLeftShow.form);
            obj.set_taborder("2");
            obj.set_text("방법론 관리");
            obj.set_cssclass("btn_LF_Menu03");
            this.divFrameLeftShow.addChild(obj.name, obj);

            obj = new Button("btnMenu04","0","324","80","84",null,null,null,null,null,null,this.divFrameLeftShow.form);
            obj.set_taborder("3");
            obj.set_text("사업 관리");
            obj.set_cssclass("btn_LF_Menu04");
            this.divFrameLeftShow.addChild(obj.name, obj);

            obj = new Button("btnMenu05","0","408","80","84",null,null,null,null,null,null,this.divFrameLeftShow.form);
            obj.set_taborder("4");
            obj.set_text("실적 관리");
            obj.set_cssclass("btn_LF_Menu05");
            this.divFrameLeftShow.addChild(obj.name, obj);

            obj = new Button("btnMenu06","0","492","80","84",null,null,null,null,null,null,this.divFrameLeftShow.form);
            obj.set_taborder("5");
            obj.set_text("사업수행자\r\n관리");
            obj.set_cssclass("btn_LF_Menu06");
            this.divFrameLeftShow.addChild(obj.name, obj);

            obj = new Button("btnMenu07","0","576","80","84",null,null,null,null,null,null,this.divFrameLeftShow.form);
            obj.set_taborder("6");
            obj.set_text("통계");
            obj.set_cssclass("btn_LF_Menu07");
            this.divFrameLeftShow.addChild(obj.name, obj);

            obj = new Button("btnMenu08","0","660","80","84",null,null,null,null,null,null,this.divFrameLeftShow.form);
            obj.set_taborder("7");
            obj.set_text("정보공개");
            ...
            obj = new Button("btnMenu09","0","749","80","84",null,null,null,null,null,null,this.divFrameLeftShow.form);
            obj.set_taborder("11");
            obj.set_text("비메뉴공통");
            obj.set_cssclass("btn_LF_Menu01");
            obj.set_visible("false");
            ...
            obj = new Div("divFrameLeftFold","875","0","77",null,null,"5",null,null,null,null,this);
            obj.set_taborder("1");
            obj.set_text("Div00");
            obj.set_formscrollbartype("none none");
            ...
            obj = new Button("btnMenu01","6","72","72","84",null,null,null,null,null,null,this.divFrameLeftFold.form);
            obj.set_taborder("0");
            obj.set_cssclass("btn_LF_Menu01");
            obj.set_textPadding("0px 0px 0px 0px");
            this.divFrameLeftFold.addChild(obj.name, obj);

            obj = new Button("btnMenu02","6","156","72","84",null,null,null,null,null,null,this.divFrameLeftFold.form);
            obj.set_taborder("1");
            obj.set_cssclass("btn_LF_Menu02");
            obj.set_textPadding("0px 0px 0px 0px");
            this.divFrameLeftFold.addChild(obj.name, obj);

            obj = new Button("btnMenu03","6","240","72","84",null,null,null,null,null,null,this.divFrameLeftFold.form);
            obj.set_taborder("2");
            obj.set_cssclass("btn_LF_Menu03");
            obj.set_textPadding("0px 0px 0px 0px");
            this.divFrameLeftFold.addChild(obj.name, obj);

            obj = new Button("btnMenu04","6","324","72","84",null,null,null,null,null,null,this.divFrameLeftFold.form);
            obj.set_taborder("3");
            obj.set_cssclass("btn_LF_Menu04");
            obj.set_textPadding("0px 0px 0px 0px");
            this.divFrameLeftFold.addChild(obj.name, obj);

            obj = new Button("btnMenu05","6","408","72","84",null,null,null,null,null,null,this.divFrameLeftFold.form);
            obj.set_taborder("4");
            obj.set_cssclass("btn_LF_Menu05");
            obj.set_textPadding("0px 0px 0px 0px");
            this.divFrameLeftFold.addChild(obj.name, obj);

            obj = new Button("btnMenu06","6","492","72","84",null,null,null,null,null,null,this.divFrameLeftFold.form);
            obj.set_taborder("5");
            obj.set_cssclass("btn_LF_Menu06");
            obj.set_textPadding("0px 0px 0px 0px");
            this.divFrameLeftFold.addChild(obj.name, obj);

            obj = new Button("btnMenu07","6","576","72","84",null,null,null,null,null,null,this.divFrameLeftFold.form);
            obj.set_taborder("6");
            obj.set_cssclass("btn_LF_Menu07");
            obj.set_textPadding("0px 0px 0px 0px");
            this.divFrameLeftFold.addChild(obj.name, obj);

            obj = new Button("btnMenu08","6","660","72","84",null,null,null,null,null,null,this.divFrameLeftFold.form);
            obj.set_taborder("7");
            obj.set_cssclass("btn_LF_Menu08");
            obj.set_textPadding("0px 0px 0px 0px");
            this.divFrameLeftFold.addChild(obj.name, obj);
            ...
            obj = new Static("stcLogo","13","22","56","25",null,null,null,null,null,null,this.divFrameLeftFold.form);
            obj.set_taborder("9");
            obj.set_cssclass("sta_LF_Logo");
            this.divFrameLeftFold.addChild(obj.name, obj);

            obj = new Button("btnMenu09","6","749","70","84",null,null,null,null,null,null,this.divFrameLeftFold.form);
            obj.set_taborder("11");
            obj.set_cssclass("btn_LF_Menu01");
            obj.set_visible("false");
            this.divFrameLeftFold.addChild(obj.name, obj);
        ...
        */
        ...
        {
        	// var sFilterStr = this.fvApp.objMenu.sMenuLevelCol+"> 1 && useYn == 'Y' && "+this.fvApp.objMenu.sPopupYn+" != 'Y'";
        	...
        	// trace("this.fvApp.gdsMenu.getRowCount():"+this.fvApp.gdsMenu.getRowCount());
        	...
        	// this.dsMenuList.addColumn("menuPathSearch", "STRING", 255);
        	// var nRowCnt2 = this.dsMenuTmp.assign(this.fvApp.gdsMenu);
        ...
        */
        // this.divFrameLeftShow_grdMenu_ontreestatuschanged = function(obj:nexacro.Grid,e:nexacro.GridTreeStatusEventInfo)
        this.divFrameLeftShow_divMenu_grdMenu_ontreestatuschanged = function(obj,e)
        {
        // trace("[divFrameLeftShow_grdMenu_ontreestatuschanged]e.reason:"+e.reason);
        ...
        */
        ...
        {
        	// trace("[divFrameLeftFold_btnMenu_onclick]obj:"+obj.id);
        	...
        	// trace("nMenuNo:"+nMenuNo+"|sMenuId:"+sMenuId);
        	// var sFilterStr = this.fvApp.objMenu.sTopMnuId + "== '" + sMenuId + "' && useYn == 'Y' && "+this.fvApp.objMenu.sPopupYn+" != 'Y'";
        	...
        	// trace("this.dsLeftMenuAll.getRowCount():"+this.dsLeftMenuAll.getRowCount());
        ...
        */
        ...
        {
        	// trace("[divFrameLeftShow_btnMenu_onclick]obj:"+obj.id);
        ...
        this.divFrameLeftFold_btnMenu_onmouseenter = function(obj,e)
        {
        	...
        	if(this.pdvTooltip.isPopup())
        	{
        		if(e.fromobject != obj)
        		{
        			...
        			// ( objComp, nXpos, nYpos [,nWidth ,nHeight [,strCallBackFunc [,bCapture]]] )
