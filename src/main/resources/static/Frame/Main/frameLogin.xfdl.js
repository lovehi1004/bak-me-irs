(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Div("divLogin",null,"0","400","444","0",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("3");
            obj.set_cssclass("div_LOGIN_Box");
            obj.set_text("");
            this.divContents.addChild(obj.name, obj);

            obj = new Edit("edtId","45","46",null,"60","45",null,null,null,null,null,this.divContents.form.divLogin.form);
            obj.set_taborder("0");
            ...
            obj = new Edit("edtPw","45","106",null,"60","45",null,null,null,null,null,this.divContents.form.divLogin.form);
            obj.set_taborder("1");
            ...
            obj = new Button("btnLogin","45","196",null,"45","45",null,null,null,null,null,this.divContents.form.divLogin.form);
            obj.set_taborder("2");
            obj.set_text("로그인");
            obj.set_cssclass("btn_LOGIN_Submit");
            this.divContents.form.divLogin.addChild(obj.name, obj);

            obj = new CheckBox("chkId","55","259","150","32",null,null,null,null,null,null,this.divContents.form.divLogin.form);
            obj.set_taborder("4");
            obj.set_text("아이디저장");
            obj.set_cssclass("chk_LOGIN_IdSave");
            this.divContents.form.divLogin.addChild(obj.name, obj);

            obj = new Button("btnRegisterUser","45",null,"37.5%","45",null,"45",null,null,null,null,this.divContents.form.divLogin.form);
            obj.set_taborder("5");
            obj.set_text("사용자등록");
            obj.set_cssclass("btn_LOGIN_UserAdd");
            this.divContents.form.divLogin.addChild(obj.name, obj);

            obj = new Button("btnFindUser","btnRegisterUser:10","354",null,"45","45",null,null,null,null,null,this.divContents.form.divLogin.form);
            obj.set_taborder("6");
            ...
            obj = new Div("Div01_00",null,"474","400","149","0",null,null,null,null,null,this.divContents.form);
            obj.set_taborder("4");
            obj.set_cssclass("div_MF_Box");
            this.divContents.addChild(obj.name, obj);

            obj = new Static("Static00","29","45","63","59",null,null,null,null,null,null,this.divContents.form.Div01_00.form);
            obj.set_taborder("0");
            obj.set_cssclass("sta_LOGIN_Help");
            this.divContents.form.Div01_00.addChild(obj.name, obj);

            obj = new Static("Static01","125","18","60","30",null,null,null,null,null,null,this.divContents.form.Div01_00.form);
            obj.set_taborder("1");
            obj.set_text("문의");
            obj.set_cssclass("sta_LOGIN_HelpText");
            this.divContents.form.Div01_00.addChild(obj.name, obj);

            obj = new Static("Static01_00","125","47","220","55",null,null,null,null,null,null,this.divContents.form.Div01_00.form);
            obj.set_taborder("2");
            obj.set_text("1577-8095");
            obj.set_cssclass("sta_LOGIN_HelpCall");
            this.divContents.form.Div01_00.addChild(obj.name, obj);

            obj = new Static("Static02","125","105","265","24",null,null,null,null,null,null,this.divContents.form.Div01_00.form);
            obj.set_taborder("3");
            obj.set_text("평일 09:30~18:00  토·일요일, 공휴일은 휴무");
            obj.set_cssclass("sta_LOGIN_HelpTextS");
            this.divContents.form.Div01_00.addChild(obj.name, obj);

            obj = new Div("divWgLogin04","0","310","1020","116",null,null,null,null,null,null,this.divContents.form);
            obj.set_taborder("5");
            obj.set_text("공지사항");
            obj.set_url("Frame_Widget::wgLogin04.xfdl");
            this.divContents.addChild(obj.name, obj);

            obj = new Div("Div03","0",null,"320","141",null,"0",null,null,null,null,this.divContents.form);
            obj.set_taborder("6");
            this.divContents.addChild(obj.name, obj);

            obj = new Button("Button00","108",null,"104","30",null,"0",null,null,null,null,this.divContents.form.Div03.form);
            obj.set_taborder("0");
            obj.set_text("더보기");
            obj.set_cssclass("btn_LOGIN_More");
            this.divContents.form.Div03.addChild(obj.name, obj);

            obj = new Static("Static00","110","7","140","50",null,null,null,null,null,null,this.divContents.form.Div03.form);
            obj.set_taborder("1");
            obj.set_text("법령과 지침");
            obj.set_cssclass("sta_LOGIN_Title");
            this.divContents.form.Div03.addChild(obj.name, obj);

            obj = new Static("Static00_00","110","47",null,"50","12",null,null,null,null,null,this.divContents.form.Div03.form);
            obj.set_taborder("2");
            obj.set_text("국제감축사업 및 실적에 관한\r\n법령과 지침을 확인해보세요.");
            obj.set_cssclass("sta_LOGIN_Text");
            this.divContents.form.Div03.addChild(obj.name, obj);

            obj = new ImageViewer("ImageViewer00","0","16","80","80",null,null,null,null,null,null,this.divContents.form.Div03.form);
            obj.set_taborder("3");
            obj.set_image("url(\'theme://images/main/ico_LOGIN_Guide.png\')");
            obj.set_stretch("none");
            this.divContents.form.Div03.addChild(obj.name, obj);

            obj = new Div("Div03_00","350",null,"320","141",null,"0",null,null,null,null,this.divContents.form);
            obj.set_taborder("7");
            this.divContents.addChild(obj.name, obj);

            obj = new Button("Button00","112",null,"104","30",null,"0",null,null,null,null,this.divContents.form.Div03_00.form);
            obj.set_taborder("0");
            obj.set_text("더보기");
            obj.set_cssclass("btn_LOGIN_More");
            this.divContents.form.Div03_00.addChild(obj.name, obj);

            obj = new Static("Static00","111","7","140","50",null,null,null,null,null,null,this.divContents.form.Div03_00.form);
            obj.set_taborder("1");
            obj.set_text("자료실");
            obj.set_cssclass("sta_LOGIN_Title");
            this.divContents.form.Div03_00.addChild(obj.name, obj);

            obj = new Static("Static00_00","111","48",null,"50","11",null,null,null,null,null,this.divContents.form.Div03_00.form);
            obj.set_taborder("2");
            obj.set_text("국제감축사업 및 실적에 관한\r\n\r자료를 제공합니다.");
            obj.set_cssclass("sta_LOGIN_Text");
            this.divContents.form.Div03_00.addChild(obj.name, obj);

            obj = new ImageViewer("ImageViewer00","-4","15","80","80",null,null,null,null,null,null,this.divContents.form.Div03_00.form);
            obj.set_taborder("3");
            obj.set_image("url(\'theme://images/main/ico_LOGIN_Data.png\')");
            obj.set_stretch("none");
            this.divContents.form.Div03_00.addChild(obj.name, obj);

            obj = new Div("Div03_00_00","700",null,"320","141",null,"0",null,null,null,null,this.divContents.form);
            obj.set_taborder("8");
            this.divContents.addChild(obj.name, obj);

            obj = new Button("Button00","122",null,"104","30",null,"0",null,null,null,null,this.divContents.form.Div03_00_00.form);
            obj.set_taborder("0");
            obj.set_text("더보기");
            obj.set_cssclass("btn_LOGIN_More");
            this.divContents.form.Div03_00_00.addChild(obj.name, obj);

            obj = new Static("Static00","120","7","140","50",null,null,null,null,null,null,this.divContents.form.Div03_00_00.form);
            obj.set_taborder("1");
            obj.set_text("정보공개");
            obj.set_cssclass("sta_LOGIN_Title");
            this.divContents.form.Div03_00_00.addChild(obj.name, obj);

            obj = new Static("Static00_00","120","47",null,"50","2",null,null,null,null,null,this.divContents.form.Div03_00_00.form);
            obj.set_taborder("2");
            obj.set_text("국제감축사업 및 실적에 관한\r\n\r정보공개 내용을 확인해보세요.");
            obj.set_cssclass("sta_LOGIN_Text");
            this.divContents.form.Div03_00_00.addChild(obj.name, obj);

            obj = new ImageViewer("ImageViewer00","5","14","80","80",null,null,null,null,null,null,this.divContents.form.Div03_00_00.form);
            obj.set_taborder("3");
            ...
            obj = new ImageViewer("ImageViewer00","90","25","207","44",null,null,null,null,null,null,this.divBottom.form);
            obj.set_taborder("0");
            ...
            obj = new Static("Static00_00","378","50","796","48",null,null,null,null,null,null,this.divBottom.form);
            obj.set_taborder("2");
            ...
            obj = new Button("btnFAQBoard",null,"19","100","31","btnInformation:40",null,null,null,null,null,this.divTop.form);
            obj.set_taborder("4");
            obj.set_text("FAQ");
            obj.set_cssclass("btn_LOGIN_TopMenu");
            this.divTop.addChild(obj.name, obj);
            ...
            obj = new PopupDiv("pdEdtIdTooltip","1383","225","180","39",null,null,null,null,null,null,this);
            obj.set_cssclass("pdiv_WF_Tooltip");
            this.addChild(obj.name, obj);

            obj = new Static("staTooltip","0","4","180","35",null,null,null,null,null,null,this.pdEdtIdTooltip.form);
            obj.set_taborder("0");
            obj.set_text("영문만 입력가능 합니다");
            obj.set_cssclass("sta_WF_Tooltip");
            this.pdEdtIdTooltip.addChild(obj.name, obj);
            // Layout Functions
            ...
            //-- Default Layout : this.divContents.form.Div01_00.form
            obj = new Layout("default","",0,0,this.divContents.form.Div01_00.form,function(p){});
            this.divContents.form.Div01_00.form.addLayout(obj.name, obj);
            ...
            //-- Default Layout : this.divContents.form.Div03.form
            obj = new Layout("default","",0,0,this.divContents.form.Div03.form,function(p){});
            this.divContents.form.Div03.form.addLayout(obj.name, obj);

            //-- Default Layout : this.divContents.form.Div03_00.form
            obj = new Layout("default","",0,0,this.divContents.form.Div03_00.form,function(p){});
            this.divContents.form.Div03_00.form.addLayout(obj.name, obj);

            //-- Default Layout : this.divContents.form.Div03_00_00.form
            obj = new Layout("default","",0,0,this.divContents.form.Div03_00_00.form,function(p){});
            this.divContents.form.Div03_00_00.form.addLayout(obj.name, obj);
            ...
            //-- Default Layout : this.pdEdtIdTooltip.form
            obj = new Layout("default","",0,0,this.pdEdtIdTooltip.form,function(p){});
            this.pdEdtIdTooltip.form.addLayout(obj.name, obj);
        ...
        this.fnCallback = function(sSvcId, nErrCode, sErrMsg)
        {
        	...
        	switch (sSvcId)
        	{
        		...
        		case "userInfo" :
        			...
        			this.fvApp.User.instDtlsClsfCd	= this.fvApp.gdsUserInfo.getColumn(0, "instDtlsClsfCd"	);  // 기관세부분류코드
        ...
        */
        this.fnPreLoginValueSetting = function()
        {
        	...
        	// ID 셋팅
        	this.dsLogin.setColumn(0,"userId",this.divContents.form.divLogin.form.edtId.value);

        	// PW 셋팅
        	//this.dsLogin.setColumn(0,"pwd",this.divContents.form.divLogin.form.edtPw.value);
        ...
        */
        this.divTop_btnInformation_onclick = function(obj,e)
        {
        	...
        	var oOption		= {showtitlebar:true,titletext:"정보공개", modal:false, resizable:true};
        	this.fnShowPopup(sPopupId, sPopupUrl, objArgs, oOption);
        };
        /**
        ...
        */
        ...
        {
        	if(!this.pdEdtIdTooltip.isPopup())
        	{
        		nXPos = (obj.getOffsetWidth()/2) - (this.pdEdtIdTooltip.getOffsetWidth()/2);
        		nYPos = obj.getOffsetHeight();
        		this.pdEdtIdTooltip.trackPopupByComponent(obj, nXPos, nYPos, this.pdEdtIdTooltip.getOffsetWidth(), this.pdEdtIdTooltip.getOffsetHeight(), "", false);
        		this.divContents.form.divLogin.form.edtId.setFocus();
        	}
        };
        ...
        */
        ...
        {
        	this.pdEdtIdTooltip.closePopup();
        };
        ...
        */
        ...
        this.on_initEvent = function()
        {
            ...
            this.divContents.form.divLogin.form.edtId.addEventHandler("onsetfocus",this.divContents_divLogin_edtId_onsetfocus,this);
            this.divContents.form.divLogin.form.edtId.addEventHandler("onkillfocus",this.divContents_divLogin_edtId_onkillfocus,this);
            this.divContents.form.divLogin.form.edtId.addEventHandler("oneditclick",this.divContents_divLogin_edtId_oneditclick,this);
            ...
            this.divContents.form.Div03.form.Button00.addEventHandler("onclick",this.divTop_btnLNGBoard_onclick,this);
            this.divContents.form.Div03_00.form.Button00.addEventHandler("onclick",this.divTop_btnDataBoard_onclick,this);
