(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Combo("cboSite",null,"14","180","30","30",null,null,null,null,null,this);
            obj.set_taborder("0");
            obj.set_codecolumn("codecolumn");
            obj.set_datacolumn("datacolumn");
            var cboSite_innerdataset = new nexacro.NormalDataset("cboSite_innerdataset", obj);
            cboSite_innerdataset._setContents("<ColumnInfo><Column id=\"codecolumn\" size=\"256\"/><Column id=\"datacolumn\" size=\"256\"/></ColumnInfo><Rows><Row><Col id=\"codecolumn\">https://www.gir.go.kr/home/main.do</Col><Col id=\"datacolumn\">GIR 온실가스종합정보센터</Col></Row><Row><Col id=\"codecolumn\">https://ngms.gir.go.kr:8443/main.do</Col><Col id=\"datacolumn\">NGMS 국가온실가스종합관리</Col></Row><Row><Col id=\"codecolumn\">https://etrs.gir.go.kr/etrs/</Col><Col id=\"datacolumn\">ETRS 배출권등록부</Col></Row><Row><Col id=\"codecolumn\">https://ets.krx.co.kr/contents/ETS/03/03010000/ETS03010000.jsp</Col><Col id=\"datacolumn\">KRX 배출권 정보플랫폼</Col></Row><Row><Col id=\"codecolumn\">https://devors.gir.go.kr/ors/main.do</Col><Col id=\"datacolumn\">ORS 상쇄등록부시스템</Col></Row><Row><Col id=\"datacolumn\">바로가기</Col></Row></Rows>");
            obj.set_innerdataset(cboSite_innerdataset);
            obj.set_text("바로가기");
            obj.set_value("");
            obj.set_index("5");
            this.addChild(obj.name, obj);

            obj = new Button("btnPrivacy","14","20","110","20",null,null,null,null,null,null,this);
            obj.set_taborder("1");
        ...
        */
        this.btnPrivacy_onclick = function(obj,e)
        {
        ...
        */
        this.cboSite_onitemclick = function(obj,e)
        {
        ...
        this.on_initEvent = function()
        {
            ...
            this.cboSite.addEventHandler("onitemclick",this.cboSite_onitemclick,this);
            this.btnPrivacy.addEventHandler("onclick",this.btnPrivacy_onclick,this);
        };
