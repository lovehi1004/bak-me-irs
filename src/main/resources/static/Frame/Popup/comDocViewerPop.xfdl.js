(function()
{
    return function()
    {
        ...
        {
            this.set_name("comDocViewerPop");
            this.set_titletext("DocViewer (Modeless) 공통팝업폼");
            ...
            obj = new WebBrowser("wbsDocViewer","0","0",null,null,"0","0",null,null,null,null,this.divContents.form);
            obj.set_taborder("0");
        ...
        // User Script
        this.registerScript("comDocViewerPop.xfdl", function() {
        /***********************************************************************************
        * SERVICE GROUP : Frame_Popup
        * BUSINESS      : comDocViewerPop Form
        * FILE NAME     : comDocViewerPop.xfdl
        * DESCRIPTION   : DocViewer (Modeless) 공통팝업폼
        *------------------------------------------------------------------
        ...
        ***********************************************************************************/
        ...
        this.fvUrl = "";				// DocViewer 연결 Url
        this.fvFn = "";					// DocViewer FN 값
        this.fvRs = "";					// DocViewer RS 값
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	this.fvFn = this.gfnGetParameter(objFormFrame, "pvFn");
        	this.fvRs = this.gfnGetParameter(objFormFrame, "pvRs");
        	...
        	var sUrl = this.fvUrl + "?fn=" + this.fvFn + "&rs=" + this.fvRs;
        	this.divContents.form.wbsDocViewer.set_url(sUrl);
        ...
        */
        this.divContents_wbsDocViewer_onloadcompleted = function(obj,e)
        {
        	trace("[divContents_wbsDocViewer_onloadcompleted]");
        };
        });
        ...
        this.on_initEvent = function()
        {
            ...
            this.divContents.form.wbsDocViewer.addEventHandler("onloadcompleted",this.divContents_wbsDocViewer_onloadcompleted,this);
            this.btnOk.addEventHandler("onclick",this.btnOk_onclick,this);
        };
        this.loadIncludeScript("comDocViewerPop.xfdl");
