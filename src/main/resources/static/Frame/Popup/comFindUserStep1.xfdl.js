(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Button("btnCancel",null,null,"75","32","706","25",null,null,null,null,this.divContent.form);
            obj.set_taborder("1");
            obj.set_text("취소");
            obj.set_cssclass("btn_POP_Cancel");
            this.divContent.addChild(obj.name, obj);

            obj = new Button("btn00","212","83","564","202",null,null,null,null,null,null,this.divContent.form);
            obj.set_taborder("2");
            obj.set_text("◀ 비밀번호 찾기 | 아이디 찾기 ▶");
        ...
        */
        ...
        {
        	this.getOwnerFrame().form.fnGoStep(2);			// STEP4 화면 보여주기
        };
