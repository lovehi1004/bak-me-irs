(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj._setContents("<ColumnInfo><Column id=\"no\" type=\"STRING\" size=\"256\"/><Column id=\"instMgno\" type=\"STRING\" size=\"256\"/><Column id=\"instClsfCd\" type=\"STRING\" size=\"256\"/><Column id=\"instDtlClsfCd\" type=\"STRING\" size=\"256\"/><Column id=\"govInstYn\" type=\"STRING\" size=\"256\"/><Column id=\"acntSttsClCd\" type=\"STRING\" size=\"256\"/><Column id=\"bzentNm\" type=\"STRING\" size=\"256\"/><Column id=\"bzentClCd\" type=\"STRING\" size=\"256\"/><Column id=\"crno\" type=\"STRING\" size=\"256\"/><Column id=\"brno\" type=\"STRING\" size=\"256\"/><Column id=\"rprsvNm\" type=\"STRING\" size=\"256\"/><Column id=\"corpTelDdd\" type=\"STRING\" size=\"256\"/><Column id=\"corpTelTlpno\" type=\"STRING\" size=\"256\"/><Column id=\"corpTelPhino\" type=\"STRING\" size=\"256\"/><Column id=\"rdnmCd\" type=\"STRING\" size=\"256\"/><Column id=\"addr\" type=\"STRING\" size=\"256\"/><Column id=\"dtlAddr\" type=\"STRING\" size=\"256\"/><Column id=\"upInstMgno\" type=\"STRING\" size=\"256\"/><Column id=\"upInstNm\" type=\"STRING\" size=\"256\"/><Column id=\"brdocFlmno\" type=\"STRING\" size=\"256\"/><Column id=\"targetUserClCd\" type=\"STRING\" size=\"256\"/></ColumnInfo>");
            this.addChild(obj.name, obj);
            ...
            obj.set_accessibilitylabel("사업체구분");
            obj.set_text("투비");
            obj.set_value("1");
            obj.set_index("-1");
            this.divPop.form.divSearch.addChild(obj.name, obj);
            ...
            obj._setContents("<Formats><Format id=\"default\"><Columns><Column size=\"50\"/><Column size=\"100\"/><Column size=\"150\"/><Column size=\"80\"/><Column size=\"120\"/><Column size=\"120\"/><Column size=\"80\"/></Columns><Rows><Row size=\"43\" band=\"head\"/><Row size=\"43\"/></Rows><Band id=\"head\"><Cell text=\"번호\" tooltiptext=\"번호\"/><Cell col=\"1\" text=\"사업체분류\" tooltiptext=\"사업체분류\"/><Cell col=\"2\" text=\"사업수행자\" tooltiptext=\"사업수행자\"/><Cell col=\"3\" text=\"대표자명\" tooltiptext=\"대표자명\"/><Cell col=\"4\" text=\"사업자등록번호\" tooltiptext=\"사업자등록번호\"/><Cell col=\"5\" text=\"사업체구분\" tooltiptext=\"사업체구분\"/><Cell col=\"6\" text=\"선택\" tooltiptext=\"선택\"/></Band><Band id=\"body\"><Cell text=\"bind:no\" textAlign=\"center\" tooltiptext=\"번호\" accessibilitylabel=\"번호\"/><Cell col=\"1\" text=\"bind:instClsfCd\" displaytype=\"combotext\" combodataset=\"dsResult02\" combocodecol=\"cdMgno\" combodatacol=\"cdKornNm\" tooltiptext=\"사업체분류\" accessibilitylabel=\"사업체분류\"/><Cell col=\"2\" text=\"bind:bzentNm\" textAlign=\"center\" tooltiptext=\"사업수행자\" accessibilitylabel=\"사업수행자\"/><Cell col=\"3\" text=\"bind:rprsvNm\" textAlign=\"center\" tooltiptext=\"대표자명\" accessibilitylabel=\"대표자명\"/><Cell col=\"4\" text=\"bind:brno\" textAlign=\"center\" displaytype=\"mask\" maskedittype=\"string\" maskeditformat=\"###-##-#####\" tooltiptext=\"사업자등록번호\" accessibilitylabel=\"사업자등록번호\"/><Cell col=\"5\" text=\"bind:bzentClCd\" displaytype=\"combotext\" combodataset=\"dsResult01\" combocodecol=\"cdMgno\" combodatacol=\"cdKornNm\" tooltiptext=\"사업체구분\" accessibilitylabel=\"사업체구분\"/><Cell col=\"6\" displaytype=\"buttoncontrol\" text=\"선택\" padding=\"10px\" tooltiptext=\"선택\" accessibilitylabel=\"선택\" accessibilitydescription=\"사업체 선택\"/></Band></Format></Formats>");
            this.divPop.addChild(obj.name, obj);
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	try
        	{
        		/*
        			0 : 일반사업체 제외 조회
        			1 : [그외 정부기관|관장기관|위탁기관] 정부기관 조회
        			2 : 일반사업체 조회
        			3 : 관장기관만 조회
        			4 : 관리운영
        			9 : 전체조회
        		*/
        		this.pvInstSearchType  	= this.getOwnerFrame().arguments["pvInstSearchType"];
        	}
        	catch (e)
        	{
        ...
        */
        this.fnChgCboSrhBzentClCd = function()
        {
        	...
        	} else if(this.pvInstSearchType == 4) {										// 관리운영 조회 라면
        		this.divPop.form.divSearch.form.cboSrhBzentClCd.set_readonly(false);
        		this.divPop.form.divSearch.form.cboSrhBzentClCd.set_index(2);			// 비할당

        	} else if(this.pvInstSearchType == 8) {										// 전체 조회 라면 - 계정상태 모두 포함
        		this.divPop.form.divSearch.form.cboSrhBzentClCd.set_readonly(false);
        		this.divPop.form.divSearch.form.cboSrhBzentClCd.set_index(0);			// 전체

        	} else if(this.pvInstSearchType == 9) {										// 전체 조회 라면 - 승인만 포함
        		this.divPop.form.divSearch.form.cboSrhBzentClCd.set_readonly(false);
        		this.divPop.form.divSearch.form.cboSrhBzentClCd.set_index(0);			// 전체
        	}
        };
        ...
        this.divPop_grdList_oncellclick = function(obj,e)
        {
        	...
        	if(e.cell == 6)
        	{
        		var strRtnJson = {
        			...
        			, instDtlClsfCd	:	this.dsInstList.getColumn(e.row, "instDtlClsfCd")	// 기관세부분류코드
        		...
        		if(this.fvApp.User.roleIdMgno == "RL00000001") {
        			strRtnJson["psnAcntUnqno"] = this.dsInstList.getColumn(e.row, "psnAcntUnqno")	// 보유계정고유번호
        		}

        		var strRtn = this.gfnSetPopupReturn(strRtnJson);
