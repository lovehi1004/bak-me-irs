(function()
{
    return function()
    {
        ...
        this.on_create = function()
        {
            ...
            obj = new Static("staMessage","50","91",null,null,"50","86","270","500","38","500",this);
            obj.set_taborder("2");
            ...
            obj = new Button("btnCustom1","109","staMessage:9","75","32",null,null,null,null,null,null,this);
            obj.set_taborder("3");
            obj.set_text("예");
            ...
            obj = new Button("btnCustom2","btnCustom1:3","staMessage:9","75","32",null,null,null,null,null,null,this);
            obj.set_taborder("4");
            obj.set_text("아니요");
        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	if ( nGapW > 0 || nGapH > 0 )
        	{
        		...
        		nLeft  = this.getOffsetWidth()/2 - (this.btnCustom1.getOffsetWidth()+3+this.btnCustom2.getOffsetWidth())/2;
        		trace("nLeft:"+nLeft);
        		this.btnCustom1.set_left(nLeft);
        	}
        	this.resetScroll();
