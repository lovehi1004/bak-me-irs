        ...
        ***********************************************************************************/
        ...
        this.fnFormInit = function(objForm)
        {
        	...
        	try
        	{
        		...
        		// 사용자관리 - 비밀번호 초기화는 전체관리자가 팝업을 띄운다.
        		if(this.pvPopType == 0) {
        	...
        	if(this.pvPopType == 0){						// 비밀번호 초기화
        		...
        		this.divFrm.form.divEvlReg.form.staTitle.set_text("새 비밀번호가 SMS발송 되었습니다.");
        		this.divFrm.form.divEvlReg.form.edtContent.set_value(this.pvValue);
        	} else if(this.pvPopType == 1){					// 아이디찾기
        		this.divTitFrm.form.staTit.set_text("아이디찾기");
        		this.divFrm.form.divEvlReg.form.staTitle.set_text("아이디가 SMS발송 되었습니다.");
        	} else if(this.pvPopType == 2){					// 비밀번호찾기
        		this.divTitFrm.form.staTit.set_text("비밀번호찾기");
        		this.divFrm.form.divEvlReg.form.staTitle.set_text("비밀번호가 SMS발송 되었습니다.");
        	} else {
